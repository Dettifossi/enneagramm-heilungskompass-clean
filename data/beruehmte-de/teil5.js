...
export function angelinaJoliePortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function billHaastPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-bill-haast-portrait.jpg" alt="Bill Haast – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function carlRogersPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-carl-rogers-portrait.jpg" alt="Dr. Carl Rogers – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function cluesoPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Berühmte Persönlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-clueso-portrait.jpg" alt="Clueso" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function dieterNuhrPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-dieter-nuhr-portrait.jpg" alt="Dieter Nuhr – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function elonMuskPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function fredericChopinPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\xfchmte Pers\xf6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-frederic-chopin-portrait.jpg" alt="Fr&eacute;d&eacute;ric Chopin – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function gottfriedWilhelmLeibnizPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Berühmte Persönlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-gottfried-wilhelm-leibniz-portrait.jpg" alt="Gottfried Wilhelm Leibniz" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function herbertGroenomeyerPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-herbert-groenemeyer-portrait.jpg" alt="Herbert Gr\u00f6nemeyer – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jackBlackPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jack-black-portrait.jpg" alt="Jack Black" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jillPruetzPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Berühmte Persönlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jill-pruetz-portrait.jpg" alt="Dr. Jill Pruetz – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function julesVernePortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Berühmte Persönlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function klausKinskiPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function leonardCohenPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Berühmte Persönlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function mahatmaGandhiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-mahatma-gandhi-portrait.jpg" alt="Mahatma Gandhi – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function martinLutherPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-martin-luther-portrait.jpg" alt="Martin Luther \u2013 Portr\u00e4t" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function morganFreemanPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-morgan-freeman-portrait.jpg" alt="Morgan Freeman – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function oprahWinfreyPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function quentinTarantinoPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Berühmte Persönlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-quentin-tarantino-portrait.jpg" alt="Quentin Tarantino – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function sallyRooneyPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Berühmte Persönlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-sally-rooney-portrait.jpg" alt="Sally Rooney" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function stromaePortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Berühmte Persönlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-stromae-portrait.jpg" alt="Stromae – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function tonyShalhoubPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Berühmte Persönlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-tony-shalhoub-portrait.jpg" alt="Tony Shalhoub" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function willyBrandtPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ber\u00fchmte Pers\u00f6nlichkeiten")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-carlo-ancelotti", label:"Portr\u00e4t: Carlo Ancelotti (SO9w8) \u2013 ebenfalls verz\u00f6gerte, dann klare Direktheit"},
      ])}
    </div>
  `);
}
...
export function hannahArendtPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-hannah-arendt-portrait.jpg" alt="Hannah Arendt \u2013 Portr\u00e4t" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function williamShakespearePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-william-shakespeare-portrait.jpg" alt="William Shakespeare – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Sein Testament ist auffällig nüchtern-geschäftsmäßig: präzise Auflistung von Besitz, das berühmte "zweitbeste Bett" für seine Frau Anne Hathaway &ndash; keine poetische Geste, sondern ein sachliches Dokument. Reale Leistung und Substanz zählten für ihn offenbar mehr als jede öffentliche Inszenierung darüber.</p>
          <p class="vb-intro">Bezeichnend ist dabei, welches Selbstbild Shakespeare offenbar gerade <em>nicht</em> pflegte: das des weltabgewandten, leidenden Künstlers, der sich über den kommerziellen Theaterbetrieb erhaben fühlt. Er verstand sich, soweit erkennbar, als professioneller Handwerker des Theaters &ndash; als Geschäftsmann und Lieferant, der pünktlich fertige Stücke abliefern musste, nicht als romantisches Genie in der Dachkammer. Diese "unsichtbare Macher"-Haltung geht bei der selbsterhaltenden Drei noch einen Schritt weiter als die bloße Bühnenscheu: Nicht nur der Auftritt wird vermieden, sondern auch die eigene Ambition selbst wird getarnt. Es geht nicht darum, als besonders ehrgeizig zu wirken, sondern schlicht außergewöhnlich gut in dem zu sein, was man tut &ndash; und genau das lässt sich an Shakespeares Sorge um Familie und materielle Sicherheit in Stratford ablesen, weit entfernt von jeder eitlen Selbstdarstellung.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der Viererflügel ist dabei kein bloßes Beiwerk, sondern das entscheidende Gegengewicht: Eine reine selbsterhaltende Drei ohne diese Note liefe Gefahr, rein zweckorientiert, trocken, kommerziell zu bleiben &ndash; ein solider Theaterhandwerker ohne besonderen Nachhall. Erst die Verbindung aus geschäftstüchtiger, disziplinierter Drei-Struktur und dem Vierer-Zugang zu den dunkelsten, universellsten menschlichen Gefühlen macht aus dem zuverlässigen Lieferanten von Theaterstücken einen Dichter, dessen Sprache Jahrhunderte überdauert.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Wie leicht die eigene Leistung hinter der eigenen Unsichtbarkeit verschwinden kann, zeigt sich bei Shakespeare besonders deutlich: Die Substanz war so vollständig, dass sie bis heute Anlass für Verschwörungstheorien bietet, die lieber einen adligen, öffentlich sichtbareren Autor hinter dem Werk vermuten, als zu akzeptieren, dass ein unauffälliger Mann aus Stratford es allein geschaffen haben könnte.</p>
        </blockquote>
...
export function christianDrostenPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-christian-drosten-portrait.jpg" alt="Prof. Dr. Christian Drosten – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Bei der politischen Aufarbeitung der Pandemie zeigte sich dasselbe Muster aus Gruppenbindung und Verteidigungsbereitschaft: Im Dezember 2025 sagte Drosten, unter Polizeischutz, vor der Corona-Enquete-Kommission des Bundestags aus. Er verteidigte den deutschen Pandemiekurs in weiten Teilen, räumte an mehreren Stellen aber auch eigene Fehleinschätzungen ein und bezeichnete sich selbst als „Pandemie-Erklärer", dessen Aussagen teils missverstanden worden seien. Einzelne Fragen, vor allem der AfD-Vertreter zu Schweden und zu früheren Datenlücken, wies er als „irreführend" zurück – ein Muster, das seine Kritiker als mangelnde Selbstkritik lesen, seine Verteidiger als berechtigte Zurückweisung parteipolitisch motivierter Fragen.</p>
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Sein Erwachungserlebnis ereignete sich in London, wo Tolle seit seinem 19. Lebensjahr lebte und zunächst als Sprachlehrer arbeitete, bevor er an der University of London studierte und 1977 ein Promotionsstudium in Cambridge begann &ndash; das er nach dem Erlebnis auf der Parkbank abbrach. Auch seine ersten kleinen Lehrgruppen entstanden noch in London, wo Menschen, angezogen von seiner Präsenz, informell zu ihm fanden. Erst 1995 zog er nach Vancouver, wo er „Jetzt! Die Kraft der Gegenwart" schrieb, das zunächst kaum beachtet wurde, bis Oprah Winfrey es Jahre später ihrem Millionenpublikum empfahl. Sein zweites Buch, „Eine neue Erde" (2005), richtet sich explizit an die Menschheit als Ganzes und beschreibt einen möglichen kollektiven Bewusstseinswandel.</p>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Eine auffällige Parallele besteht zu <a href="javascript:void(0)" data-route="beruehmte-carl-rogers">Dr. Carl Rogers</a> (ebenfalls SX9w1), obwohl sich beide nachweislich nie begegneten: Rogers schuf in der Psychotherapie einen wertfreien Raum, in dem Menschen sich ohne Bewertung entfalten konnten, und wurde dadurch therapeutisch außergewöhnlich wirksam. Beide leben dieselbe SX9w1-Grundbegabung vor &ndash; Verschmelzung ohne Urteil, getragen von der disziplinierten Genauigkeit des Einserflügels &ndash;, nur in unterschiedlichen Feldern: der eine in der Psychotherapie, der andere in der spirituellen Lehre.</p>
          <p class="vb-intro">Fairerweise gehört auch hier eine Einordnung dazu, ganz ähnlich wie bei Dieter Lange (SE1w9): So wahr und wirksam Tolles Lehre auch ist, sie bleibt zunächst der Weg einer bewussten, integrierten SX9w1 &ndash; eine Fähigkeit zur urteilsfreien Verschmelzung mit dem Moment, die diesem Subtyp von Natur aus besonders leichtfällt. Das macht die dahinterliegenden Einsichten nicht falsch; im Gegenteil, bewusste Neuner besitzen gerade die Gabe, aus ihrer eigenen Verschmelzungserfahrung heraus Wahrheiten zu formulieren, die für Menschen aller Subtypen gültig sind. Aber sie lassen sich nicht einfach nachahmen. Jeder andere Enneagrammtyp muss diese Weisheit erst verstehen und im Rahmen des eigenen Musters integrieren, statt Tolles oder Rogers' Haltung äußerlich zu kopieren &ndash; nur die selbst durchlebte Integration macht eine fremde Wahrheit für einen anderen Menschen wirklich fruchtbar.</p>
        </blockquote>

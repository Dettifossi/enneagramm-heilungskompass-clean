    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der Schatten liegt in der Gefahr, dass das eigene Prinzip der Ungeschnittenheit zum Selbstzweck wird. Im über vierstündigen Gespräch mit dem AfD-Politiker Björn Höcke 2026 durfte dieser unwidersprochen behaupten, die SA der NSDAP habe keinen Wahlspruch gehabt – eine Aussage, die nicht nur historisch falsch ist ("Alles für Deutschland" gilt laut einem rechtskräftigen Urteil des OLG Hamm von 2006 als der Wahlspruch der SA – unabhängig davon auch museal und waffenhistorisch dokumentiert: Der 1933 eingeführte SA-Dienstdolch trug genau diese Inschrift, eingeätzt in die Klinge), sondern Höckes eigener Rechtsgeschichte widerspricht: Er selbst wurde zweimal strafrechtlich verurteilt, weil er genau diesen verbotenen Spruch öffentlich verwendet hatte. Die Landesmedienanstalt NRW ermahnte Berndt daraufhin förmlich, journalistische Sorgfaltspflichten einzuhalten und genau eine solche Einordnung nachzuholen.</p>
          <p class="vb-intro">Berndts eigene Reaktion auf diese Kritik ist bezeichnend: Er verweist darauf, kein Journalist zu sein, und spricht von Zensur – statt die eigene Regel im Einzelfall zu überdenken, verteidigt er sie als Prinzip. Das ist die Kehrseite derselben Eins-Disziplin, die im Licht so viel Vertrauen schafft: Ein selbst gesetztes Gesetz, an dem konsequent festgehalten wird, kann sich gegen begründete Kritik ebenso konsequent abschotten wie gegen beliebige.</p>
          <p class="vb-intro">Genau darin liegt die eigentliche Schwachstelle des "Ich bin kein Journalist, nur Gastgeber"-Prinzips: Es setzt ein außergewöhnlich mündiges Publikum voraus, das jede unwidersprochene Behauptung selbst überprüft – wie aufwendig allein die Recherche zu nur einer einzigen falschen Aussage sein kann, zeigt sich, sobald man es tatsächlich versucht. Die meisten Zuhörer haben dafür weder die Zeit noch die Mittel. Ein Prinzip, das keine Ausnahme kennt, verlagert die journalistische Sorgfaltspflicht damit faktisch vollständig auf ein Publikum, das sie kaum leisten kann.</p>
        </blockquote>

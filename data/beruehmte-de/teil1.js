    ...
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-abd-al-fattah-as-sisi-portrait.jpg" alt="Abd al-Fattah as-Sisi – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function byronKatiePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-byron-katie-portrait.jpg" alt="Byron Katie – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function dhapanbalYunupinguPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-dhapanbal-yunupingu-portrait.jpg" alt="Dhapanbal Yunupingu – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function giannaNanniniPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-gianna-nannini-portrait.jpg" alt="Gianna Nannini – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function heidiKlumPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-heidi-klum-portrait.jpg" alt="Heidi Klum – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function indraNooyiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-indra-nooyi-portrait.jpg" alt="Indra Nooyi – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jennaOrtegaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jenna-ortega-portrait.jpg" alt="Jenna Ortega – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function josephAounPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-joseph-aoun-portrait.jpg" alt="Joseph Aoun – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function leboMPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-lebo-m-portrait.jpg" alt="Lebo M – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function ludwigXIVPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-ludwig-xiv-portrait.jpg" alt="Ludwig XIV. – der Sonnenkönig – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function markZuckerbergPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-mark-zuckerberg-portrait.jpg" alt="Mark Zuckerberg – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function mohammedPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-mohammed-portrait.jpg" alt="Kalligrafie des Namens Mohammed \u2013 Symbolbild anstelle eines Portr\u00e4ts" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function ninaChubaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-nina-chuba-portrait.jpg" alt="Nina Chuba – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function pierceBrosnanPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-pierce-brosnan-portrait.jpg" alt="Pierce Brosnan – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-cg-jung", label:"Porträt: Carl Gustav Jung (SO5w6)"},
      ])}
    </div>
  `);
}
...
export function timCluttonBrockPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-tim-clutton-brock-portrait.jpg" alt="Prof. Tim Clutton-Brock – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Dreierflügel (w3)</strong> gibt der sexuellen Zwei den Antrieb, aus persönlicher Hingabe ein sichtbares, wirkungsvolles Projekt zu formen. Duncan blieb nicht bei der eigenen Bühnenpräsenz stehen: Sie gründete Tanzschulen in Deutschland, Frankreich, den USA und schließlich in der Sowjetunion, um ihre Methode systematisch an eine neue Generation weiterzugeben – die berühmten „Isadorables", sechs von ihr selbst ausgebildete Schülerinnen, traten weltweit in ihrem Stil auf – 1920 wollte Duncan sie sogar offiziell adoptieren und ließ sie fortan ihren Nachnamen tragen, auch wenn es entgegen späteren Behauptungen nie zu einer rechtsgültigen Adoption kam.</p>
...
export function suzanLoriParksPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-suzan-lori-parks-portrait.jpg" alt="Suzan-Lori Parks – Portr\xe4t" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Keine einzelne, intensive Verbindung wie bei der sexuellen Sieben, kein geteiltes Wissenssystem wie bei der sozialen Sieben, sondern eine reine, disziplinierte Menge an t\xe4glich produziertem Material, das sich zu einem eigenen, weltweiten Auff\xfchrungsnetz verdichtete. Wie ein Gorilla, der sein Revier mit Vorräten sichert, füllte sie ihres mit 365 einzelnen, aber untereinander verbundenen St\xfccken.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Achterflügel: Kompromisslose Verteidigung der eigenen Setzung</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der Achterfl\xfcgel verleiht der selbsterhaltenden Sieben eine Durchsetzungskraft, die bei schw\xe4cherer Auspr\xe4gung fehlen w\xfcrde. Als Parks 2011 f\xfcr eine Broadway-Neuinszenierung von \xbbPorgy and Bess\xab tiefgreifende \xc4nderungen am Original vornahm, kritisierte der legend\xe4re Komponist Stephen Sondheim sie \xf6ffentlich und scharf &ndash; Parks verteidigte ihre k\xfcnstlerischen Entscheidungen jedoch unnachgiebig, statt zur\xfcckzurudern.</p>
...
export function miraMuratiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/mira-murati-portrait.jpg" alt="Mira Murati – Portr\xe4t" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-lewis-howes", label:"Portr\xe4t: Lewis Howes (SO2w3)"},
      ])}
    </div>
  `);
}
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Sie selbst hat öffentlich eine bipolare Störung eingeräumt, die zu manchen der ihr zugeschriebenen „erratischen" Phasen beitrug – ein eigenständiger gesundheitlicher Faktor, der von der enneagrammatischen Typisierung getrennt zu betrachten ist, aber die Härte, mit der ihr Verhalten öffentlich beurteilt wurde, zusätzlich einordnet.</p>
              <p class="vb-intro">Ergänzend lässt sich das über den Stresspunkt der Eins einordnen: Unter chronischem Druck bewegt sich die Eins entlang ihrer Stresslinie zur Vier – und übernimmt dort vermehrt deren Schattenseiten: Stimmungsschwankungen, das Gefühl, unverstanden zu sein, eine Intensität, die ins Dramatische kippt. Bei Dunaway könnten manche der ihr vorgeworfenen „launischen" Ausbrüche also nicht nur Symptom der bipolaren Erkrankung selbst gewesen sein, sondern zusätzlich genau diese stressbedingte Verschiebung – ohne dass die Krankheit dadurch auf ein Enneagramm-Muster reduziert würde: Menschsein und Kranksein bleiben zwei Seiten derselben Münze, keine Kausalkette. Diese Stresspunkt-Dynamik kann hier nur angedeutet werden – vertiefend nachlesen lässt sie sich im Buch „Die verborgene Dynamik der 27 Subtypen", das die Verbindungen zwischen den einzelnen Subtypen ausführlich herleitet.</p>
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-clara-loesel", label:"Porträt: Clara Lösel (SX6w5)"},
      ])}
    </div>
  `);
}
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Ben Berndt, 1984 in Berlin geboren, absolvierte ein duales Studium der Betriebswirtschaftslehre bei der Fluggesellschaft Lufthansa und später einen Master of Business Administration – einen postgradualen, praxisorientierten Wirtschafts-Studiengang – an der EBS Universität für Wirtschaft und Recht – bevor er mit "ungeskriptet" einen der meistgehörten deutschsprachigen Interview-Podcasts aufbaute: mehrstündige, größtenteils ungeschnittene Gespräche mit Gästen aus Politik, Medien, Wirtschaft und gesellschaftlichen Randgruppen. Sein eigener Anspruch an das Format ist ein selbst auferlegtes Gesetz: "roh, ungeschnitten und unzensiert – so wie Menschen wirklich sind".</p>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Seine offen ausgesprochene Kritik, viele Journalisten hielten sich für neutraler, als sie tatsächlich seien, liest sich wie eine einsertypische Forderung nach Redlichkeit – gerichtet weniger gegen andere als gegen den eigenen Anspruch, genau diese Falle selbst nicht zu begehen.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Zweierflügel: Der freundliche Gastgeber statt der distanzierte Interviewer</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Zweierflügel (w2)</strong> zeigt sich in genau dieser Selbstbeschreibung als "freundlicher Gastgeber" statt als distanzierter Fragender. Eine selbsterhaltende Eins mit schwach ausgeprägtem Zweierflügel – oder gar eine selbsterhaltende Eins mit Neunerflügel – würde eher auf sachliche Korrektheit pochen und sich stärker zurücknehmen; der Zweierflügel öffnet Berndts Format für die persönliche, oft stundenlange Nähe zum Gast, die "ungeskriptet" von klassischem Interview-Journalismus unterscheidet.</p>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der Schatten liegt in der Gefahr, dass das eigene Prinzip der Ungeschnittenheit zum Selbstzweck wird. Ein Beispiel dafür ist das über vierstündige Gespräch mit dem AfD-Politiker Björn Höcke 2026: Dort durfte Höcke unwidersprochen behaupten, die SA der NSDAP habe keinen Wahlspruch gehabt. Das ist historisch falsch. "Alles für Deutschland" gilt laut einem rechtskräftigen Urteil des OLG Hamm von 2006 als Wahlspruch der SA – unabhängig davon auch museal und waffenhistorisch belegt, denn der 1933 eingeführte SA-Dienstdolch trug genau diese Inschrift, eingeätzt in die Klinge. Zudem widerspricht die Aussage Höckes eigener Rechtsgeschichte: Er selbst wurde zweimal strafrechtlich verurteilt, weil er genau diesen verbotenen Spruch öffentlich verwendet hatte. Die Landesmedienanstalt NRW ermahnte Berndt daraufhin förmlich, journalistische Sorgfaltspflichten einzuhalten und die fehlende Einordnung nachzuholen.</p>
          <p class="vb-intro">Berndts eigene Reaktion auf diese Kritik ist bezeichnend: Er verweist darauf, kein Journalist zu sein, und spricht von Zensur, statt die eigene Regel im Einzelfall zu überdenken. Dieselbe einsertypische Disziplin, die im Licht so viel Vertrauen schafft, zeigt hier ihre Kehrseite: Wer an einem selbst gesetzten Gesetz ausnahmslos festhält, schützt sich damit auch gegen berechtigte Kritik – nicht nur gegen unberechtigte.</p>
          <p class="vb-intro">Genau darin liegt die eigentliche Schwachstelle des "Ich bin kein Journalist, nur Gastgeber"-Prinzips: Es setzt ein außergewöhnlich mündiges Publikum voraus, das jede unwidersprochene Behauptung selbst überprüft. Wie aufwendig allein die Recherche zu einer einzigen falschen Aussage sein kann, zeigt sich, sobald man es tatsächlich versucht – die meisten Zuhörer haben dafür weder die Zeit noch die Mittel. Ein Prinzip ohne Ausnahme verlagert die journalistische Sorgfaltspflicht damit faktisch vollständig auf ein Publikum, das sie kaum leisten kann.</p>
        </blockquote>

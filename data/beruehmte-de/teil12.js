...
export function arminRohdePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-armin-rohde-portrait.jpg" alt="Armin Rohde – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function bracoPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-braco-portrait.jpg" alt="Braco – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function changpengZhaoPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-changpeng-zhao-portrait.jpg" alt="Changpeng Zhao – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function donataHopfenPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-donata-hopfen-portrait.jpg" alt="Donata Hopfen – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">1972 zog sie nach Kalifornien, ließ sich später von ihrem ersten Mann scheiden und ging eine zweite Ehe mit dem sexuellen Achter <a href="#beruehmte-eli-jaxon-bear">Eli Jaxon-Bear (SX8w9)</a> ein, mit dem sie ein tibetisch-buddhistisches Dharma-Zentrum betrieb. 1989 heirateten die beiden formell in einer Höhle am Haleakala-Krater auf Maui – eine Verbindung, die bis heute anhält. Keine dieser Stationen war ein Irrweg – jede war eine weitere Form, in der dieselbe grundlegende Sehnsucht nach etwas Wirklicherem einen Ausdruck suchte, bevor sie 1990 gemeinsam mit ihm nach Indien reiste.</p>
        </blockquote>

        <h2 class="vb-section">2. Die sexuelle Vier: Konkurrenzneid als Sehnsucht ohne Halbheiten</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>sexuelle Vier (SX4)</strong> ist der Kontratyp der Vier – Naranjo nannte diesen Subtyp <em>Konkurrenzneid</em>: eine Intensität, die in keinem Verhältnis zur äußeren Erscheinung oder zu den Startbedingungen steht. Kein halbes Fühlen, kein gemäßigtes Auftreten – was gefühlt wird, wird vollständig gefühlt. In Indien trafen Gangaji und Jaxon-Bear gemeinsam auf H. W. L. Poonja, genannt Papaji, einen Schüler Ramana Maharshis, der ihr in dieser Begegnung den Namen Gangaji gab und sie zur Lehrerin machte.</p>
      ...
      ${relatedLinks([
        {route:"beruehmte-persoenlichkeiten", label:"Alle berühmten Persönlichkeiten"},
        {route:"beruehmte-eli-jaxon-bear", label:"Porträt: Eli Jaxon-Bear (SX8w9) – ihr Ehemann"},
        {route:"subtype/sx4", label:"SX4 – Der Chihuahua: Subtyp-Profil"},
...
export function hansChristianAndersenPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-hans-christian-andersen-portrait.jpg" alt="Hans Christian Andersen – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Einordnung ohne Determinismus: Andersens Gesundheit litt zeitlebens unter psychosomatischen Beschwerden &ndash; Zahnprobleme, Verdauungsstörungen, ausgeprägte Hypochondrie &ndash; die sich nicht monokausal auf seinen Subtyp zurückführen lassen. Bemerkenswert bleibt dennoch, wie eng seine ständige Sorge um Krankheit und Ablehnung mit seinem Grundmuster verwoben war. Andersen kannte sein eigenes Enneagramm-Muster naturgemäß nicht; seine Sehnsucht nach Zugehörigkeit bestimmte ihn unwidersprochen, ohne die Sprache, sie als wiederkehrendes Muster zu erkennen, statt sie immer wieder aufs Neue als individuelles Schicksal zu erleiden &ndash; nicht aus Schuld, sondern aus Unwissenheit über das eigene Muster.</p>
        </blockquote>
...
export function heinrichHeinePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-heinrich-heine-portrait.jpg" alt="Heinrich Heine – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function hughWarwickPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-hugh-warwick-portrait.jpg" alt="Hugh Warwick – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function janeGoodallPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jane-goodall-portrait.jpg" alt="Dr. Jane Goodall – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function ladyDianaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-lady-diana-portrait.jpg" alt="Lady Diana – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function loiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-loi-portrait.jpg" alt="Loi (Leonie Greiner) – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function nataschaKampuschPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-natascha-kampusch-portrait.jpg" alt="Natascha Kampusch – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function shakiraPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-shakira-portrait.jpg" alt="Shakira – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function theaLitschkaKoenPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-thea-litschka-koen-portrait.jpg" alt="Thea Litschka-Koen – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function umbertEcoPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-umberto-eco-portrait.jpg" alt="Dr. Umberto Eco – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function markusLanzPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-markus-lanz-portrait.jpg" alt="Markus Lanz – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function heleneFischerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-helene-fischer-portrait.jpg" alt="Helene Fischer – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
        <p class="krim-portrait-name">Helene Fischer</p>
        <p class="krim-portrait-typ">SX3w2 &middot; Sexueller Typ 3 mit Zweierflügel</p>
        <p class="krim-portrait-subtitle">Sängerin, geb. 1984 &ndash; Tierentsprechung: Pfau</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. Der Pfau, der sein Rad vollständig für andere entfaltet</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Pfau</strong> ist das Tier des sexuellen Typs 3 – ein Tier, dessen schönster Moment kein privates Vergnügen ist, sondern eine vollständig für ein Publikum ausgespielte Vorstellung. Helene Fischer, 1984 in Krasnojarsk geboren und mit ihrer Familie als Kind nach Deutschland übergesiedelt, arbeitete sich über Jahre unermüdlicher Auftritte, Proben und Tourneen zur erfolgreichsten deutschen Schlagersängerin der Gegenwart hoch – mit Bühnenshows, die an Aufwand und Akrobatik eher an eine Cirque-du-Soleil-Produktion erinnern als an ein klassisches Schlagerkonzert.</p>
          <p class="vb-intro">Trotz Weltruhm hält sie ihr Privatleben streng abgeschottet – kaum Home-Storys, kaum Social-Media-Selbstinszenierung im Alltag. Das ist kein Widerspruch zur SX3, sondern ihre Konzentration: Die gesamte magnetische Wirkung wird nicht in ständiger Präsenz verstreut, sondern vollständig auf den einen Moment gebündelt, in dem der Vorhang aufgeht.</p>
        </blockquote>

        <h2 class="vb-section">2. Die sexuelle Drei: Die vollständige Darbietung als Kunstform</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>sexuelle Drei (SX3)</strong> sucht nach Naranjo nicht in erster Linie gesellschaftliches Prestige oder stille Eigenständigkeit, sondern unmittelbare, magnetische Wirkung im direkten Moment der Begegnung – eine vollständige, bewusst gestaltete Selbstdarbietung, die genau weiß, welchen Eindruck sie erzielen will. Fischer bezeichnet sich selbst als „Kontrolletti", die sich mit ihrem eigenen Perfektionismus manchmal selbst im Weg steht, und gesteht offen: „Ich bin wahnsinnig schlecht im Abgeben." Statt Aufgaben zu delegieren, trainiert sie ihre aufwendigen Trapez- und Flugelemente lieber selbst durch – auch nach einer Kopfverletzung beim Trapezakt in Hannover oder einer gebrochenen Rippe während einer Tourprobe.</p>
          <p class="vb-intro">Diese Bereitschaft, erhebliche körperliche Risiken einzugehen, damit die Show am Abend exakt die überwältigende Wirkung erzielt, die sie sich vorgestellt hat, zeigt die sexuelle Drei in Reinform: Nicht die stille Absicherung im Hintergrund treibt sie, sondern der Anspruch, den einen Auftritt vollständig und unvergesslich zu machen.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Zweierflügel: Hingabe an das Publikum</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Zweierflügel</strong> verleiht der sexuellen Drei eine warme, beziehungsstiftende Note, die über reine Blendung hinausgeht. Fischers Konzerte sind explizit auf emotionale Nähe zum Publikum angelegt: Liedtexte über Liebe und das Kostbare des Moments, das wiederkehrende „diesen Abend gemeinsam feiern", Paare, die sich in den Armen liegen. Die taz beschrieb dieses Muster treffend mit „Alles für euch, meine Lieben" – eine Formulierung, die genau die Zweier-Grundhaltung trifft: sich selbst über die Hingabe an andere zu definieren, statt die eigene Strahlkraft nur zur Schau zu stellen.</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Fischer selbst hat offen eingeräumt, dass ihr Perfektionismus sie manchmal „selbst nervt" und ihr die innere Ruhe nimmt. Diese Ehrlichkeit gegenüber der eigenen Getriebenheit ist selten bei öffentlichen Figuren, die primär über ihre Bühnenpräsenz wahrgenommen werden – und passt zur SX3, die ihre Anstrengung nicht als Last, sondern als selbstverständliche Voraussetzung für den perfekten Auftritt empfindet, selbst wenn sie darunter leidet.</p>
          <p class="vb-intro">Genau hier liegt der entscheidende Unterschied zur sozialen Drei (SO3), mit der Fischer wegen ihrer Rekordshows und ihres öffentlichen Status leicht verwechselt wird: Bei der SO3 ist gesellschaftliches Prestige das eigentliche Ziel – das gesellschaftliche Idealbild von Erfolg zu verkörpern, dauerhaft im öffentlichen Gespräch zu bleiben. Bei der SX3 dagegen konzentriert sich die gesamte Energie auf die unmittelbare, überwältigende Wirkung im einzelnen Moment der Begegnung – auf der Bühne, im direkten Kontakt mit dem Publikum vor ihr –, nicht auf das dauerhafte gesellschaftliche Image dazwischen. Dass Fischer ihr Privatleben so konsequent abschottet, passt genau zu diesem Muster: Die Intensität wird nicht auf ständige öffentliche Präsenz verteilt, sondern vollständig für den einen Abend, die eine Show aufgespart – eine soziale Drei würde ihr Image dagegen auch abseits der Bühne aktiv pflegen und ausstellen.</p>
          <p class="vb-intro">Ihre Töchter hätten sie „sensibler" gemacht, sagt sie, und gleichzeitig „gelassener" – eine Entwicklung, die zeigt, wie der Zweierflügel mit der Zeit stärker zum Tragen kommt: die eigene emotionale Zugänglichkeit wächst, ohne dass die SX3-Grundstruktur der vollständigen, magnetischen Bühnenwirkung verschwindet.</p>
        </blockquote>
        ...
        <h2 class="vb-section">6. Die Sängerin, die ihr Rad ganz oder gar nicht entfaltet</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Helene Fischers Karriere zeigt die sexuelle Drei mit Zweierflügel in einer besonders intensiven Form: kompromissloser Perfektionismus, der körperliche Risiken in Kauf nimmt, gepaart mit einer echten, warmen Hingabe an ein Publikum, dem sie unvergessliche Abende schenken will. Der Pfau schont sich nicht, wenn das Rad sich einmal öffnet – aber er entfaltet es für die, die ihm wichtig sind, nicht aus bloßer Berechnung.</p>
          ${bookTip("wer-du-wirklich-bist-band-1", "Die neun Typen in ihrer Tiefe – Schutzmuster, Leidenschaften und der Weg zur Essenz.", "Wer du wirklich bist – Band 1")}
          ${bookTip("die-verborgene-dynamik-der-27-subtypen", "27 Subtypen: Leidenschaften, Schutzstrategien und Heilungswege aus der therapeutischen Praxis.", "Die verborgene Dynamik der 27 Subtypen")}
          ${bookTip("die-27-persoenlichkeiten-des-enneagramms", "27 Charakterprofile im Vergleich – wie sich die Subtypen desselben Typs voneinander unterscheiden.", "Die 27 Persönlichkeiten des Enneagramms")}
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Seit über 30 Jahren begleitet Lange Führungskräfte internationaler Konzerne in Europa, Asien und den USA. Medien wie „Stern", „Spiegel" und „Focus" zählten ihn zu den wichtigsten Erfolgsstrategen Deutschlands, sein Buch „Sieger erkennt man bereits am Start" bündelt seinen zentralen Ansatz: Haltung und Perspektive entscheiden über Erfolg oder Scheitern, lange bevor die eigentliche Herausforderung beginnt.</p>
          <p class="vb-intro">Bezeichnend für die SE1w9 ist dabei, dass Lange trotz seiner charismatischen, bildreichen Rhetorik als jemand beschrieben wird, der Konflikte nicht scheut, die echte Veränderung erfordern &ndash; die innere Ruhe des Neunerflügels macht ihn nicht konfliktscheu, sondern gibt ihm die Gelassenheit, unbequeme Wahrheiten auszusprechen, ohne selbst aus der Fassung zu geraten.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Fairerweise gehört dazu auch eine Einordnung: So authentisch dieser Weg gelebt ist, bleibt er im Kern der eines bewussten, integrierten selbsterhaltenden Einsers mit Neunerflügel &ndash; und was Lange als allgemeingültigen Weg zu innerer Klarheit vermittelt, ist zunächst einmal <em>sein</em> Weg, geprägt von seinem eigenen Subtyp. Das kann, wie die Enneagrammlehre selbst zeigt, nicht für jeden Menschen in gleicher Weise der richtige Ansatz sein. Da jedoch die wenigsten Coachees das Enneagramm kennen, schmälert das seine Leistung nicht: Bewusste Einser besitzen gerade die Fähigkeit, aus der eigenen, selbst durchlebten Wahrheit heraus Einsichten zu formulieren, die weit über den eigenen Subtyp hinaus für viele Menschen gültig und hilfreich sind &ndash; und sie didaktisch klug, lebenserfahren und ohne erhobenen Zeigefinger an ihre Coachees weiterzugeben.</p>
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der soziale Subtyp der Drei, den man als <strong>Verstärkungstyp</strong> bezeichnet, sucht Bedeutung nicht in stiller, privater Leistung, sondern in sichtbarer Wirkung im sozialen und gesellschaftlichen Raum. William James hat diesen Antrieb in eine ganze wissenschaftliche Disziplin übersetzt: 1875 richtete er an der Harvard University eines der ersten psychologischen Laboratorien der Vereinigten Staaten ein und positionierte sich damit als Gründungsfigur der amerikanischen Psychologie – zu einem Zeitpunkt, als dieses Feld akademisch kaum existierte.</p>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das <strong>Flusspferd</strong> ist das Tier der selbsterhaltenden Zwei: warm, stolz, mit einem ausgeprägten Gespür dafür, wer im eigenen Umfeld Fürsorge braucht. Madison Chock wurde 1992 in Redondo Beach, Kalifornien, geboren – väterlicherseits chinesisch-hawaiianischer, mütterlicherseits europäischer Abstammung – und begann mit fünf Jahren, Eis zu laufen. 2011 fand sie mit Evan Bates eine neue Partnerschaft, die sie über vier Olympische Winterspiele hinweg zu drei Weltmeistertiteln, sechs US-Meistertiteln und mehreren olympischen Medaillen führte.</p>

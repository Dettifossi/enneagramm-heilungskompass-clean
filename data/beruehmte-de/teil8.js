  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das <strong>Gürteltier</strong> ist das Tier der sozialen Vier: Es trägt seine Verletzlichkeit sichtbar auf der Haut und sucht die Gruppe, gerade weil es sich in ihr nie ganz zugehörig fühlt. Kaum ein deutscher Liedermacher hat diese Grundhaltung so beständig zur Kunstform gemacht wie Reinhard Mey: seit über fünf Jahrzehnten allein mit Gitarre auf der Bühne, mit Texten, die durchgängig von Wehmut, Verlust und der eigenen, unverwechselbaren Wahrnehmung der Welt geprägt sind.</p>
        ...
        <h2 class="vb-section">2. Die soziale Vier: Zugehörigkeit über das Publikum, nicht über den Mainstream</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>soziale Vier (SO4)</strong> trägt die Vierer-Grundüberzeugung &ndash; <em>ich bin anders als die anderen</em> &ndash; direkt in die Gruppe hinein und sucht dort, über das eigene Publikum, eine Form von Zugehörigkeit, die im Alltag oft fehlt. Naranjo beschreibt diesen Subtyp über das Element der <em>Scham</em>: die ständige Suche nach Bestätigung durch genau die Gemeinschaft, von der man sich zugleich unterschieden fühlt.</p>
          <p class="vb-intro">Mey hat nie einen Hehl daraus gemacht, dass ihm der Schlager fremd ist und er seiner eigenen Musik bewusst einen Gegenpol dazu setzen wollte &ndash; eine klare, eigensinnige Positionierung, die er über Jahrzehnte trotz kommerziellem Erfolgsdruck beibehielt. Über 1300 Konzerte in fünf Ländern zeugen von einer Karriere, die auf genau diesem Prinzip beruht: die eigene, unverwechselbare Stimme immer wieder einem großen Publikum vorzutragen, ohne sich ihm anzupassen.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Dreierflügel: Über fünf Jahrzehnte auf der Bühne</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Dreierflügel (w3)</strong> verwandelt die introspektive Traurigkeit der Vier in aktives Streben nach Sichtbarkeit. Mey selbst hat in Interviews betont, dass er zu Hause kaum singt, weil er dort "keine Show abliefern" wolle &ndash; eine klare Trennung zwischen dem authentischen privaten Ich und dem Bühnen-Ich, die typisch für den Dreierflügel ist: Das eigene Innenleben wird nicht ständig ausgestellt, sondern gezielt für die Bühne reserviert, wo es wirken kann.</p>
          <p class="vb-intro">"Über den Wolken" (1974) und unzählige weitere Lieder wurden über Jahrzehnte einem Millionenpublikum vorgetragen &ndash; nicht in stiller Zurückgezogenheit geschrieben und für sich behalten, sondern konsequent auf Wirkung und Verbreitung hin angelegt. Der Dreierflügel weiß: Die eigene Einzigartigkeit muss sichtbar werden, um als Bestätigung zu zählen.</p>
          <p class="vb-intro"><strong>Abgrenzung zur sozialen Sieben:</strong> Angesichts der enormen thematischen Bandbreite seines Werks &ndash; über dreihundert Lieder zwischen Wehmut, Situationskomik und Alltagsbeobachtung, dazu jahrzehntelange, humorvolle Bühnenmoderationen &ndash; könnte man versucht sein, in Mey eher eine soziale Sieben mit Sechserflügel zu erkennen, die rastlos immer neue Themen und Publikumskontakt sucht. Der entscheidende Unterschied liegt jedoch darin, wie er selbst sein Werk verortet: Melancholie benennt er wiederholt und explizit als sein "großes, durchgängiges Thema", nicht als eine von vielen Farben. Die Sieben würde tendenziell vor genau dieser Schwere fliehen, sie mit neuen Themen überdecken; Mey kehrt bis ins hohe Alter bewusst zu ihr zurück &ndash; auch in aktuellen Interviews und Auftritten, Jahre nach dem Tod seines Sohnes, wirkt sein Blick in die Kamera eher still-traurig als heiter-enthusiastisch. Die humorvolle Bandbreite ist bei ihm ein Kontrastmittel zur Melancholie, nicht deren Ersatz &ndash; genau das ist die soziale Vier: Verschiedenheit im Ausdruck, aber ein einziger, nie verlassener emotionaler Grundton.</p>
        </blockquote>

        <h2 class="vb-section">4. Der Verlust des Sohnes und das Lied, das ihn trug</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">2009 erlitt Meys Sohn Maximilian eine schwere Lungenentzündung, die ihn ins Koma versetzte; er starb 2014 im Alter von 32 Jahren, ohne das Bewusstsein wiedererlangt zu haben. Statt diesen Verlust zu verschweigen, verarbeitete Mey ihn öffentlich in Liedern wie "Du bist ein Riese, Max!" &ndash; ermutigend und zugleich rückblickend melancholisch, ein Vater-Sohn-Chanson, das den eigenen Schmerz nicht kommerzialisierte, aber auch nicht verbarg.</p>
          <p class="vb-intro">Auch politisch bezog Mey immer wieder mit großer persönlicher Intensität Stellung: "Nein, meine Söhne geb' ich nicht" (1986) ist eine zutiefst persönliche Absage an Krieg und staatlichen Machtmissbrauch &ndash; kein abstraktes Statement, sondern ein aus der eigenen emotionalen Wahrheit gespeister Protest, typisch für die soziale Vier, die ihre tiefsten Überzeugungen öffentlich, aber persönlich formuliert.</p>
        </blockquote>

        <h2 class="vb-section">5. Licht und Schatten der sozialen Vier</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SO4w3 zeigt sich in Meys Fähigkeit, aus tiefer persönlicher Melancholie Lieder zu schaffen, die Millionen Menschen über Generationen hinweg begleiten &ndash; "Gute Nacht, Freunde", "Annabelle" und viele mehr wurden zu einem festen Bestandteil des deutschsprachigen Liedguts, weil sie echte emotionale Wahrheit trugen, keine erfundene Sentimentalität.</p>
          <p class="vb-intro">Das Schicksalsmuster der Vier ist der <strong>Neid</strong> &ndash; bei Mey sichtbar in seinem konsequenten Widerstand gegen den Mainstream und seiner Sorge, in Klischees eines Genres eingeordnet zu werden, dem er sich nie zugehörig fühlte. Sein streng gehütetes Privatleben &ndash; er ließ sogar gerichtlich ein biografisches Buch verbieten &ndash; zeigt die Schattenseite: die Angst, dass die eigene, sorgfältig kuratierte Einzigartigkeit durch fremde Deutungshoheit beschädigt werden könnte.</p>
        </blockquote>

        <h2 class="vb-section">6. Das Vermächtnis: Das Gürteltier, das seine Wehmut zum Lied machte</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der Heilungsweg der Vier führt von der Frage <em>Werde ich endlich dazugehören, wenn die anderen sehen, wer ich wirklich bin?</em> zur Erkenntnis <em>Ich gehöre bereits dazu, unabhängig davon, ob die Gruppe es bestätigt.</em> Über fünf Jahrzehnte auf der Bühne, treu der eigenen melancholischen Stimme, ohne sich musikalischen Trends anzupassen &ndash; das ist das bleibende Bild der sozialen Vier mit Dreierflügel: Sichtbarkeit, die sich der eigenen emotionalen Wahrheit verdankt, nicht der Anpassung an Erwartungen.</p>
          <p class="vb-intro">Ein interessanter Vergleich im selben Feld der deutschsprachigen Liedkunst ist <a href="javascript:void(0)" data-route="beruehmte-franz-schubert">Franz Schubert</a> (SE6w5) &ndash; bei ihm entsteht die musikalische Feinfühligkeit aus einem gänzlich anderen Grundmuster: häusliche Sicherheit statt öffentlicher Sichtbarkeit. Der Kontrast macht deutlich, wie unterschiedlich zwei Liedermacher-Temperamente zu vergleichbar zeitloser Musik finden können. Mehr dazu im <a href="javascript:void(0)" data-route="beruehmte-franz-schubert">Porträt zu Franz Schubert</a>.</p>
        </blockquote>

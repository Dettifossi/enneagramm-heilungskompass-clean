    ...
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-alan-mcelligott-portrait.jpg" alt="Dr. Alan McElligott – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function anneMcBridePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-anne-mcbride-portrait.jpg" alt="Dr. Anne McBride – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function biruteGaldikasPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-birute-galdikas-portrait.jpg" alt="Dr. Birut\xe9 Galdikas – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function carmenGoglinPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-carmen-goglin-portrait.jpg" alt="Carmen Goglin – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function cynthiaLummisPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-cynthia-lummis-portrait.jpg" alt="Cynthia Lummis – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function diogenesPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-diogenes-portrait.jpg" alt="Diogenes von Sinope – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function hippokratesVonKosPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-hippokrates-von-kos-portrait.jpg" alt="Hippokrates von Kos" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jamaicaKincaidPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jamaica-kincaid-portrait.jpg" alt="Jamaica Kincaid – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function konfuziusPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-konfuzius-portrait.jpg" alt="Konfuzius (Kong Fuzi)" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function leoTolstoiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-leo-tolstoi-portrait.jpg" alt="Leo Tolstoi – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function margotFriedlaenderPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-margot-friedlaender-portrait.jpg" alt="Margot Friedländer – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function pabloPicassoPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-pablo-picasso-portrait.jpg" alt="Pablo Picasso – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        ...
        <p class="krim-portrait-subtitle">Deutscher Liedermacher, geb. 1942 – Tierentsprechung: Faultier</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. Das Faultier mit der Gitarre</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das <strong>Faultier</strong> ist das Tier der sexuellen Neun: Es spart seine Energie, bis es sich mit etwas oder jemandem vollständig verbindet &ndash; und dann geht es ganz darin auf. Kaum ein deutscher Liedermacher zeigt diese Verschmelzung so unmittelbar wie Reinhard Mey: seit über fünf Jahrzehnten mutterseelenallein mit Gitarre auf der Bühne, und wenn er ein eigenes Lied vorträgt, ist zwischen Interpret und Song kaum noch eine Grenze zu erkennen.</p>
          <p class="vb-intro">Reinhard Mey, 1942 in Berlin geboren, gehört seit den späten 1960er-Jahren zu den prägendsten Vertretern der deutschen Liedermacher-Szene. Melancholie ist, wie er selbst und zahlreiche Beobachter seines Werks festhalten, sein großes, durchgängiges Thema &ndash; kein bloßes Stilmittel, sondern die Grundfärbung, aus der heraus er über Jahrzehnte schrieb.</p>
        </blockquote>

        <h2 class="vb-section">2. Die sexuelle Neun: Verschmelzung mit dem Lied statt mit dem Publikum</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>sexuelle Neun (SX9)</strong> sucht nach Naranjo nicht Zugehörigkeit zu einer Gruppe, sondern die eine, vollständige Verschmelzung &ndash; mit einem Menschen, einem Werk, einer Sache. Der eigene Wille tritt dabei zurück, oft bis zur Unsichtbarkeit: Was der andere möchte, was das Lied verlangt, wird wichtiger als eine eigene Präferenz. Mey selbst hat das in einem Interview so beschrieben: Spielmann zu werden sei sein Kindertraum gewesen, ist es "als junger Wilder" gewesen und ist "noch heute der Traum des wilden alten Mannes" &ndash; keine Karriereplanung, sondern eine lebenslange Sehnsucht, ganz in dieser einen Sache aufzugehen.</p>
          <p class="vb-intro">Auf der Bühne zeigt sich das unmittelbar in seinem Vortragsstil: Mey inszeniert seine Lieder nicht, er verschmilzt mit ihnen, während er sie singt &ndash; ein Verschwinden im eigenen Material, das mit dem Kalkül eines auf Wirkung bedachten Auftritts wenig zu tun hat. Genau diese Ambivalenz gehört zur SX9: die Verbindung mit dem eigenen Publikum ist real und wichtig, aber die eigentliche Verschmelzung findet zuerst mit dem Lied selbst statt, "mutterseelenallein" auf der Bühne, wie er es selbst formuliert.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Einserflügel: Fünf Stunden vorher, jedes Lied einmal ganz</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Eine Neun mit schwach ausgeprägtem Einserflügel würde sich eher treiben lassen; der <strong>Einserflügel</strong> bringt bei Mey ein striktes, über Jahrzehnte unverändertes Ritual mit: Er erscheint rund fünf Stunden vor einem großen Auftritt in der Halle, macht einen gründlichen Soundcheck &ndash; und spielt danach, allein, das gesamte Konzertprogramm einmal vollständig durch, egal wie oft er es schon gespielt hat. Erst danach traut er sich auf die Bühne. Nach eigener Aussage geht das auf eine frühe Erfahrung zurück, bei der ihm auf der Bühne der Faden verloren gegangen war und er vom Publikum wieder eingefangen werden musste &ndash; seither lässt er nichts mehr dem Zufall.</p>
          <p class="vb-intro">Dazu passt, dass Mey sein Lampenfieber nicht als etwas beschreibt, das mit der Erfahrung von über fünfzig Jahren nachgelassen hätte, sondern als tägliche Konstante: "Es ist jeden Abend da. Es ist der Motor, der mich antreibt … der Wettkampf mit mir selbst, der freie Fall, der Triumph über die Angst." Das ist die typische Verschiebung der Neun unter Stress in Richtung ihres Stresspunkts Sechs: die sonst so gelassene Verschmelzung mit dem Moment weicht kurz vor dem Auftritt einer geradezu zwanghaften Kontrollbedürftigkeit, die erst durch das vollständige, disziplinierte Durchspielen wieder beruhigt wird.</p>
          <p class="vb-intro"><strong>Abgrenzung zur sozialen Vier:</strong> Auf den ersten Blick könnte man in Mey eine soziale Vier mit Dreierflügel vermuten &ndash; ein Solist, der sich mit unverwechselbarer, durchgängig melancholischer Stimme bewusst vom Mainstream abhebt. Der entscheidende Unterschied liegt jedoch darin, worum es ihm eigentlich geht: Die soziale Vier sucht über ihr Publikum eine Bestätigung des eigenen Andersseins &ndash; <em>seht, wie einzigartig ich bin</em>. Mey selbst beschreibt sein Ziel jedoch nie als Wunsch nach Anerkennung der eigenen Besonderheit, sondern als Sehnsucht nach dem restlosen Aufgehen im Handwerk selbst: "Ich möchte gern weiter schreiben, wieder mit meinen Freunden im Studio musizieren und irgendwann wieder mutterseelenallein auf die Bühne gehen und meine Lieder singen, für immer." Das ist keine Suche nach Zugehörigkeit oder Bestätigung durch eine Gruppe, sondern die Sehnsucht nach Verschmelzung selbst &ndash; mit Freunden im Studio ebenso wie, ganz allein, mit dem Lied auf der Bühne. Auch sein extrem geschütztes Privatleben passt eher zur SX9 als zur SO4: Es geht ihm nicht um die Verteidigung einer kuratierten Einzigartigkeit, sondern schlicht darum, dass die eine, zentrale Bindung &ndash; seine Familie &ndash; ungestört bleibt.</p>
        </blockquote>

        <h2 class="vb-section">4. Der Verlust des Sohnes und das Kind, das groß werden durfte</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">2009 erlitt Meys Sohn Maximilian eine schwere Lungenentzündung, die ihn ins Koma versetzte; er starb 2014 im Alter von 32 Jahren, ohne das Bewusstsein wiedererlangt zu haben. Mey machte diesen Verlust nie zum öffentlichen Dauerthema, verarbeitete ihn aber in dem Lied "Du bist ein Riese, Max!" &ndash; darin auch der Gedanke, wie Eltern ihre Kinder durch Erziehung oft klein statt groß werden lassen. Genau das war sein erklärtes erzieherisches Prinzip: seinen Söhnen bewusst viel Freiraum zu lassen, sie "sein zu lassen", statt sie in eine bestimmte Form zu drängen &ndash; die Stärke der Neun, dem anderen uneingeschränkte Aufmerksamkeit zu schenken, auch auf Kosten der eigenen.</p>
          <p class="vb-intro">Auch politisch bezog Mey mit großer persönlicher Intensität Stellung: "Nein, meine Söhne geb' ich nicht" (1986) ist eine zutiefst persönliche Absage an Krieg und staatlichen Machtmissbrauch &ndash; kein abstraktes Statement, sondern die unmittelbare Verschmelzung der eigenen Vaterschaft mit einem politischen Thema, das ihn existenziell betraf.</p>
        </blockquote>

        <h2 class="vb-section">5. Licht und Schatten der sexuellen Neun</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SX9w1 zeigt sich in Meys Fähigkeit, aus vollständiger Hingabe an sein Handwerk Lieder zu schaffen, die Millionen Menschen über Generationen hinweg begleiten &ndash; "Gute Nacht, Freunde", "Annabelle" und viele mehr wurden zu einem festen Bestandteil des deutschsprachigen Liedguts, weil in ihnen echte Verschmelzung steckt, keine kalkulierte Performance.</p>
          <p class="vb-intro">Die Schattenseite der Neun ist die Selbstvergessenheit: die eigenen Bedürfnisse hinter denen des anderen zurückzustellen, bis sie kaum noch spürbar sind. Mey selbst hat das nie ausdrücklich thematisiert, aber sein Muster passt genau dorthin: für die Menschen, die ihm nahestehen, alles zu tun, während er selbst kaum als jemand mit eigenen Vorlieben in Erscheinung tritt &ndash; ganz Werkzeug seines Liedes, seiner Familie, seines Publikums, selten sichtbar als jemand mit einem eigenen, unabhängigen Wollen.</p>
        </blockquote>

        <h2 class="vb-section">6. Das Vermächtnis: Das Faultier, das mit seinem Lied verschmolz</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der Heilungsweg der Neun führt von der Selbstvergessenheit <em>Ich zähle nicht, solange die Verbindung bleibt</em> zur Erkenntnis <em>Ich bin bereits da, mit eigenem Gewicht, auch innerhalb der Verschmelzung.</em> Über fünf Jahrzehnte auf der Bühne, mutterseelenallein und doch nie wirklich allein, weil er sich restlos in sein Lied hineingibt &ndash; das ist das bleibende Bild dieser sexuellen Neun mit Einserflügel: Präsenz, die aus vollständiger Hingabe entsteht, nicht aus dem Wunsch, gesehen zu werden.</p>
          <p class="vb-intro">Wie unauffällig diese jahrzehntelange Hingabe an das eigene Handwerk tatsächlich wirkte, zeigte sich erst 2026: Der Bundesverband Musikindustrie stellte bei einer Datenüberprüfung fest, dass zahlreiche Alben aus den Jahren 1975 bis 2000 trotz hoher Verkaufszahlen nie offiziell mit einer Goldenen Schallplatte ausgezeichnet worden waren &ndash; Mey erhielt daraufhin, mit über vierzig Jahren Verspätung, mindestens 23 zusätzliche Gold- und Platin-Auszeichnungen. Kein Nachruhm, den er selbst gesucht hätte, sondern die stille Bestätigung eines Lebenswerks, das sich nie über seinen kommerziellen Erfolg definierte.</p>
          <p class="vb-intro">Ein aufschlussreicher Vergleich im internationalen Musikbetrieb ist <a href="javascript:void(0)" data-route="beruehmte-jon-bon-jovi">Jon Bon Jovi</a> (SX9w1) &ndash; bei ihm zeigt sich dieselbe Verschmelzungsfähigkeit sowohl in einer seit 1989 ungebrochenen Ehe als auch in der Treue zu derselben Band seit 1983. Mehr dazu im <a href="javascript:void(0)" data-route="beruehmte-jon-bon-jovi">Porträt zu Jon Bon Jovi</a>.</p>
        </blockquote>
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-jon-bon-jovi", label:"Porträt: Jon Bon Jovi (SX9w1)"},
...
export function sandraHuellerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-sandra-hueller-portrait.jpg" alt="Sandra H\xfcller – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function taddlPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-taddl-portrait.jpg" alt="Taddl (Daniel Tjarks) – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function tuttyTranPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-tutty-tran-portrait.jpg" alt="Tutty Tran – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function winifredCharlesworthPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-winifred-charlesworth-portrait.jpg" alt="Mrs. Winifred Charlesworth – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function lindaEvansPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-linda-evans-portrait.jpg" alt="Linda Evans – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-christoph-waltz", label:"Porträt: Christoph Waltz (SE1w2)"},
        {route:"beruehmte-ben-berndt", label:"Porträt: Ben Berndt (SE1w2)"},

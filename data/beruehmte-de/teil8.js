    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Denselben unverwechselbaren, nie abgelegten Hut als tägliches Erkennungszeichen tragen auch <a href="javascript:void(0)" data-route="beruehmte-gunther-von-hagens">Gunther von Hagens</a> und <a href="javascript:void(0)" data-route="beruehmte-udo-lindenberg">Udo Lindenberg</a> (beide SX1w9) – bei allen dreien ist der Hut keine Mode, sondern dieselbe präventiv aufgebaute Schutzrüstung des Bauchzentrums, öffentlich zur Schau getragen. Mehr dazu in den Porträts zu <a href="javascript:void(0)" data-route="beruehmte-gunther-von-hagens">Gunther von Hagens</a> und <a href="javascript:void(0)" data-route="beruehmte-udo-lindenberg">Udo Lindenberg</a>.</p>
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das <strong>Gürteltier</strong> ist das Tier der sozialen Vier: ein Panzer aus Zurückhaltung, unter dem sich eine tiefe, oft schmerzhafte Empfindsamkeit verbirgt. Reinhard Mey verkörpert genau diese Kombination: seit über fünf Jahrzehnten einer der erfolgreichsten deutschen Liedermacher, und dennoch nie jemand, der seinen Erfolg zur Schau stellte oder um Aufmerksamkeit warb.</p>
        ...
        <h2 class="vb-section">2. Die soziale Vier: Anderssein verteidigen, nicht zur Schau stellen</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Naranjo nannte die soziale Vier <em>Scham</em>: ein tiefes Gefühl, fundamental anders zu sein als die anderen, kombiniert mit dem Bedürfnis, dieses Anderssein nicht zu verstecken, sondern in einer eigenen, unverwechselbaren Form gesellschaftlich sichtbar zu behaupten. Ein besonders klares Beispiel dafür lieferte Mey selbst: Er lehnte eine ECHO-Nominierung ab, weil sie ihn in die Kategorie "Deutscher Schlager" einordnete &ndash; eine Einordnung, die er als Beleidigung empfand. Das ist keine Eitelkeit, sondern die soziale Vier in Reinform: die eigene künstlerische Identität aktiv gegen eine als unpassend empfundene Kategorisierung verteidigen, statt sich stillschweigend einzureihen.</p>
          <p class="vb-intro">Auch sein politisches Engagement folgt diesem Muster: "Nein, meine Söhne geb' ich nicht" (1986) übersetzt eine zutiefst persönliche Haltung &ndash; die eigene Vaterschaft &ndash; in ein öffentliches, gesellschaftlich wirksames Statement gegen Krieg und staatlichen Machtmissbrauch. Die soziale Vier bleibt nicht in der privaten Verletzlichkeit stehen, sondern übersetzt sie in etwas, das die Gemeinschaft angeht.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Fünferflügel: Beherrschung vor der Bühne, nicht Selbstdarstellung auf ihr</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Eine soziale Vier mit ausgeprägtem Dreierflügel würde ihre Besonderheit aktiv inszenieren &ndash; Bühnenpräsenz, Image, sichtbarer Erfolg als Bestätigung des eigenen Andersseins. Bei Mey zeigt sich stattdessen der <strong>Fünferflügel</strong>: Er erscheint rund fünf Stunden vor einem großen Auftritt in der Halle, macht einen gründlichen Soundcheck &ndash; und spielt danach, allein, das gesamte Konzertprogramm einmal vollständig durch, egal wie oft er es schon gespielt hat. Erst danach traut er sich auf die Bühne. Das ist keine Show, sondern das Bedürfnis des Fünferflügels, vollständige Beherrschung des eigenen Materials herzustellen, bevor er sich der Öffentlichkeit aussetzt &ndash; Kompetenz als Schutz vor Verletzlichkeit, nicht Auftritt als Selbstzweck.</p>
          <p class="vb-intro">Dazu passt, dass er trotz über fünfzig Jahren Bühnenerfahrung von Lampenfieber spricht, das nie nachgelassen habe: "Es ist jeden Abend da. Es ist der Motor, der mich antreibt … der Wettkampf mit mir selbst, der freie Fall, der Triumph über die Angst." Und dazu passt auch sein extrem geschütztes Privatleben: Es geht ihm nicht darum, seine Besonderheit öffentlich zu inszenieren, sondern darum, sie in einem streng kontrollierten, selbst gewählten Rahmen zu bewahren &ndash; genau die Rückzugstendenz, die der Fünferflügel der sozialen Vier hinzufügt.</p>
        </blockquote>

        <h2 class="vb-section">4. Der Verlust des Sohnes: privater Schmerz, öffentlich verarbeitet</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">2009 erlitt Meys Sohn Maximilian eine schwere Lungenentzündung, die ihn ins Koma versetzte; er starb 2014 im Alter von 32 Jahren, ohne das Bewusstsein wiedererlangt zu haben. Mey machte diesen Verlust nie zum öffentlichen Dauerthema, verarbeitete ihn aber in dem Lied "Du bist ein Riese, Max!" &ndash; darin auch der Gedanke, wie Eltern ihre Kinder durch Erziehung oft klein statt groß werden lassen. Genau das ist die soziale Vier in ihrer konstruktivsten Form: das zutiefst Persönliche nicht zu verschweigen, sondern in eine Form zu bringen, die anderen Menschen in ähnlichem Schmerz etwas zu sagen hat &ndash; Kunst als Übersetzung der eigenen Wunde in etwas gesellschaftlich Tragfähiges.</p>
          <p class="vb-intro">Sein erklärtes erzieherisches Prinzip &ndash; seinen Söhnen bewusst viel Freiraum zu lassen, sie "sein zu lassen", statt sie in eine bestimmte Form zu drängen &ndash; liest sich wie die eigene Erfahrung des Andersseins, die er seinen Kindern ersparen wollte.</p>
        </blockquote>

        <h2 class="vb-section">5. Licht und Schatten der sozialen Vier mit Fünferflügel</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SO4w5 zeigt sich in Meys Fähigkeit, aus zutiefst persönlicher Melancholie Lieder zu schaffen, die Millionen Menschen über Generationen hinweg begleiten &ndash; "Gute Nacht, Freunde", "Annabelle" und viele mehr wurden zu einem festen Bestandteil des deutschsprachigen Liedguts, weil in ihnen echtes, kontrolliert verarbeitetes Anderssein steckt, keine kalkulierte Pose.</p>
          <p class="vb-intro">Der Schatten liegt in der Gefahr, dass die Rückzugstendenz des Fünferflügels die eigene Andersartigkeit so weit vor der Öffentlichkeit abschirmt, dass sie kaum noch als Person, sondern nur noch als Werk wahrgenommen wird &ndash; Mey selbst tritt öffentlich fast ausschließlich als Stimme seiner Lieder in Erscheinung, kaum als Privatperson mit eigenen Bedürfnissen jenseits des Handwerks.</p>
        </blockquote>

        <h2 class="vb-section">6. Das Vermächtnis: Das Gürteltier, das seine Besonderheit nie zur Schau stellte</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der Heilungsweg der Vier führt von der Scham <em>Ich bin fundamental anders und mangelhaft</em> zur Erkenntnis <em>Ich bin ganz normal, auch in meiner Besonderheit.</em> Über fünf Jahrzehnte auf der Bühne, allein mit Gitarre und dennoch nie um Aufmerksamkeit werbend &ndash; das ist das bleibende Bild dieser sozialen Vier mit Fünferflügel: Andersartigkeit, die sich selbst genügt, statt sich beweisen zu müssen.</p>
          <p class="vb-intro">Wie unauffällig dieser jahrzehntelange Verzicht auf Selbstinszenierung tatsächlich wirkte, zeigte sich erst 2026: Der Bundesverband Musikindustrie stellte bei einer Datenüberprüfung fest, dass zahlreiche Alben aus den Jahren 1975 bis 2000 trotz hoher Verkaufszahlen nie offiziell mit einer Goldenen Schallplatte ausgezeichnet worden waren &ndash; Mey erhielt daraufhin, mit über vierzig Jahren Verspätung, mindestens 23 zusätzliche Gold- und Platin-Auszeichnungen. Kein Nachruhm, den er selbst gesucht hätte, sondern die stille Bestätigung eines Lebenswerks, das sich nie über kommerziellen Erfolg definierte.</p>
          <p class="vb-intro">Ein aufschlussreicher Vergleich im internationalen Musikbetrieb ist <a href="javascript:void(0)" data-route="beruehmte-leonard-cohen">Leonard Cohen</a> (SO4w5) &ndash; bei ihm zeigt sich dieselbe Kombination aus tiefer, öffentlich verarbeiteter Melancholie und einem zurückgezogenen, kaum inszenierten Auftreten. Mehr dazu im <a href="javascript:void(0)" data-route="beruehmte-leonard-cohen">Porträt zu Leonard Cohen</a>.</p>
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      ${relatedLinks([
        ...
        {route:"krankheitsportraets-wim-thoelke", label:"Krankheitsporträt: Wim Thoelke – die Herzerkrankung hinter der Sendung"},
      ])}
    </div>
  `);
}

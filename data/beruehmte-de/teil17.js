  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>sexuelle Vier (SX4)</strong> trägt den Schmerz der Vier nicht nach innen, sondern schleudert ihn nach außen &ndash; Naranjo nannte diesen Subtyp <em>Rivalität</em> und lehrte ausdrücklich, dass die SX4 im Ausdruck noch aggressiver werden kann als so manche anderen assertiven Subtypen des Enneagramms, etwa die soziale Acht (SO8): Wo die SX8 aus ungebrochener Kraft heraus konfrontiert, entlädt die SX4 eine angestaute, oft jahrzehntelang mitgetragene Wut &ndash; und genau diese Intensität im Blick führt dazu, dass beide Subtypen im ersten Eindruck leicht verwechselt werden.</p>

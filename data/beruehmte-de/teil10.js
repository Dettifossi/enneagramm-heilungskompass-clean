    ...
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-albert-schweitzer-portrait.jpg" alt="Dr. Albert Schweitzer – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function anthonyHopkinsPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-anthony-hopkins-portrait.jpg" alt="Anthony Hopkins – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function bobMarleyPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-bob-marley-portrait.jpg" alt="Bob Marley – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function carstenStahlPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-carsten-stahl-portrait.jpg" alt="Carsten Stahl – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        ${relatedLinks([
          ...
          {route:"beruehmte-peter-sage", label:"Portr\xe4t: Peter Sage (SO8w7)"},
        ])}
      </div>
    </div>
  `);
...
export function dakotaJohnsonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-dakota-johnson-portrait.jpg" alt="Dakota Johnson – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function dollyPartonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-dolly-parton-portrait.jpg" alt="Dolly Parton – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Dabei lohnt sich ein genauerer Blick auf das Begriffspaar selbst: Stärke und Schönheit sind bei der SX6 keine zwei getrennten Strategien, sondern oft zwei Seiten derselben Münze. Gerade bei Frauen, die sich stark über den eigenen Körper definieren, wird Schönheit nicht als Gegensatz zu Stärke gelebt, sondern als ihr unmittelbarer Ausdruck: Wer sich souverän, makellos und unwiderstehlich zeigt, demonstriert damit ebenso viel Kontrolle über die eigene Wirkung wie eine offen konfrontative Präsenz. Bei Mendes verschmelzen beide Pole sichtbar ineinander – ihre Kampagnenbilder wirken nicht trotz, sondern gerade wegen ihrer betonten Schönheit kraftvoll und selbstbestimmt. Schönheit wird hier zur Waffe gegen die Angst, nicht zur Ablenkung von ihr.</p>
...
export function gustavMahlerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-gustav-mahler-portrait.jpg" alt="Gustav Mahler – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jamesLevinePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-james-levine-portrait.jpg" alt="James Levine – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function kaiPflaumePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-kai-pflaume-portrait.jpg" alt="Kai Pflaume – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function konradLorenzPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-konrad-lorenz-portrait.jpg" alt="Konrad Lorenz – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function lionelBoycePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-lionel-boyce-portrait.jpg" alt="Lionel Boyce – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function mariahCareyPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-mariah-carey-portrait.jpg" alt="Mariah Carey – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function mutterMeeraPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-mutter-meera-portrait.jpg" alt="Mutter Meera – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function parisHiltonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-paris-hilton-portrait.jpg" alt="Paris Hilton – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function tELawrencePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-t-e-lawrence-portrait.jpg" alt="T. E. Lawrence (Lawrence von Arabien)" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function wladimirPutinPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-wladimir-putin-portrait.jpg" alt="Wladimir Putin – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function robertCrumbPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-robert-crumb-portrait.jpg" alt="Robert Crumb \u2013 Portr\u00e4t" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function arminMuellerStahlPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-armin-mueller-stahl-portrait.jpg" alt="Armin Mueller-Stahl – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-ellen-degeneres", label:"Porträt: Ellen DeGeneres (SE6w5)"},
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        ...
        <p class="krim-portrait-typ">SX6w5 &middot; Sexueller Typ 6 mit Fünferflügel</p>
        <p class="krim-portrait-subtitle">Schachweltmeister, größtes Schachgenie der Geschichte, 1943&ndash;2008 &ndash; Tierentsprechung: Wolf</p>
      </div>
      <div class="page-content">
        ...
        <h2 class="vb-section">2. Das Genie am Brett: Vorbereitung als Waffe gegen die Angst</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Schon mit dreizehn Jahren lieferte Fischer 1956 gegen Donald Byrne die später als „Partie des Jahrhunderts" berühmt gewordene Kombination: Er opferte seine Dame, um einen unaufhaltsamen Angriff freizusetzen – bis heute weltweit unterrichtet. Der Großmeister David Bronstein sagte später: „Lange konnte ich nicht verstehen, warum dieser fünfzehnjährige Junge so brillant spielte." Das war kein Zufallstreffer: Fischer bereitete sich mit einer Gründlichkeit vor, die selbst sowjetische Berufsspieler überraschte. In Moskau entdeckte er 1958 in fremdsprachiger Fachliteratur theoretische Ideen, die dortige Experten übersehen hatten; er brachte sich selbst Russisch bei, nur um sowjetische Schachzeitschriften im Original lesen zu können, die kein Konkurrent sonst studierte.</p>
          <p class="vb-intro">Diese Vorbereitungsintensität ist reine SX6w5-Logik: Der Fünferflügel liefert die Fähigkeit zur erschöpfenden, einsamen Aneignung von Wissen, das andere übersehen; die sexuelle Sechs verwandelt dieses Wissen in eine Waffe gegen die eigene Angst, überrascht oder ausgetrickst zu werden. Bei seinem Kandidatenmatch 1971 gegen Mark Taimanov fand Fischer einen Zug aus einer Fußnote einer sowjetischen Fachmonographie – ausgerechnet Taimanov, selbst Sizilianisch-Experte, hatte sie übersehen. Fischer gewann 6:0. Wenige Wochen später gewann er ebenfalls 6:0 gegen Bent Larsen, danach 6½:2½ gegen Tigran Petrossjan – eine zwanzig Partien lange Siegesserie gegen Weltklassespieler ohne eine einzige Niederlage, die es davor und danach in dieser Form nie wieder gab. Petrossjan sagte später, Fischer sei nach dem sechsten Spiel „zum Genie geworden", während er selbst „zusammengebrochen" sei; Garry Kasparov nannte diese Bilanz eine Überlegenheit über Rivalen, wie sie niemand sonst je gezeigt habe.</p>
          <p class="vb-intro">Auch sein Spielstil selbst war nie defensiv-abwartend, sondern konfrontativ und angriffslustig – er suchte die offene, komplikationsreiche Stellung, in der er seinem Gegner keine ruhige Sekunde ließ. Das ist dieselbe Bewegung, die auch sein Leben außerhalb des Bretts prägte: Angst wird nicht vermieden, sondern durch totale, erdrückende Vorbereitung und frontalen Angriff neutralisiert, bevor sie überhaupt zur Bedrohung werden kann.</p>
        </blockquote>

        <h2 class="vb-section">3. Die sexuelle Sechs: Von berechtigtem Verdacht zur globalen Paranoia</h2>
        <blockquote class="vb-blockquote">
        ...
        <h2 class="vb-section">4. Der Fünferflügel: Rückzug in ein sicheres Territorium</h2>
        <blockquote class="vb-blockquote">
        ...
        <h2 class="vb-section">5. Kontrolle als Preis für das Spielen</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Vor dem WM-Match 1972 gegen Spassky in Reykjavik zeigten sich Fischers Kontrollansprüche in extremer Form: Er weigerte sich anzureisen, bis das Preisgeld um zusätzliche 125.000 Dollar erhöht wurde, stritt wochenlang über den Austragungsort und ließ sich siebzehn Maßanzüge schneidern, um jedes Detail seiner öffentlichen Erscheinung selbst zu bestimmen. Ungewöhnlich für einen Großmeister seiner Zeit trainierte er zusätzlich intensiv Tennis und Fitness, um auch körperlich für die Ausdauer langer Partien gerüstet zu sein – Kontrolle, die sich auf den eigenen Körper genauso erstreckte wie auf die äußeren Bedingungen. Während des Matches forderte er ständig neue Bedingungen – Kontrolle über das gesamte Umfeld war für ihn keine Nebensache, sondern Voraussetzung für Sicherheit überhaupt.</p>
        ...
        <h2 class="vb-section">6. Licht und Schatten der sexuellen Sechs mit Fünferflügel</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SX6w5 zeigt sich in Fischers beispiellosem 11:0-Ergebnis beim US-Meisterschaftsfinale 1963/64 gegen die stärksten amerikanischen Spieler seiner Zeit – eine Konzentration und Wachsamkeit, die keine Schwachstelle im eigenen Spiel je unbeachtet ließ, wurde zur größten kombinatorischen Klarheit der Schachgeschichte. Der sowjetische Großmeister Juri Awerbach beschrieb ihn schon 1958 als jemanden mit „erstaunlicher Ausgeglichenheit, präziser Berechnung und diabolischem Einfallsreichtum" – eine Wachsamkeit, die sich in reine Genialität übersetzte, solange sie an das Schachbrett gebunden blieb.</p>
        ...
        <h2 class="vb-section">7. Der Wolf, der sein eigenes Rudel verlor</h2>
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Und doch bleibt, unabhängig von allem, was danach kam: Fischers reine schachliche Leistung – die zwanzig Partien lange Siegesserie ohne Niederlage gegen die stärksten Spieler seiner Zeit, das nie wiederholte 11:0 von 1963/64, der Weltmeistertitel 1972, den er im Alleingang gegen die geschlossene Übermacht der sowjetischen Schachschule errang – gilt bis heute als eine der größten individuellen Leistungen der Sportgeschichte überhaupt. Das ist kein Widerspruch zu allem Gesagten, sondern gehört untrennbar zusammen: Dieselbe kompromisslose, furchtlose Wachsamkeit, die ihn am Ende in Isolation und Wahn trieb, war exakt die Kraft, die ihn zuvor zum wohl größten Schachspieler machte, den es je gegeben hat.</p>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Waschbär</strong> ist das Tier der selbsterhaltenden Drei &ndash; ein Pragmatiker, der sich nicht auf Talent verlässt, sondern auf erprobte, jahrelang eingeübte Lösungswege. Enrico Caruso, 1873 in Neapel als Sohn eines Metallarbeiters und einer Putzfrau geboren, arbeitete ab seinem zehnten Lebensjahr in der Gießerei seines Vaters, bevor er mit achtzehn Jahren die erste ernsthafte Gesangsausbildung erhielt. Nur drei Jahre später debütierte er auf der Opernbühne &ndash; kein Wunderkind im klassischen Sinne, aber ein Sänger mit einer tatsächlich außergewöhnlichen stimmlichen Anlage, die er sich durch harte, systematische Arbeit erst nutzbar machte.</p>
          <p class="vb-intro">Denn was Carusos Ruhm am Ende trug, war eine wirklich seltene Stimme: ein Timbre, das die dunkle Wärme und Fülle eines Baritons im unteren Register mit dem strahlenden Glanz eines Tenors in der Höhe verband &ndash; eine Klangfarbe, die Kritiker sofort als unverwechselbar erkannten. Hinzu kam eine Atemtechnik von legendärer Präzision: Caruso dosierte für jeden einzelnen Ton exakt so viel Atem, wie gebraucht wurde, nicht mehr und nicht weniger &ndash; daraus entstanden seine makellose Intonation, ein außergewöhnlich langer, tragender Legato-Bogen und Töne, die scheinbar mühelos endlos gehalten werden konnten. Diese Stimme traf zudem genau in dem Moment auf die Opernwelt, als der Übergang vom romantischen zum kraftvolleren, dramatischeren Verismo-Tenor stattfand &ndash; Caruso prägte diesen neuen Klang entscheidend mit und wurde damit zum Vorbild für spätere Jahrhunderttenöre wie Pavarotti, Domingo und Carreras.</p>
          <p class="vb-intro">Sein eigenes Erfolgsrezept, das er selbst formulierte, liest sich dennoch fast wie ein Manifest dieses Subtyps: ›Eine große Brust, ein großer Mund, neunzig Prozent Gedächtnis, zehn Prozent Intelligenz, viel harte Arbeit und etwas im Herzen.‹ Kein Wort über die eigene, tatsächlich außergewöhnliche Begabung &ndash; nur über Arbeit, Technik und Disziplin. Genau diese Untertreibung des eigenen Talents zugunsten der reinen Leistung ist selbst schon typisch für den Kontratyp der Drei.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Im Dezember 1920 traf ihn während einer Vorstellung eine herabfallende Bühnensäule im Rücken, kurz darauf entwickelte er Husten und Schmerzen &ndash; sein Arzt diagnostizierte eine harmlose Nervenentzündung und erklärte ihn für bühnentauglich. Am 11. Dezember erlitt er während einer Vorstellung von ›L'elisir d'amore‹ (›Der Liebestrank‹) einen Blutsturz auf offener Bühne. Statt sich zurückzuziehen, gab er danach noch drei weitere Vorstellungen, die letzte am 24. Dezember als Eléazar in ›La Juive‹ (›Die Jüdin‹). Erst als die Schmerzen am Weihnachtstag unerträglich wurden, kam die korrekte Diagnose: eine eitrige Rippenfellentzündung. Quellen benennen ausdrücklich seine ›obsession with honoring his commitments and fear of disappointing his fans‹ &ndash; seine Besessenheit, Verpflichtungen einzuhalten, und seine Angst, seine Fans zu enttäuschen &ndash; als wahrscheinliche Ursache seines vorzeitigen Todes.</p>
        </blockquote>

        <h2 class="vb-section">5. Das Geschenk: Eine Stimme, die nie enttäuschte</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Was Enrico Caruso der Welt gab, war eine beispiellose Verbindung aus einer wahrhaft außergewöhnlichen Stimme, handwerklicher Perfektion und echter menschlicher Wärme &ndash; ein Talent, das erst durch Arbeit zur vollen Wirkung kam, getragen von einer Großzügigkeit, die weit über die Bühne hinausreichte. Er war zugleich Pionier der Schallplattenaufnahme und machte damit die Oper einem Massenpublikum zugänglich, das sie nie live erlebt hätte: Seine 1904 aufgenommene Aufnahme von ›Vesti la giubba‹ aus Leoncavallos ›Pagliacci‹ wurde zur ersten Schallplatte der Geschichte, die sich eine Million Mal verkaufte &ndash; ein Beleg dafür, wie außergewöhnlich diese Stimme selbst durch die primitive Aufnahmetechnik ihrer Zeit noch wirkte.</p>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der Heilungsweg der Eins führt von der Überzeugung <em>Nur das absolut Richtige zählt</em> zur Erkenntnis <em>Ich darf unvollkommen sein und trotzdem gut.</em> Bei von Hagens zeigt sich eine besondere Volte dieses Weges: Er kündigte seine eigene, unheilbare Erkrankung öffentlich an und plante offen, seinen eigenen Körper nach seinem Tod plastinieren und ausstellen zu lassen – die letzte, radikal konsequente Vereinigung von Lehre und eigenem Leben. Seine Familie, allen voran seine Frau Angelina Whalley, hat bestätigt, diesen Wunsch zu respektieren; da eine vollständige Plastination eines menschlichen Körpers jedoch Monate bis Jahre dauert, ist mit einem fertigen, öffentlich gezeigten Plastinat auf absehbare Zeit nicht zu rechnen.</p>

    ...
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-adam-smith-portrait.jpg" alt="Adam Smith – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function andyReidPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-andy-reid-portrait.jpg" alt="Andy Reid – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function bernardFayePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-bernard-faye-portrait.jpg" alt="Dr. Bernard Faye – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function carlFriedrichGaussPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-carl-friedrich-gauss-portrait.jpg" alt="Carl Friedrich Gauß – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function claudioNaranjoPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-claudio-naranjo-portrait.jpg" alt="Dr. Claudio Naranjo – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function eliJaxonBearPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-eli-jaxon-bear-portrait.jpg" alt="Eli Jaxon-Bear – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function franzVonAssisiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-franz-von-assisi-portrait.jpg" alt="Franz von Assisi" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function gloriaVonThurnUndTaxisPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-gloria-von-thurn-und-taxis-portrait.jpg" alt="Gloria von Thurn und Taxis" class="krim-portrait-img" loading="lazy"
...
export function helmutKohlPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-helmut-kohl-portrait.jpg" alt="Helmut Kohl – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
        ...
        <p class="krim-portrait-subtitle">Deutscher Bundeskanzler, 1930&ndash;2017 &ndash; Tierentsprechung: Orang-Utan</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. Der Orang-Utan aus der Pfalz</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Orang-Utan</strong> ist das Tier der selbsterhaltenden Acht &ndash; massiv, geduldig, kaum aus der Ruhe zu bringen. Er braucht kein Publikum, um seine Kraft zu beweisen; er sitzt einfach da, wo er sitzt, und wer ihn verdrängen will, muss ihn erst einmal bewegen. Sein Körper ist gebaut, um zu bleiben &ndash; nicht um zu fliehen.</p>
        ...
        <h2 class="vb-section">2. Die Selbsterhaltungs-Acht: Das eigene Terrain sichern</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>Selbsterhaltungs-Acht (SE8)</strong> drückt die Leidenschaft der Acht &ndash; die <em>Wollust</em>, den Hunger nach uneingeschränkter Intensität &ndash; durch Selbstbehauptung und die unbedingte Sicherung des eigenen Terrains aus. Naranjo nannte diesen Subtyp <em>Satisfacción</em>: Sie verteidigt kompromisslos, was ihr gehört &ndash; nicht als Dienst an einer abstrakten Gemeinschaft, sondern als Absicherung der eigenen Machtbasis und des eigenen engsten Umfelds. Kohls gesamte Karriere war von diesem Muster geprägt: 16 Jahre als Bundeskanzler (1982&ndash;1998), die längste Amtszeit der deutschen Nachkriegsgeschichte, in der er die CDU faktisch zu seinem persönlichen Territorium machte und mit allen Mitteln verteidigte.</p>
          <p class="vb-intro">Sein berühmtestes Machtinstrument war das informelle Netzwerk, das er über Jahrzehnte aufbaute und pflegte &ndash; der &bdquo;Kohl-Clan&ldquo; in der CDU, persönliche Loyalitäten, die er selbst kultivierte und die ihn lange gegen jede parteiinterne Konkurrenz absicherten. Das ist die typische Machtstrategie der selbsterhaltenden Acht: nicht die Fahne einer Sache voranzutragen, sondern das eigene, engste Umfeld so fest zu sichern, dass es in jeder Krise trägt.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Das Bild der beiden Staatsmänner, die sich 1984 in Verdun, dem Symbolort des Ersten Weltkriegs, spontan die Hände reichten, wurde zur Ikone der deutsch-französischen Versöhnung. Für die selbsterhaltende Acht ist das typisch: Die eigene Machtfülle wird eingesetzt, um das eigene Territorium &ndash; Deutschland &ndash; dauerhaft gegen die existenzielle Bedrohung eines neuen Krieges abzusichern, nicht aus Sentimentalität, sondern aus der festen Überzeugung, dass nur ein vereintes Europa das eigene Überleben dauerhaft garantieren kann.</p>
        </blockquote>

        <h2 class="vb-section">5. Licht und Schatten</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SE8w9 ist die Fähigkeit, <strong>Führungsstärke mit strategischer Geduld</strong> zu verbinden &ndash; eine Macht, die nicht impulsiv, sondern zielgerichtet und ausdauernd eingesetzt wird, um das eigene Terrain dauerhaft abzusichern. Kohls Vermächtnis &ndash; ein wiedervereinigtes Deutschland in einem geeinten Europa &ndash; ist genau das: ein Werk, das über die eigene Amtszeit hinausreicht.</p>
          <p class="vb-intro">Der Schatten zeigte sich in der CDU-Spendenaffäre, die 1999/2000 aufgedeckt wurde: Kohl gestand ein, illegale Parteispenden über Jahre durch schwarze Kassen verschleiert zu haben, weigerte sich aber beharrlich, die Namen der Spender zu nennen &ndash; selbst unter dem Druck von Ehrenverlust und juristischen Konsequenzen. Das ist die Kehrseite der selbsterhaltenden Acht: Das eigene, engste Umfeld wird kompromisslos geschützt, selbst gegenüber Transparenz und Öffentlichkeit &ndash; und das über Jahrzehnte kultivierte System der persönlichen Bindungen kann zur Falle werden, wenn seine verdeckten Regeln ans Licht kommen. Die Affäre beschädigte sein Ansehen erheblich und stürzte die von ihm selbst geprägte Partei in eine tiefe Krise.</p>
        </blockquote>

        <h2 class="vb-section">6. Der Orang-Utan, der einen Kontinent zusammenhielt</h2>
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Und doch bleibt: Kein deutscher Nachkriegskanzler hat die Landkarte Europas so nachhaltig verändert. Als &bdquo;Kanzler der Einheit&ldquo; steht Kohl für den seltenen Fall, in dem die Härte und Ausdauer der selbsterhaltenden Acht, gepaart mit der Geduld des Neunerflügels, ein historisches Zeitfenster nutzte, das sich nie wieder geöffnet hätte &ndash; der Orang-Utan, der jahrzehntelang unbeweglich auf seinem Ast saß, und der genau in dem Moment, in dem ganz Europa hinsah, sein ganzes Gewicht in die Waagschale warf.</p>
        </blockquote>
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-winston-churchill", label:"Porträt: Winston Churchill (SE8w9) – ebenfalls Staatsmann, derselbe Subtyp"},
        {route:"beruehmte-golda-meir", label:"Porträt: Golda Meir (SE8w9)"},
        {route:"krankheitsportraets-helmut-kohl", label:"Krankheitsporträt: Helmut Kohl (SE8w9) – Sturz, Rollstuhl und Sprachverlust"},
      ])}
    </div>
  `);
}
...
export function jenniferMatherPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jennifer-mather-portrait.jpg" alt="Jennifer Mather – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function klaraVonAssisiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-klara-von-assisi-portrait.jpg" alt="Klara von Assisi" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Am 17. Februar 1958, gut siebenhundert Jahre nach ihrem Tod, ernannte Papst Pius XII. Klara von Assisi offiziell zur Schutzpatronin des Fernsehens. Der Legende nach wurde ihr, zu schwach, um an Weihnachten das Bett zu verlassen, die Christmette aus der Ferne gleichsam wie auf einem unsichtbaren Bildschirm an die Wand ihrer Zelle projiziert. Als das Fernsehen in den fünfziger Jahren des zwanzigsten Jahrhunderts populär wurde, erinnerte sich der Vatikan an diese mittelalterliche „Live-Übertragung" und sprach ihr kurzerhand dieses Patronat zu.</p>
...
export function lenaUrzendowskyPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-lena-urzendowsky-portrait.jpg" alt="Lena Urzendowsky – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function madelineStuartPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-madeline-stuart-portrait.jpg" alt="Madeline Stuart – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function monicaSimpsonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-monica-simpson-portrait.jpg" alt="Monica Simpson – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function nusratFatehAliKhanPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-nusrat-fateh-ali-khan-portrait.jpg" alt="Nusrat Fateh Ali Khan – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function sadhguruPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-sadhguru-portrait.jpg" alt="Sadhguru – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function tomKaulitzPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-tom-kaulitz-portrait.jpg" alt="Tom Kaulitz – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function brigitteMacronPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/brigitte-macron-portrait.jpg" alt="Brigitte Macron – Portr\xe4t" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Genau darin zeigt sich ein besonders charakteristisches Muster der Beziehungs-Drei: Der eigene Erfolg wird nicht in erster Linie f\xfcr sich selbst gesucht, sondern in den Erfolg des Partners investiert – dessen Aufstieg wird fast wichtiger als der eigene. Brigitte wurde so zu einer Art Motor auf Macrons Weg ins Pr\xe4sidentenamt: Sie brachte ihre jahrzehntelange p\xe4dagogische Erfahrung, ihr soziales Netzwerk und ihre Reife als \xe4ltere, erfahrene Frau gezielt in seine Karriere ein, statt eine eigene \xf6ffentliche Laufbahn zu verfolgen. Dieses Muster – Erfolg als gemeinsames Projekt, bei dem der Erfolg des anderen zur eigenen Erf\xfcllung wird – zeigt sich bei der SX3 auch au\xdferhalb von Paarbeziehungen, etwa wenn Eltern die Karriere eines Kindes oder Trainer den Erfolg eines Sch\xfctzlings zu ihrem eigentlichen Lebensprojekt machen. Der eigene Erfolg ist dabei nicht unwichtig, aber er bleibt sekund\xe4r gegen\xfcber dem stellvertretend erlebten Triumph.</p>
        </blockquote>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Diese Haltung zeigte sich bis in Details, die kein Nutzer je zu Gesicht bekam – etwa die Forderung, auch die Innenseite von Platinen sauber und ästhetisch anzuordnen, obwohl niemand sie je öffnen würde. Für die SO1 ist das kein übertriebener Perfektionismus, sondern die konsequente Anwendung eines moralischen Maßstabs auf jedes Detail der eigenen Arbeit. Eine hübsche Randnotiz, die über ein reines Wortspiel hinausgeht: Moderne Computer-Platinen enthalten tatsächlich, in sehr geringen Mengen, wertvolle Spurenmetalle wie Palladium, Platin und Tantal. Und das homöopathische Konstitutionsmittel der Eins ist ausgerechnet Platinum metallicum, gewonnen aus dem Edelmetall Platin, das von keiner Säure angegriffen wird – genau jenes Streben nach Unangreifbarkeit und makelloser Reinheit, das Jobs sogar noch in die unsichtbare Innenseite seiner Platinen legte, buchstäblich mit einer Spur des passenden Metalls darin.</p>
        </blockquote>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Einordnung ohne Determinismus: Nicht jeder Mensch mit diesem Subtyp gerät in Lebensgefahr, weil er ein Problem nicht unterbrechen kann – die allermeisten SX5er verschmelzen mit weit ungefährlicheren Objekten ihrer Faszination. Archimedes' Tod ist ein historischer Extremfall, kein zu erwartendes Muster. Bemerkenswert bleibt dennoch, wie konsequent sich sein gesamtes überliefertes Verhalten – von der Badewanne bis zum Sand vor den Toren Syrakus' – in ein einziges Grundmuster fügt. Archimedes kannte sein eigenes Enneagramm-Muster naturgemäß nicht; seine Leidenschaft nach vollständiger Verschmelzung mit dem gerade erkannten Problem bestimmte ihn unwidersprochen, ohne die Sprache, um zu erkennen, dass genau diese Intensität, die sein Werk unsterblich machte, ihn am Ende auch das Leben kostete.</p>
        </blockquote>

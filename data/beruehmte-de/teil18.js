  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>soziale Zwei (SO2)</strong> sucht ihren Platz nicht in der einen exklusiven Beziehung, sondern in der Mitte eines großen Netzwerks – Naranjo nannte diesen Subtyp <em>Ambition</em>: Bedeutung wird dadurch gesichert, dass man sich unentbehrlich für viele macht, oft gerade durch die Nähe zu einflussreichen oder erfolgreichen Menschen. Howes' Lebenswerk ist im Kern genau das: 2013 startete er den Podcast <em>The School of Greatness</em>, der inzwischen über 500 Millionen Downloads verzeichnet – kein Werk der Selbstdarstellung, sondern über mehr als tausend Episoden hinweg ein systematischer Aufbau persönlicher Beziehungen zu Sportlern, Wissenschaftlern und Unternehmern, deren Vertrauen er gewinnt, bevor sie ihre eigentliche Geschichte erzählen.</p>
...
export function anastasiaBarnerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-anastasia-barner-portrait.jpg" alt="Anastasia Barner – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function barackObamaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-barack-obama-portrait.jpg" alt="Barack Obama – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function christopheBoeschPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-christophe-boesch-portrait.jpg" alt="Prof. Dr. Christophe Boesch – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function derekGoodwinPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-derek-goodwin-portrait.jpg" alt="Derek Goodwin – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function indilaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-indila-portrait.jpg" alt="Indila – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jeanneMarieGuyonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jeanne-marie-guyon-portrait.jpg" alt="Jeanne-Marie Bouvier de la Motte Guyon – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jordanPetersonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jordan-peterson-portrait.jpg" alt="Dr. Jordan Peterson – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function laurieMarkerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-laurie-marker-portrait.jpg" alt="Dr. Laurie Marker – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function nikolaTeslaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-nikola-tesla-portrait.jpg" alt="Nikola Tesla – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function rowanAtkinsonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-rowan-atkinson-portrait.jpg" alt="Rowan Atkinson – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function aliWongPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-ali-wong-portrait.jpg" alt="Ali Wong – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function giorgiaMeloniPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/giorgia-meloni-portrait.jpg" alt="Giorgia Meloni – Portr\xe4t" class="krim-portrait-img" loading="lazy" />
        </div>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        ${relatedLinks([
          ...
          {route:"beruehmte-juergen-drews", label:"Porträt: Jürgen Drews (SX9w8) – ebenfalls jahrzehntelange Bindung an Publikum und Partnerin"},
        ])}
      </div>
    </div>
  `);
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Die soziale Neun gilt in der Enneagramm-Literatur als <strong>Kontratyp der Neun</strong>: Während die Neun in ihrer Grundpassion zur Trägheit neigt &ndash; dem Ausweichen vor der eigenen Energie, um keinen Konflikt zu riskieren &ndash;, zeigt ausgerechnet die soziale Variante oft das Gegenteil: einen auffälligen, manchmal geradezu unermüdlichen Fleiß. Der Grund liegt genau in der Ausrichtung der Energie: Wo die selbsterhaltende Neun ihre Energie in persönlichen Komfort und die sexuelle Neun in die eine intensive Verschmelzung steckt, muss die soziale Neun sich aktiv für die Gemeinschaft einsetzen, um ihre Zugehörigkeit zu spüren &ndash; und das verlangt Einsatz, nicht Rückzug. Beim Dalai Lama zeigt sich das in einem Lebenswerk, das mit reiner Trägheit nichts gemein hat: Jahrzehnte diplomatischer Reisen, Hunderte Bücher und Schriften, der Aufbau ganzer Bildungs- und Kultureinrichtungen im Exil &ndash; eine Disziplin, die nicht nur aus dem Einserflügel stammt, sondern aus der Kontratyp-Dynamik der sozialen Neun selbst.</p>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">5. Warum nicht einfach eine Acht?</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Bei einer Person, die faktisch jahrzehntelang an der Spitze der Macht stand, Institutionen zerschlagen und einen Krieg entschlossen geführt hat, liegt der Verdacht auf eine Acht nahe &ndash; und er ist nicht unbegründet. Wer tatsächlich Macht ausübt, wird fast automatisch mit Achter-Attributen assoziiert: Durchsetzungskraft, Kontrolle, Härte in der Krise. Genau das war bei Gandhi äußerlich alles vorhanden.</p>
          <p class="vb-intro">Der entscheidende Unterschied liegt jedoch nicht im Ausmaß der Macht, sondern in ihrer <strong>psychologischen Quelle</strong>. Eine echte Acht in derselben Position hätte ihren Machtanspruch offen vertreten, nicht verleugnet &ndash; Gandhis eigenes ›Ich bin nicht ehrgeizig‹ bei gleichzeitiger totaler Machtkonzentration ist eine Aussage, die eine Acht kaum treffen würde; sie schämt sich ihres Machtwillens grundsätzlich nicht. Eine echte Acht hätte auf die Wahlniederlage 1977 zudem eher mit Kampf bis zum letzten Widerstand reagiert als mit der geschickten, bildbewussten Anpassung, mit der Gandhi ihr Comeback organisierte &ndash; Sturheit statt Wandlungsfähigkeit ist ein Achter-Kernzug, den sie so nicht zeigte. Und eine echte Acht verbirgt eigene Verwundbarkeit meist konsequent, auch im Privaten, weil genau das ihre tiefste Angst berührt; Gandhi dagegen sprach wiederholt offen über ihre Einsamkeit und Traurigkeit &ndash; eine Offenheit, die zur Dreier-Vier-Kombination passt, aber kaum zur Acht.</p>
          <p class="vb-intro">Der Ausnahmezustand selbst lässt sich damit besser als Dreier-Reaktion unter existenzieller Bedrohung lesen denn als Ausdruck eines grundsätzlichen Achter-Machtanspruchs: Wenn die eigene, mühsam bewiesene Kompetenz plötzlich infrage gestellt wird &ndash; durch ein Gerichtsurteil, durch Massenproteste &ndash;, kann aus der SE3-Logik der Existenzsicherung durch Funktionieren eine Härte entstehen, die von außen wie Achter-Dominanz aussieht, aber aus einer ganz anderen inneren Notwendigkeit gespeist wird: nicht aus dem Bedürfnis zu herrschen, sondern aus der Angst, als inkompetent oder überflüssig entlarvt zu werden.</p>
        </blockquote>

        <h2 class="vb-section">6. Der Waschbär, der 1977 die Wahl verlor und 1980 zurückkehrte</h2>
        <blockquote class="vb-blockquote">
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Sein Ansatz fand auch praktischen Eingang in RadarOpus, das weltweit führende homöopathische Softwaresystem: Dort wurde eigens das ›Vithoulkas Expert System‹ als eigenständiges Zusatzmodul integriert, das seine charakteristische Denkweise bei Symptomanalyse und Mittelwahl digital nachbildet – ein Zeichen dafür, wie tief sein Ansatz in die alltägliche Praxis von Homöopathen weltweit eingegangen ist. In derselben Software findet sich, ebenfalls als eigenständiges Zusatzmodul, ›Rathmer's Repertorium‹ – das mit weit über 20.000 Geist-Gemüts-Rubriken umfangreichste Nachschlagewerk zur psychologischen Homöopathie, verfasst vom Autor dieses Kompasses, Detlef Rathmer.</p>
        </blockquote>

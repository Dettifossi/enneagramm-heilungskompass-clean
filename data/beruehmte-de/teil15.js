    ...
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-amelia-earhart-portrait.jpg" alt="Amelia Earhart – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function astridLindgrenPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-astrid-lindgren-portrait.jpg" alt="Astrid Lindgren – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function brunoMarsPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-bruno-mars-portrait.jpg" alt="Bruno Mars – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function cheyenneOchsenknechtPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-cheyenne-ochsenknecht-portrait.jpg" alt="Cheyenne Ochsenknecht – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Wie er zum j\u00fcngsten Wirtschaftssenator in der Geschichte des Europ\u00e4ischen Wirtschaftssenats wurde, zeigt genau diese Haltung: Eigentlich sollte er, damals einundzwanzig Jahre alt, auf einem Kongress \u00fcber sein Enneagramm-Profiling sprechen. Auf der B\u00fchne sa\u00dfen jedoch honorige, altgediente Wirtschaftsvertreter, die sich ohne Vorwarnung einem ganz anderen Thema zuwandten \u2013 und David sollte, unvorbereitet, einfach mitreden. Er tat es, im Anzug, mit kreativen, substanziellen Beitr\u00e4gen zu den wichtigsten Wirtschaftsfragen des Gespr\u00e4chs, ohne sich je vorbereitet zu haben. Die Reaktion kam prompt: \u203aDu bist hier genau der Richtige f\u00fcr uns.\u2039 Kurz darauf wurde er in den Kreis der Wirtschaftssenatoren aufgenommen \u2013 nicht auf eigene Bewerbung hin, sondern weil seine spontane Leistung \u00fcberzeugte. Das ist die SE3 in ihrer bewussten Form: Erfolg als Konsequenz, nicht als Ziel.</p>
        </blockquote>
      ...
      ${relatedLinks([
        ...
        {route:"astrologie-david-l-rathmer", label:"Enneagramm meets Astrologie: David L. Rathmer (SE3w4)"},
      ])}
    </div>
  `);
}
...
export function drDrePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-dr-dre-portrait.jpg" alt="Dr. Dre – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function frankaPotentePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-franka-potente-portrait.jpg" alt="Franka Potente – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function haraldGloeocklerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-harald-gloeockler-portrait.jpg" alt="Harald Glööckler – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function igaSwiatekPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-iga-swiatek-portrait.jpg" alt="Iga \u015awi\u0105tek – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function johnnyDeppPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-johnny-depp-portrait.jpg" alt="Johnny Depp – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function katharinaTempelPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-katharina-tempel-portrait.jpg?v=2" alt="Katharina Tempel – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function mariellaSuperinaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-mariella-superina-portrait.jpg" alt="Dr. Mariella Superina – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function mickyBeisenherzPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-micky-beisenherz-portrait.jpg" alt="Micky Beisenherz – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function neilArmstrongPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-neil-armstrong-portrait.jpg" alt="Neil Armstrong – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function romulusWhitakerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-romulus-whitaker-portrait.jpg" alt="Romulus Whitaker – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function sokratesPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-sokrates-portrait.jpg" alt="Sokrates" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function thomasVonAquinPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-thomas-von-aquin-portrait.jpg" alt="Thomas von Aquin" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function uweOchsenknechtPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-uwe-ochsenknecht-portrait.jpg" alt="Uwe Ochsenknecht – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function rosaParksPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-rosa-parks-portrait.jpg" alt="Rosa Parks – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro"><strong>Abgrenzung zur selbsterhaltenden Zwei:</strong> Angesichts ihres jahrzehntelangen Einsatzes für andere &ndash; die Untersuchung von Gewaltfällen, später die Förderung junger Menschen &ndash; könnte man versucht sein, in Parks eine selbsterhaltende Zwei zu erkennen, die über persönliche Fürsorge Bedeutung und Nähe sucht. Der entscheidende Unterschied liegt in der Richtung dieser Zuwendung: Die Zwei sucht typischerweise die eigene Unentbehrlichkeit in konkreten, persönlichen Beziehungen; Parks' Engagement zielte dagegen auf ein abstraktes Kollektiv &ndash; Bürgerrechte für eine ganze Bevölkerungsgruppe, nicht die Fürsorge für einzelne, ihr nahestehende Menschen. Auch fehlt bei ihr die für die Zwei typische, meist verdeckte Überzeugung der eigenen Unentbehrlichkeit fast vollständig: Sie bestand stets darauf, nur ein Teil einer viel größeren Bewegung gewesen zu sein, statt sich als deren tragende Figur zu verstehen. Und der zentrale Akt selbst war eine Frage der eigenen Würde ("ich war es leid, nachzugeben") &ndash; eine Ich-Aussage über Selbstachtung, keine Wir-Aussage über Beziehung oder Für-andere-Dasein.</p>
        </blockquote>
...
export function skylarGreyPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-skylar-grey-portrait.jpg" alt="Skylar Grey – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        ...
        <p class="krim-portrait-typ">SE1w9 &middot; Selbsterhaltender Typ 1 mit Neunerflügel</p>
        <p class="krim-portrait-subtitle">Finanzwissenschaftler, geb. 1961 &ndash; Tierentsprechung: Adler</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. Der Adler, der aus der Fachwelt heraustrat</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Adler</strong> beobachtet lange, bevor er handelt – und wenn er handelt, dann mit einer Präzision und Beharrlichkeit, die keine Wiederholung braucht. Stefan Homburg, geboren 1961, war über zwei Jahrzehnte ein unauffälliger, in Fachkreisen anerkannter Finanzwissenschaftler: Professor für Öffentliche Finanzen in Hannover, Dekan, Berater mehrerer Bundesregierungen, Autor von Lehrbüchern. Kaum jemand außerhalb der Fachwelt kannte seinen Namen.</p>
          <p class="vb-intro">2020 änderte sich das abrupt. Mit seiner Kritik an den Corona-Maßnahmen wurde er einem Millionenpublikum bekannt, gewann über 140.000 Follower auf X und verarbeitete seine eigenen Tweets später zu einem Buch. Aus dem zurückgezogenen Wissenschaftler wurde über Nacht eine der lautesten Stimmen der öffentlichen Debatte – ein Adler, der aus seiner stillen Warte heraustrat, sobald er von der fachlichen Richtigkeit seiner Position überzeugt war.</p>
        </blockquote>

        <h2 class="vb-section">2. Die selbsterhaltende Eins: Die eigene fachliche Korrektheit als Maßstab</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>selbsterhaltende Eins (SE1)</strong> richtet ihren Perfektionismus nicht in erster Linie auf die Korrektur anderer, sondern nach innen: auf das eigene Handwerk, die eigene Vorbereitung, die eigene fachliche Integrität. Naranjo nannte diesen Subtyp <em>Worry</em> – Besorgnis: eine ständige, meist stille innere Prüfung, ob man dem eigenen Anspruch wirklich gerecht wird. Bei Homburg zeigt sich das in einer über Jahrzehnte durchgehaltenen wissenschaftlichen Sorgfalt – Lehrbuchautor bereits als Student, Professuren in Bonn, Magdeburg und schließlich 24 Jahre in Hannover, Beratungstätigkeit für mehrere Bundesregierungen unter Waigel, Wulff und Schröder.</p>
          <p class="vb-intro">Diese Sorge um die eigene fachliche Richtigkeit übersetzt sich bei der Eins in ein unbeirrbares Festhalten an einmal als korrekt erkannten Positionen: Schon 1997 lehnte Homburg den Euro vehement ab, wurde 2012 Unterzeichner des „Protestaufrufs der Ökonomen" und Gründungsmitglied der AfD-Vorläuferorganisation. Einmal von einer fachlichen Position überzeugt, hält er über Jahrzehnte daran fest – nicht aus Verschmelzung mit einer Bindung, sondern aus der einsertypischen Gewissheit, dass die Dinge stimmen müssen, auch gegen die öffentliche Deutung.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Neunerflügel: Ruhe als Form, nicht als Rückzug</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Neunerflügel (w9)</strong> mildert bei stark ausgeprägter Ausprägung die Schärfe der reinen Eins zu einer bedächtigeren, geduldigeren Haltung – Prinzipientreue wird nicht laut verkündet, sondern ruhig und beharrlich durchgehalten. Interviews mit Homburg werden als „ruhig, sachlich, mit einem Schuss Humor" beschrieben – kein zorniger Kämpfer, sondern jemand, der selbst seine schärfsten Aussagen mit spürbarer Gelassenheit vorträgt. Genau diese Kombination aus Einser-Unbeirrbarkeit und Neuner-Gelassenheit macht ihn schwer einzuordnen: kein lauter Wüterich, aber auch kein konfliktscheuer Vermittler.</p>
          <p class="vb-intro">Doch die Ruhe der Oberfläche bedeutet nicht Nachgiebigkeit in der Sache. Sobald die eigene fachliche Korrektheit infrage gestellt wird, bricht der sonst kontrollierte Einser-Zorn durch – gefiltert, aber unübersehbar. In der Bundestags-Enquetekommission zur Aufarbeitung der Coronapandemie 2025 geriet Homburg mit Bundesarbeitsminister Hubertus Heil scharf aneinander – nicht nur in der Sache, sondern auch im Ton, mit deutlich persönlicher Schärfe gegenüber Heil. 2020 distanzierte sich zudem die Leibniz Universität Hannover öffentlich von ihm, nachdem er einen Vergleich zu 1933 gezogen hatte, für dessen Wortwahl er später gerichtlich belangt wurde. In all diesen Fällen ging es um die Zuspitzung der Form, nicht um seine ökonomische Kernargumentation selbst – kein Zurückweichen vor dem eigenen Ton, auch nicht bei erheblichem institutionellem Gegenwind: typischer Einser-Zorn, der sich lange kontrolliert, dann aber, einmal ausgelöst, moralisch aufgeladen und schwer zu bremsen ist.</p>
        </blockquote>

        <h2 class="vb-section">4. Das Werk: Vom Lehrbuchautor zum Corona-Rebellen</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Bereits als Student schrieb Homburg gemeinsam mit seinem späteren Doktorvater ein Lehrbuch zur Makroökonomik, das bis 2005 neun Auflagen und sechs Fremdsprachen erreichte – dieselbe akribische Sorgfalt, mit der die selbsterhaltende Eins ihr Handwerk über Jahrzehnte pflegt. 2025 berief ihn die AfD als Sachverständigen für die Enquetekommission zur Aufarbeitung der Coronapandemie in den Bundestag – eine erneute öffentliche Rolle, Jahrzehnte nach seinem ersten Auftritt vor demselben Gremium als unabhängiger Wissenschaftler.</p>
        </blockquote>

        <h2 class="vb-section">5. Licht und Schatten der selbsterhaltenden Eins mit Neunerflügel</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SE1w9 zeigt sich bei Homburg in der Fähigkeit, aus fachlicher Überzeugung heraus über Jahrzehnte fundierte Positionen zu vertreten, auch gegen den Mainstream – eine seltene Standhaftigkeit, die viele seiner akademischen Kollegen anerkennen, selbst wenn sie seine konkreten Schlüsse ablehnen. Dass ihn 2025 ausgerechnet die Bundestags-Enquetekommission als Sachverständigen berief, ist selbst ein Beleg dafür, dass seine fachliche Position als ernstzunehmend gilt, nicht als Rand-Meinung ohne Substanz.</p>
          <p class="vb-intro">Der Schatten der Eins-Neun-Kombination liegt weniger in der inhaltlichen Position selbst als in der Form, in der sie manchmal vorgetragen wird: Die Gewissheit, fachlich im Recht zu sein, kann so vollständig werden, dass Kritik oder Gegenargumente nicht mehr als Sachfrage, sondern als persönlicher Angriff auf die eigene Integrität beantwortet werden – wie im scharfen, teils persönlich zugespitzten Schlagabtausch mit Hubertus Heil in der Enquetekommission. Diese Überschärfe im Ton ist von der fachlichen Substanz seiner Kernargumente zu unterscheiden; sie zeigt aber, wie schnell der sonst kontrollierte Zorn der SE1w9 von der Verteidigung einer Position in die persönliche Konfrontation mit dem Gegenüber kippen kann.</p>
        </blockquote>

        <h2 class="vb-section">6. Der Adler, der nicht mehr schweigen wollte</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Stefan Homburgs Weg zeigt die selbsterhaltende Eins mit Neunerflügel in einer besonders öffentlichen, konfliktreichen Form: zwei Jahrzehnte stille, sorgfältige Fachlichkeit im akademischen Establishment, dann ein abruptes, ungebremstes Eintreten für die eine als richtig erkannte Überzeugung – fachlich standhaft bis heute als Sachverständiger gefragt, im Ton aber bisweilen so zugespitzt, dass daraus persönliche statt rein fachliche Konfrontationen wurden.</p>
          ${bookTip("wer-du-wirklich-bist-band-1", "Die neun Typen in ihrer Tiefe – Schutzmuster, Leidenschaften und der Weg zur Essenz.", "Wer du wirklich bist – Band 1")}
          ${bookTip("die-verborgene-dynamik-der-27-subtypen", "27 Subtypen: Leidenschaften, Schutzstrategien und Heilungswege aus der therapeutischen Praxis.", "Die verborgene Dynamik der 27 Subtypen")}
          ${bookTip("die-27-persoenlichkeiten-des-enneagramms", "27 Charakterprofile im Vergleich – wie sich die Subtypen desselben Typs voneinander unterscheiden.", "Die 27 Persönlichkeiten des Enneagramms")}
        </blockquote>

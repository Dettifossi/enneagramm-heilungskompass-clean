    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Diese Direktheit kann, sobald sie sich mit der neunertypischen Verschmelzung einer einmal gefassten Überzeugung verbindet, über das rein Fachliche hinausschießen und persönlich werden. In der Bundestags-Enquetekommission zur Aufarbeitung der Coronapandemie 2025 geriet Homburg mit Bundesarbeitsminister Hubertus Heil scharf aneinander – nicht nur in der Sache, sondern auch im Ton, mit deutlich persönlicher Schärfe gegenüber Heil. 2020 distanzierte sich zudem die Leibniz Universität Hannover öffentlich von ihm, nachdem er einen Vergleich zu 1933 gezogen hatte, für dessen Wortwahl er später gerichtlich belangt wurde. In all diesen Fällen ging es um die Zuspitzung der Form, nicht um seine ökonomische Kernargumentation selbst – kein Zurückweichen vor dem eigenen Ton, auch nicht bei erheblichem institutionellem Gegenwind, typische Achterflügel-Härte, die der neunertypischen Konfliktvermeidung im Ernstfall eine schonungslose Kante gibt.</p>
          <p class="vb-intro">Trotzdem bleibt der Grundton auffallend unaufgeregt: Interviews mit ihm werden als „ruhig, sachlich, mit einem Schuss Humor" beschrieben – kein zorniger Kämpfer, sondern jemand, der selbst seine schärfsten Aussagen mit spürbarer Gelassenheit vorträgt. Genau diese Kombination aus Neuner-Ruhe und Achter-Schärfe macht ihn schwer einzuordnen: kein lauter Wüterich, aber auch kein konfliktscheuer Vermittler – und fachlich, das betonen selbst Kritiker seines Tons, bleibt er ein ernstzunehmender Ökonom, kein Rand-Provokateur ohne Substanz.</p>
        </blockquote>
        ...
        <h2 class="vb-section">5. Licht und Schatten der sexuellen Neun mit Achterflügel</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SX9w8 zeigt sich bei Homburg in der Fähigkeit, aus vollständiger Überzeugungstreue heraus über Jahrzehnte fachlich fundierte Positionen zu vertreten, auch gegen den Mainstream – eine seltene Standhaftigkeit, die viele seiner akademischen Kollegen anerkennen, selbst wenn sie seine konkreten Schlüsse ablehnen. Dass ihn 2025 ausgerechnet die Bundestags-Enquetekommission als Sachverständigen berief, ist selbst ein Beleg dafür, dass seine fachliche Position als ernstzunehmend gilt, nicht als Rand-Meinung ohne Substanz.</p>
          <p class="vb-intro">Der Schatten der Neun-Acht-Kombination liegt weniger in der inhaltlichen Position selbst als in der Form, in der sie manchmal vorgetragen wird: Die Verschmelzung mit der einmal gefassten Überzeugung kann so vollständig werden, dass Kritik oder Gegenargumente nicht mehr als Sachfrage, sondern als persönlicher Angriff beantwortet werden – wie im scharfen, teils persönlich zugespitzten Schlagabtausch mit Hubertus Heil in der Enquetekommission. Diese Überschärfe im Ton ist von der fachlichen Substanz seiner Kernargumente zu unterscheiden; sie zeigt aber, wie schnell die Achter-Härte bei der SX9w8 von der Verteidigung einer Position in die persönliche Konfrontation mit dem Gegenüber kippen kann.</p>
        </blockquote>

        <h2 class="vb-section">6. Das Faultier, das nicht mehr schweigen wollte</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Stefan Homburgs Weg zeigt die sexuelle Neun mit Achterflügel in einer besonders öffentlichen, konfliktreichen Form: zwei Jahrzehnte stille fachliche Verschmelzung mit der eigenen Wissenschaft und der eigenen Ehe, dann ein abruptes, ungebremstes Eintreten für die eine Überzeugung, sobald sie einmal gefasst war – fachlich standhaft bis heute als Sachverständiger gefragt, im Ton aber bisweilen so zugespitzt, dass daraus persönliche statt rein fachliche Konfrontationen wurden.</p>

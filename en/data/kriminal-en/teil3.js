...
export function aileenWuornosPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Aileen Wuornos – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/aileen-wuornos-portrait.jpg" alt="Aileen Wuornos – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function andreasBaaderPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/andreas-baader-portrait.jpg" alt="Andreas Baader – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="vb-section">
        ...
        <p class="vb-intro">Andreas Baader, born in 1943 in Munich, grew up without a father &ndash; his father, the historian and archivist Berndt Philipp Baader, was taken prisoner of war in 1945 and never returned, remaining missing. Andreas spent his first five years with his grandmother in Saalfeld/Saale, separated from his mother; from 1949 on he grew up in Munich in an all-female household of his mother, grandmother, and aunt. This early separation from his primary attachment figure is no incidental detail: this exact pattern &ndash; a caregiver unavailable for external reasons, and a child who learns early to rely on itself rather than on attachment &ndash; occurs disproportionately often in the early childhood of self-preservation Sevens. Baader was expelled from several schools and ran into conflict with the law early &ndash; car theft, minor offenses, a restless life between bohemia and the underworld. According to consistent accounts from contemporaries, political theory interested him considerably less than it did his fellow campaigners Gudrun Ensslin and Ulrike Meinhof, who wrote the group's ideological texts. Baader hardly read Marx &ndash; he wanted to act, to drive, to experience. Fast cars, good clothes, the feeling of never having to submit to anyone: that was his real language, long before it turned into armed struggle.</p>
      </div>
...
export function annaDelveyPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Anna Delvey – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/anna-delvey-portrait.jpg" alt="Anna Delvey – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
Claudio Naranjo called the SP2 the subtype of privilege: She believes that through her special way of giving and being, she is entitled to more than others. For Delvey, that was not a wish – it was a certainty.</p>
...
export function bernieMadoffPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Bernie Madoff \u2013 Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame"><img class="krim-portrait-img" loading="lazy" src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/bernie-madoff-portrait.jpg" alt="Bernie Madoff" /></div>
...
Madoff did not take just anyone as a client. Those permitted to invest with him felt chosen. The Four-wing lends Type Three an aesthetic of uniqueness: Not everyone gets in. You are special because I am accepting you. That was no fluke—it was a method. Exclusivity as a mechanism of trust.</p>
...
export function charlesMansonPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Charles Manson – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/charles-manson-portrait.jpg" alt="Charles Manson – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div style="margin-top:2rem;padding:1rem;background:var(--surface);border-radius:8px;max-width:100%;">
        ...
        ${relatedLinks([
          ...
          {route:"krankheitsportraets-charles-manson", label:"Illness Portrait: Charles Manson (SX6w7) – colon cancer in prison"},
        ])}
      </div>
    </div>
  `);
...
export function dennisNilsenPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Dennis Nilsen – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/dennis-nilsen-portrait.jpg" alt="Dennis Nilsen \xe2\x80\x93 Portr\xe4t" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function edGeinPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/kriminalpsychologie-ed-gein-portrait.jpg" alt="Ed Gein – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function garyRidgwayPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Gary Ridgway – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/gary-ridgway-portrait.jpg" alt="Gary Ridgway – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function haroldShipmanPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Harold Shipman – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/harold-shipman-portrait.jpg" alt="Harold Shipman – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jackUnterweegerPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Jack Unterweger – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/jack-unterweger-portrait.jpg" alt="Jack Unterweger – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function johnHinckleyJrPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/kriminalpsychologie-john-hinckley-jr-portrait.jpg" alt="John Hinckley Jr. – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jonathanMeijerPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Jonathan Meijer – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/jonathan-meijer-portrait.jpg" alt="Jonathan Meijer – Bleistiftzeichnung" class="krim-portrait-img" loading="lazy" />
        </div>
...
The Self-Preservation Two develops a sense of privilege—they are special, their resources are special, their contribution is special. Meijer saw his genetic health and appearance as a gift that he must not withhold from the world. This is SP2 pride in its rawest form.</p>
      </div>
...
export function lukaMagnottaPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Luka Magnotta – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/luka-magnotta-portrait.jpg" alt="Luka Magnotta – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function nickLeesonPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Nick Leeson – Criminal Psychology")}
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/nick-leeson-portrait.jpg" alt="Nick Leeson – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <div class="krim-portrait-footer">
          ...
          <span style="display:block;margin-bottom:0.3rem;"><strong>Subtype:</strong> SO9w8 &ndash; Soziale Neun mit Achterfl\xfcgel</span>
...
export function ottoMuehlPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/kriminalpsychologie-otto-muehl-portrait.jpg" alt="Otto Mühl – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
The abuse within the commune remained largely invisible to the outside world for decades. Like the Mamba's neurotoxin, the system paralyzed its victims psychologically long before the effect became publicly recognizable—the reckoning continues for many survivors even now.</p>
      </div>
...
export function paulOgorzowPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Paul Ogorzow – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/paul-ogorzow-portrait.jpg" alt="Paul Ogorzow – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
Paul Ogorzow is assigned to the Self-Preservation One with a Nine-wing in the Enneagram. The passion of the One is Anger – an internalized, structured resentment against one's own imperfection and the imperfection of the world. The Self-Preservation One (SP1) differs fundamentally from the Social One (SO1): where the SO1 lectures and moralizes outwardly, the SP1 directs its energy inward – toward perfect self-control, an immaculate facade, and an irreproachable daily life. They appear good-natured, almost childlike, and harmless. This has a clear logic: the SP1 masks their inner tension through exaggerated correctness because errors – and thus punishment – must be avoided at all costs. The Nine-wing adds the capacity for complete emotional splitting: two worlds, hermetically separated, never touching. Ogorzow's case shows the abysmal double life this combination can produce.</p>
      </div>

      <div class="vb-section" style="max-width:100%;">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">1. Quality of Gaze</h3>
        <p class="vb-intro"><strong>a) Inconspicuous and Adapted:</strong>
Ogorzow caught no one's attention – and that was by design. The SP1 trains itself to offer no cause for criticism: no misconduct, no sensation, no point of vulnerability. His gaze was that of a dutiful man – open, direct, unremarkable. Whoever looked at him saw nothing. And that was precisely his camouflage.</p>
...
The deepest defense mechanism of the One is reaction formation: what belongs to oneself is made foreign. Ogorzow demonstrated this mechanism in its clearest expression in court: I am not to blame – the doctor damaged my brain. This is not strategic lying; it is a deeply ingrained One reflex: the perfect self cannot bear guilt. Therefore, the guilt must lie elsewhere. Always.</p>
...
export function richardRamirezPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Richard Ramírez – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/richard-ramirez-portrait.jpg" alt="Richard Ramírez – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      ${relatedLinks([
        ...
        {route:"kriminalpsychologie-pedro-alonso-lopez", label:"Criminal Psychology: Pedro Alonso López (SO3w2)"},
        {route:"krankheitsportraets-richard-ramirez", label:"Illness Portrait: Richard Ramírez (SP3w4) – B-cell lymphoma"},
      ])}
    </div>
  `);
}
...
export function salvatoreRiinaPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Salvatore Riina – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/salvatore-riina-portrait.jpg" alt="Salvatore Riina – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function tedKaczynskiPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Ted Kaczynski – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/ted-kaczynski-portrait.jpg" alt="Ted Kaczynski – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="vb-section">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">1. The Octopus</h3>
        <p class="vb-intro">The octopus is the animal correspondence of the Social Five – and it describes Ted Kaczynski's inner architecture with surprising precision. The octopus is highly intelligent, enigmatic, and largely invisible. It lives in seclusion, observes from a distance, and remains elusive. When it strikes, it does so not with brute force – but with speed, precision, and venom. It leaves no trace. And it communicates: through color changes, shifting patterns, dispassionate signals to a world that never truly understood it. Ted Kaczynski was this octopus: an intellect in concealment whose message read – you did not understand.</p>
      </div>

      <div class="vb-section">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">2. The Social Five: Knowledge as a World Tribunal</h3>
        <p class="vb-intro">The Social Five (SO5) is paradoxical: it is the most community-oriented of all Type Five subtypes – and simultaneously often the harshest critic of society. The SO5 does not seek belonging for its own sake, but rather an intellectual foundation from which the world can be judged and comprehended. Naranjo called this subtype Totem: the Five as the bearer of an idea that transcends the individual.</p>
        <p class="vb-intro">Theodore John Kaczynski, born May 22, 1942, in Chicago, was a child prodigy. High school graduation at 16, Harvard degree at 20, PhD in mathematics from the University of Michigan at 25, assistant professor at UC Berkeley at 26 – one of the youngest in the university's history. Then he resigned. Without explanation, without a plan. He vanished into a self-built wooden cabin in the wilderness of Montana, without electricity or running water, and began – to think.</p>
      </div>

      <div class="vb-section">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">3. The Four-Wing: Depth, Sense of Mission, Solitude</h3>
        <p class="vb-intro">The Four-wing (w4) imparts something to the Social Five that it would lack otherwise: an emotional depth and a pronounced feeling of being different, of being misunderstood. The Four-wing adds an almost artistic intensity to the cool analysis of the Five – the sense of carrying a weight that the world needs to hear.</p>
        <p class="vb-intro">In Kaczynski's case, this manifested in his writing style: his manifesto is no dry academic treatise. It is passionate, almost prophetic. He wrote about alienation, the loss of autonomous living, and the erosion of human nature by technology – with an urgency that makes the Four-wing clearly identifiable. Kaczynski did not feel like a fighter for a political cause. He felt like the only person who truly saw what was happening.</p>
      </div>

      <div class="vb-section">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">4. Biography: High Intelligence and Inner Withdrawal</h3>
        <p class="vb-intro">Kaczynski's biography is one of progressive alienation. A child prodigy, yet socially isolated – skipped ahead two grade levels early on, placing him in classes with older peers with whom he found no connection. At Harvard University, as a 16-year-old, he participated in a psychological stress experiment that was later classified as ethically problematic: students were subjected to months of intense verbal and psychological abuse. Kaczynski mentioned this experiment several times in later years.</p>
        <p class="vb-intro">The decision to leave academia was no sudden crisis – it was a consequence. For an SO5w4, the feeling of working within a system perceived as fundamentally flawed is unbearable over time. He built his cabin. He hunted, grew vegetables, and lived self-sufficiently. The Five's Enneagram compass functions here: maximum internal resource preservation, maximum intellectual capacity directed toward the primary project.</p>
      </div>

      <div class="vb-section">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">5. The Crimes: Bombings 1978–1995</h3>
        <p class="vb-intro">Between 1978 and 1995, Kaczynski mailed or placed 16 bomb packages targeting universities and airlines – leading to the FBI codename UNABOM (Universities and Airlines Bomber). Three people were killed, and 23 were injured.</p>
        <p class="vb-intro">The initial packages were relatively crude. Over the years, Kaczynski significantly refined his bombs through careful craftsmanship – fabricating all components himself, leaving virtually no clues. He altered shipping locations, forged sender details, and avoided commercially bought typewriter paper. For 17 years, investigators were faced with a riddle. In the 1990s, the FBI launched one of the largest manhunts in its history.</p>
        <p class="vb-intro">The victims were not random: he targeted computer science professors, aerospace engineers, and advertising executives – individuals who, in his eyes, represented the technological-industrial system. That is the SO5: not blind killing, but a targeted sentence – executed by the sole individual possessing the resolve to carry it out.</p>
      </div>
      ...
      <div class="vb-section">
        ...
        <p class="vb-intro">In 1995, Kaczynski sent his 35,000-word manifesto to the New York Times and the Washington Post, threatening further attacks if it was not published. The FBI advised publication. The manifesto appeared in print in September 1995.</p>
        <p class="vb-intro">It is a remarkable document. Kaczynski argues clearly and rigorously: industrial society destroys human psychological autonomy by replacing natural needs for power, challenge, and purpose with surrogate activities. The individual becomes dependent on a system they neither control nor understand. The only resolution, he argued, was a radical collapse of technological civilization.</p>
        <p class="vb-intro">Philosophers, sociologists, and critics of technology have since acknowledged individual analyses in the manifesto as intellectually notable – when examined independently of his criminal acts. That is the SO5w4 paradox: a thinker whose ideas were partially open to debate – and whose methods were unacceptable.</p>
      </div>

      <div class="vb-section">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">7. Arrest and Trial</h3>
        <p class="vb-intro">The publication of the manifesto became Kaczynski's undoing. His brother David read the text and recognized the writing style. He contacted the FBI. On April 3, 1996, Kaczynski was arrested at his cabin in Lincoln, Montana.</p>
        <p class="vb-intro">The 1997/98 trial was complicated by Kaczynski's refusal to allow an insanity defense. He did not want to be portrayed as mentally ill – in his view, that would invalidate his arguments. He ultimately pled guilty and was sentenced to life imprisonment without the possibility of parole. On June 10, 2023, he was found dead in his prison cell – presumably by suicide. He was 81 years old.</p>
      </div>

      <div class="vb-section">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">8. What the Enneagram Makes Visible</h3>
        <p class="vb-intro"><strong>a) Naranjo's SO5 – "Totem":</strong> Claudio Naranjo describes the SO5 as the subtype that uses ideas as a bridge to the world – seeking intellectual testimony rather than belonging. The SO5 is not out of touch with reality: they observe society intensely, analyze it, and pass judgment upon it. In health, this yields the philosopher, the cultural critic, the visionary. In unhealthy levels – as with Kaczynski – analysis becomes verdict, and verdict becomes a mandate.</p>
        <p class="vb-intro"><strong>b) The Four-Wing as an Amplifier:</strong> Without the w4, Kaczynski might have channeled his critique into written works alone. The Four-wing gave this thinking an existential urgency: this was not merely an intellectual conviction – it was identity, mission, suffering. The Five alone withdraws. The Five with a Four-wing withdraws and burns.</p>
        <p class="vb-intro"><strong>c) The Core Dilemma:</strong> An SO5w4 lacking human connection and corrective counter-voices can drift into an isolated intellectual inner world where one's own analysis becomes the sole reality. Kaczynski's 17 years of seclusion in the woods were precisely that: a closed system of thought without friction, without contradiction, without love – solidifying into total conviction. The Enneagram calls this the collapse into the Avarice of the Five: the hoarding of knowledge until contact is no longer possible.</p>
      </div>

      <div class="vb-section">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">9. Conclusion: The Octopus Who Sentenced the World</h3>
        <p class="vb-intro">Ted Kaczynski is not a case of blind hatred, nor a case of insanity. He is the case of an extraordinarily gifted individual who – lacking human connection, lacking corrective counter-voices, lacking the simple experience of being loved and challenged – slipped into a thought system that felt completely coherent from within. That is the deepest danger of the unhealthy Social Five: not impulsivity, nor clinical lack of empathy – but the capacity to inhabit a hermetically sealed intellectual system for decades, having long consumed every trace of doubt.</p>
        <p class="vb-intro">His Four-wing turned this conviction into a mission. And his social instinctual variant ensured that he did not simply abandon the world – but sat in judgment over it. He wanted to be heard. He wanted humanity to understand. In his logic, the bombs were not attacks, but arguments – the final language of a thinker who believed all other languages had failed.</p>
        <p class="vb-intro">What remains: a manifesto that continues to be read in parts. Three victims who will never return. And the question of what might have become of this intellect, had someone managed to truly reach him in time.</p>
      </div>
      ...
      <div class="vb-section">
        ...
        <p class="vb-intro" style="margin-bottom:1.2rem;">
          ...
          <span style="display:block;margin-bottom:0.3rem;"><strong>Subtype:</strong> SO5w4 – Social Five with Four-wing</span>
          <span style="display:block;margin-bottom:0.3rem;"><strong>Passion:</strong> Avarice (as the hoarding of knowledge and detachment from the world)</span>
          <span style="display:block;margin-bottom:0.3rem;"><strong>Animal correspondence:</strong> Octopus</span>
...
export function victorLustigPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/victor-lustig-portrait.jpg" alt="Victor Lustig – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function fritzHonkaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/fritz-honka-portrait.jpg" alt="Fritz Honka – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="vb-section" style="max-width:100%;">
        ...
        <p class="vb-intro"><strong>b) Stramonium — the Five's homeopathic remedy of passion, and its warning about concealed violence:</strong> A revealing parallel lies in <strong>Stramonium</strong> (thorn apple), the homeopathic remedy of passion associated with the self-preservation Five. Its materia medica includes a distinct rubric — <em>violent, concealed, masked</em> — that describes precisely what became visible in Honka: when emotions are suppressed over very long periods and rarely shown outwardly, this accumulated inner tension eventually seeks an outlet, at wide intervals — not through calculation, but through sudden, explosive outbursts of violence in a person who had appeared calm, almost inconspicuous, until then. This naturally applies to only a vanishingly small exception among self-preservation Fives — in Honka's case, this constellation coincided with a passion of avarice lived out with particular intensity, which brought the pattern to light in its darkest form. The same underlying structure can also be found in Kroll, once the deeper motivation is considered.</p>
        <p class="vb-intro"><strong>c) His own apartment as the hiding place for the crimes — not the outside world:</strong> The most striking feature of Honka's method: he did not dispose of the body parts far from his own living space, as many other perpetrators do, but concealed them within his own four walls — behind a self-built partition wall, in the attic above his apartment. This is the SP5 logic in its darkest form: the private retreat is so completely under control that even the unspeakable seems safer there than outside — a parallel to Kroll, who kept body parts in his own refrigerator instead of disposing of them.</p>
        <p class="vb-intro"><strong>d) A cooperative, almost relieved confession:</strong> After his arrest, Honka confessed comparatively quickly and in detail. Investigators described him as cooperative; at times he seemed almost relieved that the years-long secrecy had finally ended. The meager, fear-driven hiding had itself become unbearable to carry.</p>
        <p class="vb-intro"><strong>e) Tool rather than weapon: the hands as the instrument of the crime:</strong> Looking back on the case, Honka's unusually large, massive hands stood out — described by those who knew him as tool-like, almost shovel-shaped, the hands with which he beat and strangled his victims. As a warehouse laborer who had moved crates and loads for decades, he had inevitably developed such powerful hands — yet their coarse, almost digging quality recalls the image of the mole, which effortlessly burrows through resistance with powerful, shovel-like forepaws — an animal, interestingly, likewise associated with the principle of the self-preservation Five — not the Five in general, but specifically that self-preservation variant which asserts itself against a world experienced as threatening through physical strength and burrowing persistence. Honka needed no weapon: his hands alone gave him crushing superiority over women who were mostly physically weaker than him. In accounts of the case, both in criminal-history literature and in later film adaptations, these hands became a recurring symbol — for the raw, immediate violence and the helpless fate of his victims from Hamburg's bar scene.</p>
      </div>
...
export function elizabethBathoryPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Elizabeth Báthory – Criminal Psychology")}
      <div id="js-back-target" data-route="kriminalpsychologie" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/elizabeth-bathory-portrait.jpg" alt="Elizabeth Báthory – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
        <p class="krim-portrait-name">Elizabeth Báthory</p>
        <p class="krim-portrait-typ">SX4w3 · Sexual Type 4 with Three-wing</p>
        <p style="color:var(--muted);font-size:0.9rem;margin:0;">Hungarian Countess · Animal Correspondence: Chihuahua</p>
      </div>
      <p class="psycho-intro">
        <strong>Elizabeth Báthory</strong>, born in 1560 into one of Hungary's most powerful noble families, is accused of torturing and killing numerous servant girls and young noblewomen at Čachtice Castle between the 1590s and her arrest in 1610. The famous legend that she bathed in human blood to stay young is now considered a later embellishment — contemporary sources instead describe a woman who abused her power to inflict sadistic cruelty on defenseless subordinates. Never officially tried due to her noble rank, she spent her last four years walled into her own castle.
      </p>

      <div class="vb-section" style="background:rgba(139,0,0,0.06);border-left:3px solid #8b0000;padding:1rem 1.2rem;border-radius:8px;margin-bottom:2rem;max-width:100%;">
        <p style="margin:0;font-size:0.95rem;color:var(--ink);"><strong>Type Attribution:</strong>
        <strong>Elizabeth Báthory</strong> is attributed to the <strong>Sexual Type 4 with Three-wing</strong> in the Enneagram.
        The Sexual Four rebels against every outer limitation and lives intensity without compromise, without half measures — in its shadow, that intensity can turn against other people instead of against convention. The Three-wing ties this pattern to status, image, and public effect. Under stress, the Four moves toward <strong>Two</strong>: intrusive, possessive closeness toward select confidants — documented in Báthory's unusually close, almost familial bond with her aide Darvulia.</p>
      </div>

      <div class="vb-section" style="max-width:100%;">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">1. Animal Correspondence: The Chihuahua</h3>
        <p class="vb-intro">
        The <strong>Chihuahua</strong> is the animal correspondence of the Sexual Four — small in stature, yet carrying an intensity utterly out of proportion to its size. Báthory was physically a slight, reportedly beautiful woman from one of Eastern Europe's most influential families — relatives sat on the Polish throne and the princely seat of Transylvania. This gap between a delicate outward appearance and an inner life that seemed to know no limit is pure Chihuahua pattern: what is felt is felt completely, with no moderated presentation.
        </p>
      </div>

      <div class="vb-section" style="max-width:100%;">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">2. The Sexual Four: When One's Own Wound Strikes Outward</h3>
        <p class="vb-intro"><strong>a) Competitive envy as origin:</strong>
        Naranjo called the Four's passion <strong>competitive envy</strong> — a deep, often unconscious sense that one fundamentally lacks something others possess. In its healthy form, this becomes creative, uncompromising intensity. In its most deintegrated form — as the Compass already documents in the case of the Marquis de Sade, whose radical rejection of all order discharged into demonstrable acts of violence against others — the same wound can invert: instead of cultivating one's own suffering, it is acted out on others. Naranjo himself put this inversion of the SX4 in a terse formula: <em>"hurt people hurt people"</em> — the never-resolved pain of one's own becomes the source of the pain inflicted on others.</p>
        <p class="vb-intro"><strong>b) Family history as breeding ground:</strong>
        Contemporary accounts describe Báthory's family as unstable — an aunt reputed for sexual license, a brother considered an alcoholic and libertine, and in Elizabeth herself recurring, possibly epileptic seizures. This generational pattern of documented dysregulation fits the picture of a Four whose emotional foundation was unstable from the start, before absolute power with no outer check was added.</p>
        <p class="vb-intro"><strong>c) Unleashing after her husband's death:</strong>
        Count Ferenc Nádasdy, to whom Báthory was married from age fifteen, spent years at war against the Ottomans and was mostly absent — some sources even suggest he taught her torture methods himself. After his death in 1604, Báthory gained unrestricted control over the entire estate. The documented abuses escalated precisely from that point on — no outer frame kept the intensity in check any longer.</p>
      </div>

      <div class="vb-section" style="max-width:100%;">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">3. The Three-Wing: Status, Facade, and the Blood Countess Legend</h3>
        <p class="vb-intro">
        The Three-wing gives the Sexual Four a keen sense for effect, status, and outward presentation. Báthory moved with acute status awareness in the highest circles of Hungarian nobility, corresponded with the royal court, and outwardly cultivated the image of an educated, influential countess. This very status-consciousness later fed the blood-bathing legend: none of the tortured testimonies of the servant girls ever mentioned a blood bath for youth — the notion arose only afterward, among chroniclers who wanted to equip a noblewoman with exactly this status component. The real cruelty needed no such story; it was the expression of an unrestrained Four, not calculated vanity.
        </p>
      </div>

      <div class="vb-section" style="max-width:100%;">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">4. The Crime: Čachtice Castle</h3>
        <p class="vb-intro"><strong>a) The victims:</strong>
        Primarily affected were young servant girls from the surrounding area, as well as daughters of lesser noble families sent to Báthory to learn courtly manners — girls entirely dependent on her favor and defenseless before her. According to testimony from four later-arrested aides, they were beaten, injured with needles and scissors, branded with hot irons, doused with water while tied outdoors naked in winter, or tormented with bees and ants.</p>
        <p class="vb-intro"><strong>b) The discovery:</strong>
        On December 29, 1610, the royal Palatine Count György Thurzó, a relative, stormed Čachtice Castle with a force of men — according to reports, he found Báthory in the act of tormenting a victim. Four of her closest aides were arrested, interrogated under torture, and executed shortly after.</p>
        <p class="vb-intro"><strong>c) The evidence:</strong>
        Of 289 collected witness statements, more than 250 were pure hearsay with no direct observation. Báthory herself was never brought to trial or formally convicted — her noble rank shielded her from regular proceedings. Family members who wanted access to her fortune, as well as the Habsburg court, which owed her large sums, had a tangible self-interest in her removal from power. Complete innocence is nonetheless considered unlikely among historians — as early as 1602, a priest's letter documented extraordinary cruelty toward her staff, long before any political motive for an accusation existed.</p>
      </div>

      <div class="vb-section" style="max-width:100%;">
        <h3 style="font-size:1.05rem;font-weight:700;margin:0 0 1rem;color:var(--ink);">5. The Final Years: Walled Into Her Own Castle</h3>
        <p class="vb-intro">
        Since the public execution of a high-noble countess was considered unthinkable, Báthory was sentenced without trial to lifelong isolation at Čachtice Castle — tradition holds that the windows and doors of her chambers were walled up except for a narrow slit for food. She died there on August 21, 1614, at the age of 54, completely cut off from the outside world. The same isolation she had once forced upon others — captivity, cold, being at the mercy of a foreign power — became her own fate in the end.
        </p>
      </div>
      ...
      <div class="vb-section" style="max-width:100%;">
        ...
        <p class="vb-intro">
        Elizabeth Báthory shows how the Sexual Four's competitive envy can discharge in its darkest form, directed against others rather than against convention — a pattern the Compass has already documented in the Marquis de Sade. Unlike a Sexual Eight, whose motive is the cool, planned seizure of territory or people (such as Jeffrey Epstein, whose power operated through a system of seduction and quiet entanglement), the Four's cruelty is immediate, physical, and personal — not an organized network, but the direct discharge of a never-resolved inner wound onto the bodies of others. The Three-wing ensured this discharge stayed hidden behind the facade of a flawless, high-standing countess — until absolute, unchecked power no longer needed a facade at all.
        </p>
      </div>
      ...
      <div class="vb-section" style="background:rgba(40,40,80,0.05);border-radius:8px;padding:1rem 1.2rem;margin-bottom:2rem;max-width:100%;">
        ...
        <div style="font-size:0.88rem;line-height:1.8;">
          ...
          <p style="margin:0 0 0.3rem;"><strong>Subtype:</strong> SX4w3 – Sexual Four with Three-wing</p>
          <p style="margin:0 0 0.3rem;"><strong>Passion:</strong> Competitive envy – in its shadow form directed against others rather than against convention</p>
          <p style="margin:0 0 0.3rem;"><strong>Stress point:</strong> Two – intrusive, possessive closeness toward select confidants</p>
          <p style="margin:0 0 0.3rem;"><strong>Animal correspondence:</strong> Chihuahua – small in stature, immense in inner life, incapable of half measures</p>
          <p style="margin:0;"><strong>Teaching value:</strong> Báthory shows that the Four's competitive envy — unlike the cliché of the suffering, melancholic, inward-turned Four — can also discharge outward under absolute, unchecked power, with the same lack of compromise a healthy Four otherwise brings to a work of art or a relationship.</p>
        </div>
      </div>

      <div class="vb-section" style="max-width:100%;margin-top:2rem;">
        ${bookTip("die-verborgene-dynamik-der-27-subtypen", "The Sexual Four compared: how competitive envy expresses itself differently in SE4, SO4, and SX4 – and why, in extreme cases, it can turn against others instead of against convention.", "Die verborgene Dynamik der 27 Subtypes")}
        ${bookTip("die-27-persoenlichkeiten-des-enneagramms", "SE4, SO4, SX4 – 27 character profiles compared.", "Die 27 Persönlichkeiten des Enneagramms")}
        ${bookTip("wer-du-wirklich-bist-band-1", "Type 4 portrayed in depth – competitive envy, intensity, and the healing path to one's own wholeness.", "Wer du wirklich bist – Band 1")}
      </div>
      <div style="margin-top:2rem;padding:1rem;background:var(--surface);border-radius:8px;max-width:100%;">
        <p style="margin:0;font-size:0.85rem;color:var(--muted);line-height:1.6;">
        <strong>Note:</strong> This portrait serves depth-psychological analysis. The type attribution is a psychological hypothesis, not a historical judgment. Elizabeth Báthory was never officially charged or convicted; the early-17th-century evidence is historically contested, partly politically motivated, and based largely on testimony extracted under torture. The famous blood-bathing legend is now considered a later embellishment with no contemporary evidence. The Enneagram explains, it does not justify.
        </p>
      </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="vb-section" style="max-width:100%;">
        ...
        <p class="vb-intro"><strong>f) Naranjo's View of the Self-Preservation Seven – "a Disguised Eight":</strong> Claudio Naranjo placed little weight on the wings in his more than forty years of clinical work with clients – in his view, the 27 subtypes were already defined sharply enough that the additional wing layer was rarely needed to describe someone accurately. Naranjo made this observation in person during a seminar, in front of the participants – the author of this compass was present himself – that the Self-Preservation Seven often resembles an Eight in demeanor: patriarchal, generously protective toward one's own close circle, and ready to defend that position with hard consequence if needed – not the thrill-seeking, light Seven of the public stereotype, but a grounded, almost leader-like presence. As far as is known, this observation was never written down in Naranjo's own published work. In Imiela this description holds up point for point: he staged himself to his victims as a warm, fatherly, caring advisor – and, once that role was threatened or had served its purpose, followed through with exactly the uncompromising hardness Naranjo attributed to this expression of the Seven, whether one reads it as a distinct Eight-wing or as an integral part of the SP7 subtype itself.</p>
      </div>

  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        ...
        <p class="krim-portrait-subtitle">German singer-songwriter, b. 1942 &ndash; Animal correspondence: Sloth</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. The Sloth with a Guitar</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>sloth</strong> is the animal of the sexual Nine: it saves its energy until it merges completely with something or someone &ndash; and then it dissolves entirely into it. Few German singer-songwriters show this merging as directly as Reinhard Mey: alone with a guitar on stage for over five decades, and when he performs one of his own songs, hardly any boundary remains between performer and song.</p>
        ...
        <h2 class="vb-section">2. Sexual Nine: Merging With the Song, Not With the Audience</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>sexual Nine (SX9)</strong>, per Naranjo, seeks not belonging to a group but the one, complete merging &ndash; with a person, a work, a cause. One's own will recedes, often to the point of invisibility: what the other wants, what the song demands, becomes more important than any preference of one's own. Mey himself put it this way in an interview: becoming a traveling minstrel was his childhood dream, was it "as a young wild one," and is "still today the dream of the wild old man" &ndash; not a career plan, but a lifelong longing to dissolve completely into this one thing.</p>
          <p class="vb-intro">This shows up directly in his performing style: Mey doesn't stage his songs, he merges with them while singing &ndash; a disappearing into his own material that has little to do with a calculated, effect-oriented performance. That very ambivalence belongs to the SX9: the bond with his audience is real and important, but the actual merging happens first with the song itself, "utterly alone" on stage, as he himself puts it.</p>
        </blockquote>

        <h2 class="vb-section">3. The One-Wing: Five Hours Early, Every Song Once, Start to Finish</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">A Nine with a weak One-wing would tend to drift; the <strong>One-wing</strong> gives Mey a strict, decades-unchanged ritual instead: he arrives at the venue roughly five hours before a big show, does a thorough soundcheck &ndash; and then, alone, plays through the entire concert program once from start to finish, no matter how many times he has already played it. Only then does he dare go on stage. By his own account, this goes back to an early experience of losing his place on stage and having to be caught by the audience &ndash; since then he leaves nothing to chance.</p>
          <p class="vb-intro">Fittingly, Mey doesn't describe his stage fright as something that eased with more than fifty years of experience, but as a daily constant: "It's there every evening. It's the engine that drives me … the contest with myself, the free fall, the triumph over fear." That is the typical shift of the Nine under stress toward its stress point Six: the otherwise so relaxed merging with the moment gives way, shortly before the show, to an almost compulsive need for control that only settles once the entire program has been played through in full, disciplined order.</p>
          <p class="vb-intro"><strong>Distinguishing from the Social Four:</strong> At first glance, one might take Mey for a social Four with a Three-wing &ndash; a solo artist who deliberately sets himself apart from the mainstream with an unmistakable, pervasively melancholic voice. The decisive difference, however, lies in what he is actually after: the social Four seeks confirmation of her own otherness through her audience &ndash; <em>see how unique I am</em>. Mey himself never describes his goal as a wish for recognition of his own distinctiveness, but as a longing to dissolve completely into the craft itself: "I would like to keep writing, make music again with my friends in the studio, and someday go on stage utterly alone again and sing my songs, forever." That isn't a search for belonging or confirmation from a group, but a longing for merging itself &ndash; with friends in the studio just as much as, entirely alone, with the song on stage. His extremely guarded private life also fits the SX9 better than the SO4: it isn't about defending a carefully curated uniqueness, but simply about keeping the one central bond &ndash; his family &ndash; undisturbed.</p>
        </blockquote>

        <h2 class="vb-section">4. The Loss of a Son and the Child Who Was Allowed to Grow</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">In 2009, Mey's son Maximilian suffered severe pneumonia that left him in a coma; he died in 2014 at age 32, never having regained consciousness. Mey never turned this loss into a recurring public topic, but processed it in the song "Du bist ein Riese, Max!" ("You're a Giant, Max!") &ndash; which also carries the thought of how parents, through their upbringing, often make their children small instead of letting them grow big. That was exactly his declared parenting principle: deliberately giving his sons a great deal of freedom, "letting them be," rather than pushing them into a fixed shape &ndash; the Nine's strength of giving the other unconditional attention, even at the expense of one's own.</p>
          <p class="vb-intro">Politically too, Mey took positions with great personal intensity: "Nein, meine Söhne geb' ich nicht" ("No, I Won't Give Up My Sons," 1986) is a deeply personal refusal of war and state abuse of power &ndash; not an abstract statement, but the immediate merging of his own fatherhood with a political issue that affected him existentially.</p>
        </blockquote>

        <h2 class="vb-section">5. Light and Shadow of the Sexual Nine</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The light of the SX9w1 shows in Mey's ability to turn complete devotion to his craft into songs that have accompanied millions of people across generations &ndash; "Gute Nacht, Freunde" ("Good Night, Friends"), "Annabelle," and many more became a fixed part of the German-language songbook because they carry real merging, not calculated performance.</p>
          <p class="vb-intro">The Nine's shadow side is self-forgetting: setting one's own needs aside for another's until they are barely felt at all. Mey has never explicitly named this in himself, but his pattern fits precisely there: doing everything for the people close to him, while rarely appearing as someone with preferences of his own &ndash; wholly an instrument of his song, his family, his audience, rarely visible as someone with an independent will of his own.</p>
        </blockquote>

        <h2 class="vb-section">6. The Legacy: The Sloth Who Merged With His Song</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The healing path of the Nine leads from the self-forgetting <em>I don't count, as long as the connection remains</em> to the insight <em>I am already here, with my own weight, even within the merging.</em> Over five decades on stage, utterly alone and yet never truly alone, because he gives himself completely to his song &ndash; that is the lasting image of this sexual Nine with the One-wing: presence born from complete devotion, not from a wish to be seen.</p>
          <p class="vb-intro">How quietly this decades-long devotion to his craft actually went unnoticed only became visible in 2026: a data review by Germany's music industry association found that numerous albums from 1975 to 2000 had never officially received a Gold Record despite high sales figures &ndash; Mey was subsequently awarded at least 23 additional gold and platinum certifications, more than forty years late. Not a fame he had ever sought, but the quiet confirmation of a body of work that never defined itself by commercial success.</p>
          <p class="vb-intro">A revealing comparison within the international music business is <a href="javascript:void(0)" data-route="beruehmte-jon-bon-jovi">Jon Bon Jovi</a> (SX9w1) &ndash; in him, the same capacity for merging shows up both in an unbroken marriage since 1989 and in loyalty to the same band since 1983. More in the <a href="javascript:void(0)" data-route="beruehmte-jon-bon-jovi">portrait of Jon Bon Jovi</a>.</p>
        </blockquote>
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-jon-bon-jovi", label:"Portrait: Jon Bon Jovi (SX9w1)"},

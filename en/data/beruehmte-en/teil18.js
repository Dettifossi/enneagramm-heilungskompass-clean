...
export function anastasiaBarnerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-anastasia-barner-portrait.jpg" alt="Anastasia Barner – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function barackObamaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-barack-obama-portrait.jpg" alt="Barack Obama – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>social Two (SO2)</strong> is, in the Enneagram tradition, the subtype that does not channel the energy of the Two into personal relationships or physical care, but into social effectiveness. The SO2 does not just want to help one person &ndash; it wants to change systems, shape structures, improve the conditions under which people live. Naranjo called this subtype <em>Ambition</em>: not ambition for its own sake, but the drive to do more for others through influence and standing.</p>
...
export function budSpencerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-bud-spencer-portrait.jpg" alt="Bud Spencer" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function christopheBoeschPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-christophe-boesch-portrait.jpg" alt="Prof. Dr. Christophe Boesch – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function derekGoodwinPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-derek-goodwin-portrait.jpg" alt="Derek Goodwin – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>dove</strong> is the animal of the Self-Preservation Four &ndash; it withdraws into the quiet and the persistent, processing its inner experience not in public but in decades of unassuming devotion to a cause entirely its own. Few lives illustrate this pattern as literally as that of Derek Goodwin: over decades he worked his way up to principal scientific officer for birds at the Natural History Museum in London, writing along the way the books on doves, crows, and estrildid finches that are still regarded as the definitive works in their fields &ndash; a man whose archetypal animal is the dove, who devoted his entire working life to that one bird.</p>
          <p class="vb-intro">Goodwin was born Richard Patrick Goodwin in 1920 in Woking, though his parents called him Derek for his whole life, for reasons he himself never fully understood. While still on active duty in the Royal Artillery, which had included the Siege of Tobruk, a chance event in July 1945 &ndash; buying back issues of the Avicultural Magazine, before his official discharge that August &ndash; led to his being hired into the bird room of the Natural History Museum, with no formal training in ornithology whatsoever. From this accidental beginning grew a life's work.</p>
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      ${relatedLinks([
        ...
        {route:"astrologie-franz-kafka", label:"Enneagram Meets Astrology: Franz Kafka (SP5w4)"},
      ])}
    </div>
  `);
}
...
export function heatherThomasPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-heather-thomas-portrait.jpg" alt="Heather Thomas" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function indilaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-indila-portrait.jpg" alt="Indila – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jeanneMarieGuyonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jeanne-marie-guyon-portrait.jpg" alt="Jeanne-Marie Bouvier de la Motte Guyon – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">In Guyon this shows in its rawest form. After the early death of her husband in 1676, she could have led a life of wealth and social standing. Instead, she developed a teaching of complete self-abandonment &ndash; the <em>inner prayer of silence</em>, in which one's own will submits entirely to the will of God. She travelled, preached, wrote, founded circles of spiritual companions. Not a retreat into a convent, but a mission meant to act upon the world.</p>
        </blockquote>
...
export function jordanPetersonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jordan-peterson-portrait.jpg" alt="Dr. Jordan Peterson – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function keanuReevesPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-keanu-reeves-portrait.jpg" alt="Keanu Reeves" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function laurieMarkerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-laurie-marker-portrait.jpg" alt="Dr. Laurie Marker – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function ludwigWittgensteinPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-ludwig-wittgenstein-portrait.jpg" alt="Ludwig Wittgenstein – portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function marisaAbelaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-marisa-abela-portrait.jpg" alt="Marisa Abela" class="krim-portrait-img" loading="lazy" />
        </div>
        <p class="krim-portrait-name">Marisa Abela</p>
        <p class="krim-portrait-typ">SO2w1 &middot; Social Type 2 with One-wing</p>
        <p class="krim-portrait-subtitle">Actress, b. 1996 – Industry, Back to Black – Animal correspondence: Golden Retriever</p>
      </div>
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>social Two (SO2)</strong> directs the energy of the Two not toward single personal bonds, but toward the larger field: group, ensemble, community, social impact. Naranjo called this subtype <em>Ambition</em>, not ambition for its own sake, but the drive to accomplish more for the whole through influence and belonging. The SO2 asks: <em>How can I become indispensable within this community?</em></p>
          <p class="vb-intro">In Marisa Abela this shows in her work on the HBO series <em>Industry</em>, where she plays a young investment banker fighting to hold her ground in a ruthless, male-dominated environment. Abela has repeatedly stressed in interviews how important the ensemble feeling was to her on set, the conviction that a series is only as strong as how well the whole cast plays together. That is SO2 logic: success is not won alone, but carried together.</p>
          <p class="vb-intro">Her preparation for the role of Amy Winehouse in <em>Back to Black</em> carried the same signature: months of vocal training, immersing herself personally in Winehouse's music and world, trying not just to imitate a figure but to build a connection to her that would feel genuine to the audience. The social Two does not simply want to be seen, it wants the connection between itself and the people it touches to remain felt.</p>
        </blockquote>
        ...
        <h2 class="vb-section">4. Light and Shadow of the Social Two</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The light of the SO2w1 is its ability to give itself fully to a community, a project, a role, while keeping a standard of quality that goes beyond mere people-pleasing. Marisa Abela has repeatedly been described by colleagues as a generous, highly professional actress who strengthens an ensemble rather than subordinating herself to it.</p>
          <p class="vb-intro">The fate pattern of the Two is <strong>pride</strong>, the deep need to be needed and valued. In the SO2w1 this shows as the quiet worry of not having done well enough, combined with the standard of doing better than expected. This combination drives exceptional performance, but it can also exhaust when self-worth stays too tightly bound to recognition from others.</p>
        </blockquote>

        <h2 class="vb-section">5. Between Ensemble and Lead Role</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The shift from the ensemble series <em>Industry</em> to the leading role in <em>Back to Black</em> presented Marisa Abela with a new challenge: suddenly the responsibility for an entire film rested on her shoulders, no longer shared with a cast. The SO2w1 meets this shift not with retreat, but with even more preparation, even more care, as if she had to prove herself worthy of the trust placed in her.</p>
          <p class="vb-intro">The social orientation remains visible throughout: in interviews she speaks often of her responsibility toward Amy Winehouse's memory, toward her family and fans, rarely only about her own performance. The Golden Retriever carries the attention of others with humility, not with pride in itself alone.</p>
        </blockquote>

        <h2 class="vb-section">6. The Gift: Connection with Substance</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">What Marisa Abela brings to her work is a rare combination: the warmth that holds an ensemble together, and the discipline that carries a role. That is the gift of the SO2w1, a Golden Retriever that does not merely want to please, but knows that real connection only forms when you make the effort to earn it.</p>
          <p class="vb-intro">In an industry that often rewards self-promotion, Abela stands out for the opposite: her willingness to submit to an ensemble, a character, a standard, and to grow precisely through that. The Golden Retriever does not run ahead to be admired. It runs because it is needed, and that is enough for it.</p>
        </blockquote>
...
export function milowPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-milow-portrait.jpg" alt="Milow" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function nikolaTeslaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-nikola-tesla-portrait.jpg" alt="Nikola Tesla – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">How seriously he meant this is shown by one of the most consequential decisions of his life: George Westinghouse, who had bought the AC patent rights from Tesla, ran into financial trouble in the early 1890s because of the royalty payments owed to Tesla under their agreement. Tesla voluntarily tore up the contract that could have made him the richest man in the world, in order to save Westinghouse and, with it, the spread of the AC system itself &ndash; precisely the sacrifice Claudio Naranjo had in mind for the social Seven: his own material advantage mattered less than the larger cause.</p>
        </blockquote>
...
export function pharrellWilliamsPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-pharrell-williams-portrait.jpg" alt="Pharrell Williams" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function rowanAtkinsonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-rowan-atkinson-portrait.jpg" alt="Rowan Atkinson – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
        <p class="krim-portrait-name">Rowan Atkinson</p>
        <p class="krim-portrait-typ">SO7w6 &middot; Social Type 7 with Six-Wing</p>
        <p class="krim-portrait-subtitle">Actor, comedian, writer, b. 1955 in Consett, County Durham</p>
      </div>
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Claudio Naranjo termed the Social Type 7 the sacrifice or martyr—because this subtype sacrifices its own pleasures for the good of the group or a higher purpose. While the SP7 builds abundance for itself and the SX7 seeks happiness in merger, the SO7 aligns with the collective: it wants to belong, to contribute, to be part of something greater. Its hedonism turns inward—while outwardly presenting as a conscientious worker in the service of a community.</p>
          <p class="vb-intro">Atkinson views himself as part of the British comedy tradition—a long lineage of character comedians, satirists, and physical clowns stretching back to Charlie Chaplin and Buster Keaton, and shaped in his era by Peter Sellers and the Monty Python ensemble. He is no rebel breaking tradition—he studies it, honors it, and carries it forward. "Not the Nine O'Clock News" (1979–1982), the BBC sketch show that brought him fame, was a collaborative effort; "Blackadder" grew out of years of partnership with Richard Curtis and Tony Robinson. The SO7 does not build alone.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Rowan Atkinson's body of work encompasses three iconic characters that could hardly be more different: Edmund Blackadder—cynical, eloquent, possessing a biting intellect—is the exact opposite of Mr. Bean. Blackadder always knows what he wants and why everyone else is incompetent. The show ran for four series from 1983 to 1989, each set in a different historical era; the final series, "Blackadder Goes Forth," set in World War I, stands among the most celebrated moments in British television history.</p>
          <p class="vb-intro">Mr. Bean—mute, incompetent, child-like and egocentric—was created in 1990 and catapulted Atkinson to global fame. The character communicates almost entirely without words; he is universal because he requires no language. Mr. Bean was broadcast in over 200 countries. Atkinson has repeatedly stated that he finds the character increasingly burdensome—it sticks to him, even when he has long since moved on. "Johnny English" (starting in 2003) bridges both worlds: the articulate spokesman and the blunderer. The character is an affectionate parody of the British spy genre—a James Bond wannabe who considers himself infallible while failing spectacularly.</p>
        </blockquote>

        <h2 class="vb-section">5. Light and Shadow: The Man Behind the Mask</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The bright side of the SO7w6 is its craftsmanlike seriousness. Atkinson never tried to become famous—he tried to be good. His humor is meticulously observed, carefully constructed, never cheap. He has spent more time discarding ideas than executing them.</p>
          <p class="vb-intro">The shadow: The SO7 sacrifices—and eventually asks whether he has sacrificed too much. Atkinson has spoken openly in interviews about feeling constrained by Mr. Bean; feeling defined by a character he himself left behind long ago. The beaver built a dam—and now finds itself trapped inside its own creation.</p>
          <p class="vb-intro">In his private life, Atkinson is known to be reserved, almost invisible. He avoids the spotlight away from the stage, rarely grants interviews, and seldom engages in public debate. He is an avid motorist—owning rare sports cars and surviving two spectacular crashes in a McLaren F1—yet he is no public figure. The beaver dives out of sight when it is not building.</p>
        </blockquote>
...
export function steffiGrafPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-steffi-graf-portrait.jpg" alt="Steffi Graf" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function timBendzkoPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-tim-bendzko-portrait.jpg" alt="Tim Bendzko" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function benjaminDisraeliPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-benjamin-disraeli-portrait.jpg" alt="Benjamin Disraeli" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function aliWongPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-ali-wong-portrait.jpg" alt="Ali Wong – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function giorgiaMeloniPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/giorgia-meloni-portrait.jpg" alt="Giorgia Meloni – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function davidGuettaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-david-guetta-portrait.jpg" alt="David Guetta – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
        <p class="krim-portrait-name">David Guetta</p>
        <p class="krim-portrait-typ">SX9w1 &middot; Sexual Type 9 with One-wing</p>
        <p class="krim-portrait-subtitle">DJ and music producer, born 1967 &ndash; Animal correspondence: Sloth</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. The DJ Who Steps Back Behind the Booth</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>sloth</strong> hangs motionless from its branch while the thicket around it teems with life &ndash; not absent, but completely at one with its surroundings. David Guetta, born 1967 in Paris, began playing his first records at thirteen and by seventeen was already regularly behind the decks at Le Broad Club. Since the 1980s he has almost never sung himself &ndash; nearly every one of his global hits carries someone else's voice: Chris Willis, Kelly Rowland, Sia, Anne-Marie, Bebe Rexha.</p>
          <p class="vb-intro">This is precisely the sloth-like quality in him: the name David Guetta stands above the song, yet the person himself steps back and lets the actual voice take effect. Not a frontman claiming the stage for himself, but someone who merges with the musical moment instead of standing in front of it.</p>
        </blockquote>

        <h2 class="vb-section">2. The Sexual Nine: Merging Instead of Performing</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>Sexual Nine (SX9)</strong>, per Naranjo, does not seek its own stage presence, but complete absorption into a cause or a counterpart. In Guetta this shows in his near-constant practice of working with a guest vocalist instead of singing himself: "I spent my life working for DJs to be respected as much as artists," he once said of his ambition &ndash; not to shine as a solo artist, but to elevate the craft of DJing itself by merging it with other voices.</p>
          <p class="vb-intro">The same capacity for merging carries his Ibiza party series "F*** Me I'm Famous!," which he founded in 2002 and has continued for over two decades since &ndash; from Pacha to Hï Ibiza to Ushuaïa, always with rotating guest DJs, but under the same name and the same signature. It is not the single night that counts, but the one institution carrying through all those years.</p>
        </blockquote>

        <h2 class="vb-section">3. The One-wing: System Behind the Sound</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>One-wing</strong> shows in Guetta less as strict morality than as a methodical approach to sound and genre. Again and again he recognized early which musical currents could be combined &ndash; electro-house with pop, later future house with mainstream radio sound &ndash; and built systematically repeatable production formulas from them, refined consistently over years rather than chasing a single lucky hit.</p>
          <p class="vb-intro">His 2009 breakthrough with the Black Eyed Peas and Kelly Rowland was likewise no isolated case, but the first building block of an ordered system of features, remixes, and chart successes sustained for decades &ndash; an underlying order behind the apparent casualness of the party business.</p>
        </blockquote>

        <h2 class="vb-section">4. The Work: From Paris Club to Grammy</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">In 1994 Guetta became manager of the Paris club Le Palace, and in 2001 he co-founded the production company Gum Productions with Joachim Garraud. His first big hit, "Just a Little More Love," sold over 300,000 copies, and his 2002 debut album sold around 250,000. "When Love Takes Over" (2009, feat. Kelly Rowland) brought his international breakthrough, crowned by a Grammy for Best Remix.</p>
          <p class="vb-intro">Since then he has ranked among the most-streamed and most-booked DJs in the world, with hits like "Titanium" (feat. Sia) or "I'm Good (Blue)" &ndash; each time with a different voice at the center, each time with Guetta himself in the background at the controls.</p>
        </blockquote>

        <h2 class="vb-section">5. Light and Shadow of the Sexual Nine with One-wing</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The light of the SX9w1 shows in Guetta in the ability to keep entering new mergers across the decades &ndash; with singers, genres, audiences &ndash; without ever losing his own signature. The One-wing gives this flexibility a recognizable, repeatable structure.</p>
          <p class="vb-intro">The shadow of the Nine appeared in 2014, when his 22-year marriage to Cathy Guetta ended in divorce &ndash; a break showing that even the Nine's seemingly effortless merging can reach its limits when two people grow apart over the years. Since 2015 he has been with Jessica Ledon, with whom he has two more children &ndash; a new bond, once again held for the long term.</p>
        </blockquote>

        <h2 class="vb-section">6. The Man at the Mixing Desk Who Leaves the Stage to Others</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">David Guetta's path shows the sexual Nine with One-wing in its most public and yet most unassuming form: one of the best-known names in pop music, who consistently steps back behind other people's voices and would rather carry the whole than stand in the spotlight himself. The sloth hangs from its branch at the center of the storm &ndash; and still lets the storm around it put on the show.</p>
          ${bookTip("wer-du-wirklich-bist-band-1", "The nine types in their depth – defense patterns, passions, and the path to essence.", "Wer du wirklich bist – Band 1")}
          ${bookTip("die-verborgene-dynamik-der-27-subtypen", "27 subtypes: passions, defense strategies, and healing paths from therapeutic practice.", "Die verborgene Dynamik der 27 Subtypes")}
          ${bookTip("die-27-persoenlichkeiten-des-enneagramms", "27 character profiles in comparison – how the subtypes of the same type differ from one another.", "Die 27 Persönlichkeiten des Enneagramms")}
        </blockquote>
...
export function connieChiuPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-connie-chiu-portrait.jpg" alt="Connie Chiu – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
        ...
        <p class="krim-portrait-subtitle">Model and jazz singer, born 1969 &ndash; the first known model with albinism &ndash; Animal equivalent: Dove</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. The Dove That Fled the Sun to Stay Who She Was</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>dove</strong> does not carry its difference around as a wound – it quietly moves to wherever it can protect itself. Connie Chiu, born in 1969 in Hong Kong, was the only one of four children in her Chinese family born with albinism. At age seven, the family moved to Sweden – a deliberate, unspectacular decision to protect her from Hong Kong's intense sun, not a dramatic act of flight.</p>
          <p class="vb-intro">In Sweden she first studied art and radio journalism – a solid, practical foundation before, at 24, she began her modeling career with French designer Jean Paul Gaultier and entered the fashion industry as the first known model with albinism.</p>
        </blockquote>

        <h2 class="vb-section">2. Self-Preservation Four: Downplaying Instead of Dramatizing</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">According to Naranjo, the <strong>Self-Preservation Four (SE4)</strong> is the countertype of the Four: instead of putting one's own difference on display, it is persistently downplayed and dealt with practically. Chiu puts this tellingly, matter-of-factly: "I was not bullied in school, but every now and then, people try to provoke or upset me" – a statement that minimizes rather than complains, even though she was among other things called by the name of a horror-film character, "White Hair Devil Woman."</p>
          <p class="vb-intro">Asked what she would tell a child with albinism, she answered simply: "Believe in yourself." About her own relationship to her difference, she said: "I guess I always knew I was different, but I feel exactly the same as anyone." No drama, no claim to special sympathy – just the quiet statement of belonging.</p>
        </blockquote>

        <h2 class="vb-section">3. The Five Wing: Two Considered Careers Instead of One Loud One</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>Five Wing</strong> gives the Self-Preservation Four a structured, observing note – one's own position is not seized impulsively, but built systematically over years. Chiu never tied her modeling career to pure self-display, but built a second, equally demanding career as a jazz singer alongside it, performing at major events and jazz clubs.</p>
          <p class="vb-intro">Her reflection on prejudice stays strikingly analytical rather than emotionally charged: "It's human nature to be prejudiced. And any place that is segregated – only Greek, or only black, or only Swedish – people react strongly to those that stand out. I've always preferred to be where a lot of different people are mixing together." An observing, almost sociological distance from her own experience – typical of the Five Wing.</p>
        </blockquote>

        <h2 class="vb-section">4. The Work: From the Runway to the Jazz Stage</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">From her first steps on Gaultier's runway through an international modeling career to establishing herself in parallel as a jazz singer, a continuous line of persistent reinvention runs through Chiu's career: she never let herself be reduced to the role of "the first albino model," but kept expanding her own field with an additional, seriously developed art form.</p>
        </blockquote>

        <h2 class="vb-section">5. Light and Shadow of the Self-Preservation Four with a Five Wing</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The light of the SE4w5 shows in Chiu's ability neither to hide a deeply personal physical trait nor to make it her sole identity, but to turn it into an independent, internationally visible career – calmly, persistently, without a big gesture.</p>
          <p class="vb-intro">The shadow of the Four shows in the constant need to downplay provocations rather than naming them openly – minimizing can also become a protective strategy that keeps one's own vulnerability invisible from the outside. The Five Wing reinforces this tendency through an analytical distance that can sometimes make genuine closeness harder.</p>
        </blockquote>

        <h2 class="vb-section">6. The Dove That Stayed Calmest in the Brightest Light</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Connie Chiu's path shows the Self-Preservation Four with a Five Wing in a particularly quiet form: a physical trait that made others stare never became a loud accusation, but the calm foundation of two independent artistic careers. The dove needs no harsh light to be seen – it finds its own tone, even in the shadow.</p>
          ${bookTip("wer-du-wirklich-bist-band-1", "The nine types in depth &ndash; protective patterns, passions, and the path to essence.", "Who You Really Are &ndash; Volume 1")}
          ${bookTip("die-verborgene-dynamik-der-27-subtypen", "27 subtypes: passions, protective strategies, and paths to healing from therapeutic practice.", "The Hidden Dynamics of the 27 Subtypes")}
          ${bookTip("die-27-persoenlichkeiten-des-enneagramms", "27 character profiles compared &ndash; how the subtypes of the same type differ from one another.", "The 27 Personalities of the Enneagram")}
        </blockquote>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">The social Nine is considered the <strong>countertype of the Nine</strong> in Enneagram literature: while the Nine's core passion tends toward sloth &ndash; avoiding her own energy to risk no conflict &ndash; the social variant often shows the opposite: a striking, at times almost tireless diligence. The reason lies exactly in where the energy is directed: where the self-preservation Nine channels her energy into personal comfort and the sexual Nine into the one intense merging, the social Nine has to actively engage for the community to feel her belonging &ndash; which demands effort, not withdrawal. In the Dalai Lama this shows in a body of work that has nothing in common with mere sloth: decades of diplomatic travel, hundreds of books and writings, building entire educational and cultural institutions in exile &ndash; a discipline that stems not only from the One-wing, but from the countertype dynamic of the social Nine itself.</p>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">5. Why Not Simply an Eight?</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">For someone who effectively stood at the top of power for decades, dismantled institutions, and decisively led a war, the suspicion of an Eight is natural &ndash; and not unfounded. Anyone who actually wields power gets associated with Eight attributes almost automatically: assertiveness, control, hardness in a crisis. Outwardly, all of that was present in Gandhi.</p>
          <p class="vb-intro">The decisive difference, however, lies not in the scale of the power, but in its <strong>psychological source</strong>. A genuine Eight in the same position would have openly claimed her drive for power, not denied it &ndash; Gandhi's own "I am not ambitious," spoken while she held total power, is a statement an Eight would hardly make; an Eight fundamentally does not feel ashamed of its will to power. A genuine Eight would also more likely have responded to the 1977 election defeat by fighting to the last stand of resistance rather than with the skillful, image-conscious adaptation Gandhi used to organize her comeback &ndash; stubbornness rather than adaptability is a core Eight trait she did not show in this form. And a genuine Eight usually conceals its own vulnerability consistently, even in private, because that is precisely where its deepest fear lies; Gandhi, by contrast, repeatedly spoke openly about her loneliness and sadness &ndash; an openness that fits the Three-Four combination, but hardly the Eight.</p>
          <p class="vb-intro">The Emergency itself is thus better read as a Three's reaction under existential threat than as an expression of a fundamental Eight claim to power: when one's own, painstakingly proven competence is suddenly called into question &ndash; by a court ruling, by mass protests &ndash; the SE3's logic of securing existence through functioning can produce a hardness that looks like Eight-style dominance from the outside, but is fed by an entirely different inner necessity: not the need to rule, but the fear of being exposed as incompetent or expendable.</p>
        </blockquote>

        <h2 class="vb-section">6. The Raccoon Who Lost the Election in 1977 and Returned in 1980</h2>
        <blockquote class="vb-blockquote">
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">His approach also found practical expression in RadarOpus, the world's leading homeopathic software system: a dedicated add-on module, the "Vithoulkas Expert System," was built specifically to digitally reproduce his characteristic thought process for symptom analysis and remedy selection – a sign of how deeply his approach has entered the everyday practice of homeopaths worldwide. The same software also carries, as its own separate add-on module, "Rathmer's Repertorium" – with well over 20,000 mind/emotion rubrics the most comprehensive reference work on psychological homeopathy, written by this compass's own author, Detlef Rathmer.</p>
        </blockquote>

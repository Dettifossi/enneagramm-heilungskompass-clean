    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">The shadow lies in the risk that the principle of leaving things uncut becomes an end in itself. In the more than four-hour 2026 conversation with the AfD politician Björn Höcke, Höcke was allowed to claim, uncontradicted, that the NSDAP's SA had no slogan – a statement that is not only historically false (a final 2006 ruling by the Hamm Higher Regional Court holds "Alles für Deutschland" to be the SA's slogan – independently confirmed by museum and weapons-history documentation as well: the SA service dagger introduced in 1933 carried exactly this inscription, etched into the blade), but contradicts Höcke's own legal history: he was criminally convicted twice for publicly using that exact banned phrase. North Rhine-Westphalia's state media authority subsequently formally admonished Berndt to observe journalistic due-diligence obligations and to provide exactly that missing correction.</p>
          <p class="vb-intro">Berndt's own response to this criticism is telling: he points out that he is not a journalist and speaks of censorship – rather than reconsidering his own rule in this specific case, he defends it as a principle. This is the flip side of the very same One's discipline that inspires so much trust in the light: a self-imposed law held to consistently can shut out well-founded criticism just as consistently as arbitrary criticism.</p>

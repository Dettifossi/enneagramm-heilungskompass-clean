    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">The shadow lies in the risk that the principle of leaving things uncut becomes an end in itself – visible in the criticism of his multi-hour, largely uncritical 2026 conversation with the AfD politician Björn Höcke: where one's own rule ("do not intervene, do not comment, anyone may say anything") is applied absolutely, it can become a blind spot: what is meant as consistent adherence to principle can, with guests holding extreme positions, effectively become an unchallenged stage – not because Berndt himself demands critical framing and then withholds it, but because his principle of non-intervention makes no distinction between the guest it serves well and the guest for whom that same principle becomes the problem.</p>
        </blockquote>

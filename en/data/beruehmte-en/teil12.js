...
export function alexanderDerGrossePortraitPage() {
  return shell(`
...
export function arminRohdePortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-armin-rohde-portrait.jpg" alt="Armin Rohde – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function bracoPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-braco-portrait.jpg" alt="Braco – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function changpengZhaoPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-changpeng-zhao-portrait.jpg" alt="Changpeng Zhao – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function danteAlighieriPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-dante-alighieri-portrait.jpg" alt="Dante Alighieri" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">It is striking how seamlessly Dante's nine circles of Hell still map onto the nine passions of the Enneagram today &ndash; even though he naturally had no knowledge of the psychological model as it is taught now. He drew on the same foundation of archetypal vices that Christian scholasticism and ancient philosophy had worked out over centuries &ndash; and thereby demonstrated an intuitive grasp of the human psyche that, centuries later, deeply occupied Claudio Naranjo and other Enneagram teachers as well. A detailed correspondence can be found in the chart "The 9 Circles of Hell According to Dante's Inferno."</p>
        </blockquote>
...
export function donataHopfenPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-donata-hopfen-portrait.jpg" alt="Donata Hopfen – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
        <p class="krim-portrait-name">Donata Hopfen</p>
        <p class="krim-portrait-typ">SO6w7 &middot; Social Type 6 with Seven Wings</p>
        <p class="krim-portrait-subtitle">Management consultant, digital consultant, b. 1976 in Hamburg – Animal equivalent: Meerkat</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. The Meerkat</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The meerkat keeps watch for the group. It is vigilant, cooperative, and deeply oriented toward security through belonging. But not every meerkat keeps watch in the same way. Some climb quietly onto the highest rock and methodically scan the horizon that is the Five wing, the meerkat of analysis. Others run off, mobilize the group, bring movement to the territory before the threat is even visible that is the Seven wing. Donata Hopfen belongs to the second kind.</p>
          <p class="vb-intro">She is a management consultant, digital strategist, former CEO of Bild and the Deutsche Fußball Liga (German Football League). A woman who stepped into large, sluggish systems wanting to get them moving. Not out of self-interest, but from the deeply rooted SO6 drive: I am here for the group. I handle what needs to be done. I clear the way. The meerkat of the SO6w7 does not run away it runs ahead.</p>
        </blockquote>

        <h2 class="vb-section">2. Duty: Security Through Departure</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Claudio Naranjo called the social Type 6 duty security arises through serving, through belonging, through fulfilling a task for the collective. But the Seven wing changes how this duty is lived. Where Melanie Kreis (SO6w5) finds security through structure, analysis, and quietly fulfilling her role, the SO6w7 seeks security through movement. Moving forward feels safer than standing still. Taking on a task feels safer than waiting. The SO6w7 serves but it serves with speed.</p>
          <p class="vb-intro">Hopfen built her career on this pattern: McKinsey the classic starting point for analysts and strategists. Then digital leadership roles in the media and technology sectors. In 2021, she became CEO of Bild, Germany's largest tabloid media outlet a house under transformational pressure. In 2022, she took over management of the Deutsche Fußball Liga (DFL), the governing body of the Bundesliga. Every one of these projects was a system in transition. And Hopfen was the one who said: I will take this on. We are getting this moving.</p>
          <p class="vb-intro">That is the difference from the SO6w5: Melanie Kreis builds security by growing deep into a structure. Donata Hopfen builds security by renewing structures. Both serve the group. But one holds fast, while the other shapes.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Hopfen's most famous and turbulent station was her time as CEO of the DFL (Deutsche Fußball Liga, governing body of the Bundesliga). She took office in November 2022 with a clear mandate: lead the Bundesliga into the digital future and tap into new revenue sources. At the center was an investor deal with the private equity firm CVC Capital Partners, which was supposed to bring around two billion euros to the DFL.</p>
          <p class="vb-intro">What followed was one of the most spectacular conflicts in German football: Fans protested massively against the entry of investors, games were interrupted by tennis balls and other objects on the pitch, clubs withdrew their support. In February 2023 after barely three months in office Hopfen stepped down. The deal did not materialise.</p>
          <p class="vb-intro">It was a classic SO6 experience in its harsh form: Hopfen had acted on behalf of the group, and the group turned against her. Not because the strategy was wrong, but because it tackled a spot where the fear and identity of football collided. The Seven wing had made her fast and decisive. The SO6 vulnerability hit her when belonging broke away.</p>
        </blockquote>

        <h2 class="vb-section">5. Light and Shadow: When the Group Votes Out the Guardian</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The light of the SO6w7 is its ability to set a community in motion. Hopfen is in demand as a consultant and speaker because she combines clarity, courage, and strategic vision. She can read systems, name opportunities, and carry people along. That is the SO6w7 on the bright side: It does not just serve it inspires.</p>
          <p class="vb-intro">The shadow of the SO6w7 lies in speed. Where Melanie Kreis (SO6w5) brakes with the Five wing, thoroughly checks, and only then acts, the SO6w7 can run off too early before the group is truly ready to come along. The Seven wing generates momentum and enthusiasm, but enthusiasm alone does not build a bridge between a vision and the fears of the people expected to follow that vision. The DFL episode shows this pattern in its purest form: The departure was real, the necessity was real but the group was not yet where the vision already was.</p>
          <p class="vb-intro">For the SO6, this is the deepest wound: Being cast out from the community by the exact same community one stepped up for. Hopfen made this experience public. And did not disappear afterward. That is the difference between the SO6 shadow and SO6 maturity: The mature Six knows that belonging does not hinge on a single group.</p>
        </blockquote>

        <h2 class="vb-section">6. The Meerkat That Realigns Itself</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">After her resignation at the DFL, Donata Hopfen did not go into hiding. She advises companies on digital strategy and leadership issues, gives lectures, and engages in networks. The meerkat of the SO6w7 does not retreat to the safest rock to watch the world quietly from there. It looks for the next group that needs a guard.</p>
          <p class="vb-intro">Two meerkats, one task, two completely different paths: Melanie Kreis has been keeping the same watch for the same corporation for years, steadfast and precise. Donata Hopfen has traversed several territories, weathered several storms, and kept moving forward multiple times. Both live the duty of the social Six. But one embodies it as persistence, the other as the courage to set out. The meerkat of the SO6w5 keeps watch because it stays. The meerkat of the SO6w7 keeps watch because it keeps starting anew.</p>
        </blockquote>
...
export function fionaApplePortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function gangajiPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-gangaji-portrait.jpg" alt="Gangaji" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function hansChristianAndersenPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-hans-christian-andersen-portrait.jpg" alt="Hans Christian Andersen – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">A note without determinism: Andersen's health suffered throughout his life from psychosomatic complaints &ndash; dental problems, digestive disorders, pronounced hypochondria &ndash; that cannot be traced monocausally to his subtype. What remains notable is how closely his constant worry about illness and rejection was interwoven with his core pattern. Andersen naturally had no conscious knowledge of his own Enneagram pattern; his longing for belonging governed him unopposed, with no language to recognize it as a recurring pattern, instead suffering it again and again as individual fate &ndash; not out of guilt, but out of ignorance of his own pattern.</p>
        </blockquote>
...
export function hughWarwickPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-hugh-warwick-portrait.jpg" alt="Hugh Warwick – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">The British ecologist Hugh Warwick has studied hedgehogs since the mid-1980s, spent months radio-tracking the animals across southwest England and Scotland, and has devoted practically his entire professional life to them for over three decades. One of his best-known books carries the telling title "A Prickly Affair" &ndash; a title that describes his relationship to the hedgehog for exactly what it is: an affair, not merely a field of study.</p>
        </blockquote>
...
export function janeGoodallPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-jane-goodall-portrait.jpg" alt="Dr. Jane Goodall – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function johannWolfgangVonGoethePortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-johann-wolfgang-von-goethe-portrait.jpg" alt="Johann Wolfgang von Goethe" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function karlLagerfeldPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">And yet Lagerfeld's effect was no mystery: one saw enough of him to recognize him instantly—the white hair, the black suit, the severity of the posture. He had transformed himself into a symbol identifiable at a glance, worldwide, timeless. That is the quality of gaze of the social Three at its masterful stage: not returning glances, but commanding them.</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The social subtype of the Three, commonly called the prestige/reinforcement type, does not live for success—he is success. Karl Lagerfeld embodied this type in the cultural history of the 20th century like almost no one else. His work at Chanel—taken over in 1983, when the house was considered outdated, and led until his death in 2019—is one of the most extraordinary transformation stories in the fashion world.</p>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">This cheetah energy was also evident in his speed: Lagerfeld sketched designs in minutes; his hand drawings are sought-after even today. The SO3 thinks fast—he has little patience for processes that slow down his tempo. The result must be good, and it must be done now.</p>
...
export function ladyDianaPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-lady-diana-portrait.jpg" alt="Lady Diana – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>self-preservation Four (SP4)</strong> is, in the Enneagram tradition, the counter-type of the Four: it does not display its inner life outwardly, does not draw it into grand gestures or dramatic self-presentation. Naranjo called this subtype <em>tenacity</em> &ndash; not in the sense of harshness toward others, but as a drive toward ruthless honesty with oneself. The SP4 wrestles with pain &ndash; but wrestles with it silently. It shows strength outwardly while struggling within.</p>
...
export function loiPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-loi-portrait.jpg" alt="Loi (Leonie Greiner) – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function marieAntoinettePortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-marie-antoinette-portrait.jpg" alt="Marie Antoinette" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function nataschaKampuschPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-natascha-kampusch-portrait.jpg" alt="Natascha Kampusch – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function paulMccartneyPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-paul-mccartney-portrait.jpg" alt="Paul McCartney" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">In McCartney this shows in sharp contrast to his former songwriting partner John Lennon &ndash; typed in the Compass as a social Four with Five-wing (SO4w5) &ndash; who processed his wounds publicly, raw and unpolished, in songs such as &bdquo;Mother.&ldquo; This is not mere coincidence of personality but follows the subtype theory itself: the social Four is considered the amplification type and is colloquially known as the <em>&bdquo;Sad Four&ldquo;</em> &ndash; the Four that carries its suffering visibly outward, to be seen. The self-preservation Four, by contrast, the counter-type, is the <em>&bdquo;Glad Four&ldquo;</em> &ndash; it tends to show a cheerful face while the pain travels inward. (The third in the trio, the sexual Four, is considered the <em>&bdquo;Mad Four&ldquo;</em> &ndash; the angry, passionate Four.)</p>
          <p class="vb-intro">McCartney followed the path typical of the SP4: even his most painful experiences &ndash; the early death of his mother at fourteen, the breakup of the Beatles, private losses &ndash; usually appear in his music disguised, wrapped in metaphor, softened by melody. Where Lennon screamed, McCartney composed &ndash; two Fours, two entirely different expressions of the same fate pattern.</p>
...
export function robbieWilliamsPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function shakiraPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-shakira-portrait.jpg" alt="Shakira – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function theaLitschkaKoenPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-thea-litschka-koen-portrait.jpg" alt="Thea Litschka-Koen – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function umbertEcoPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-umberto-eco-portrait.jpg" alt="Dr. Umberto Eco – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>Orangutan</strong> is the animal of the Self-Preservation Type 8 &ndash; and no image captures Umberto Eco more precisely. The Orangutan is the most solitary of the great apes: it needs no troop. It moves slowly, deliberately, with a dignity that knows no hurry. Its tool use is legendary. It is the only one among the apes that stores knowledge of food sources in a particular territory accumulated over decades &ndash; a walking archive.</p>
          <p class="vb-intro">Umberto Eco owned over 30,000 books. Not as decoration but as instruments of thought. He called it his <em>antilibrary</em>: the books one has not yet read are more important than those one has &ndash; for they remind one of everything one does not yet know. The Orangutan sits enthroned in its tree, surrounded by what it has accumulated. And it smiles when others ask whether it has really read all of them.</p>
        </blockquote>
        ...
        <h2 class="vb-section">4. The Passion: Lust as Creative Force</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The passion of the Eight is called <strong>lust</strong> &ndash; not in the narrow sense, but as a hunger for intensity, for vitality, for the full experience. The Self-Preservation Eight directs this hunger toward the material: toward possession, toward sensory experience, toward everything that can be touched, read, tasted, thought through.</p>
          <p class="vb-intro">Eco read everything. He wrote about everything. He collected everything. His semiotics was not dry science &ndash; it was an attempt to grasp the world as a system of signs that can be penetrated, possessed, decoded. <em>Foucault's Pendulum</em> is a novel about men who construct a world conspiracy from signs &ndash; and are destroyed by it. Eco knew the seductive power of knowledge. And he surrendered to it, joyfully, for a lifetime.</p>
        </blockquote>
...
export function wolodymyrSelenskyjPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-wolodymyr-selenskyj-portrait.jpg" alt="Wolodymyr Selenskyj" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function markusLanzPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-markus-lanz-portrait.jpg" alt="Markus Lanz – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">For over 30 years, Lange has accompanied executives at international corporations across Europe, Asia, and the USA. Media outlets such as "Stern," "Spiegel," and "Focus" counted him among Germany's most important success strategists; his book "Winners Are Recognizable from the Start" bundles his central approach: attitude and perspective decide success or failure long before the actual challenge begins.</p>
          <p class="vb-intro">Characteristic of the SP1w9 is that, despite his charismatic, image-rich rhetoric, Lange is described as someone who does not shy away from conflicts that genuine change requires &ndash; the Nine-wing's inner calm does not make him conflict-averse, but gives him the composure to speak uncomfortable truths without losing his own footing.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">In fairness, a qualification belongs here too: however authentically this path is lived, it remains at its core the path of a conscious, integrated self-preservation One with a Nine-wing &ndash; and what Lange conveys as a universally valid road to inner clarity is, first of all, <em>his</em> road, shaped by his own subtype. As the Enneagram itself shows, that cannot be the right approach for every person in the same way. Since most coachees don't know the Enneagram, though, this does not diminish his achievement: conscious Ones have exactly the ability to formulate, out of their own lived-through truth, insights that hold true and helpful far beyond their own subtype for many people &ndash; and to pass them on to their coachees with didactic skill, life experience, and without a wagging finger.</p>
        </blockquote>
...
export function carloAncelottiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-carlo-ancelotti-portrait.jpg" alt="Carlo Ancelotti – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
        <p class="krim-portrait-name">Carlo Ancelotti</p>
        <p class="krim-portrait-typ">SO9w8 &middot; Social Type 9 with Eight-wing</p>
        <p class="krim-portrait-subtitle">Football manager, born 1959 &ndash; Animal correspondence: Buffalo</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. The Buffalo That Never Leaves the Herd</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>buffalo</strong> doesn't move as a lone animal, but as part of a herd that follows him because it trusts him, not because it fears him. Carlo Ancelotti, born 1959 to a farming family in Emilia-Romagna, is the only manager in history with five Champions League titles, and in 2022 became the first to win all five major European league titles – with Milan, Chelsea, Paris Saint-Germain, Bayern Munich, and Real Madrid.</p>
          <p class="vb-intro">Despite this unmatched record, he never presents himself as a sole ruler. His own line, "I giocatori sono miei amici" (the players are my friends), sums up what matters to him: not distance and command, but belonging to a team he treats as part of himself.</p>
        </blockquote>

        <h2 class="vb-section">2. The Social Nine: Leadership Through Belonging, Not Command</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>Social Nine (SO9)</strong>, per Naranjo, gains her identity by dissolving into a community rather than through her own elevated role within it. In Ancelotti this shows in his famous "calm leadership style": even difficult personalities like Cristiano Ronaldo or Zlatan Ibrahimović speak appreciatively of him in hindsight – not because he subordinated himself to them, but because he treated them as part of a shared whole rather than trying to control them.</p>
          <p class="vb-intro">Kaká described him as the manager who taught him the most, precisely because his "most striking characteristic is his ability to manage people" – not tactical genius alone, but the talent to turn a collection of individual stars back into a herd that moves as one.</p>
        </blockquote>

        <h2 class="vb-section">3. The Eight-wing: The Delayed but Merciless Reckoning</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>Eight-wing</strong> shows in Ancelotti not in everyday life, but in the rare moments when his otherwise unshakable calm gives way to a clear, hard statement. After his dismissal from Bayern Munich in 2017, he initially remained publicly composed – only years later, in his 2025 memoir, did he plainly call the sacking "the most ruthless dismissal of my entire career." No more diplomatic silence, but a clear verdict, delivered on his own timeline.</p>
          <p class="vb-intro">The same directness showed when rumors surfaced about a rift with Real Madrid's dressing room and president Florentino Pérez: instead of dodging the question, he stated unambiguously: "Whoever says I have a conflict with the club, with the president, is not telling the truth." A direct rebuke, not evasion – typical of the Eight-wing, which gives the Nine's usual search for harmony a sharp edge when it truly matters.</p>
        </blockquote>

        <h2 class="vb-section">4. The Work: From Farmer's Son to the Most Decorated Manager</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">As a player, Ancelotti won, among other titles, two European Cups with AS Roma and AC Milan, before beginning his coaching career at Reggiana in 1995. Via Parma, Juventus, and Milan (Champions League title 2003), his path eventually led to international spells at Chelsea, PSG, Bayern Munich, and Real Madrid – with 36 titles won in total, one of the most decorated managerial careers in football history.</p>
          <p class="vb-intro">Notably, despite repeated dismissals from prestigious clubs, he remained consistently in demand – a pattern showing how much clubs and players valued his ability to reshape a collection of individual talents back into a functioning community.</p>
        </blockquote>

        <h2 class="vb-section">5. Light and Shadow of the Social Nine with Eight-wing</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The light of the SO9w8 shows in Ancelotti in his near-unique ability to bring together extremely different star personalities on one team without elevating himself above them – success, for him, arises from belonging, not from dominance.</p>
          <p class="vb-intro">The shadow of the Nine shows in the long delay before justified criticism is voiced at all – it took years after his Bayern dismissal for him to find the clear words for it. This restraint protects harmony in the short term, but prevents real conflicts from being named and worked through in a timely way.</p>
        </blockquote>

        <h2 class="vb-section">6. The Manager Who Never Left the Herd</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Carlo Ancelotti's path shows the social Nine with Eight-wing in its most successful form: calm, belonging-oriented leadership that incorporates even the most difficult star egos rather than subduing them – and a rare but then merciless directness, once the clear word finally comes after years of silence. The buffalo doesn't lead by command, but by the fact that the herd follows him anyway.</p>
          ${bookTip("wer-du-wirklich-bist-band-1", "The nine types in their depth – defense patterns, passions, and the path to essence.", "Wer du wirklich bist – Band 1")}
          ${bookTip("die-verborgene-dynamik-der-27-subtypen", "27 subtypes: passions, defense strategies, and healing paths from therapeutic practice.", "Die verborgene Dynamik der 27 Subtypes")}
          ${bookTip("die-27-persoenlichkeiten-des-enneagramms", "27 character profiles in comparison – how the subtypes of the same type differ from one another.", "Die 27 Persönlichkeiten des Enneagramms")}
        </blockquote>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">One facet remains notable: Zeilinger calls himself a "romantic" and stresses that genuine scientific innovation does not arise through pure logic alone, but only where intuition comes into play – language that sounds more like a four wing than a six. On closer look, though, it stays a single shade rather than a load-bearing pattern: neither the Four's typical emphasis on one's own distinctiveness nor a withdrawal from the team in favor of individual self-display shows up here. In him, intuition stays embedded within the reliable, communal system – a Six who opens himself to the unpredictable without leaving his basic structure behind.</p>
        </blockquote>

...
export function adamSmithPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-adam-smith-portrait.jpg" alt="Adam Smith – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function andyReidPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-andy-reid-portrait.jpg" alt="Andy Reid – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function bernardFayePortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-bernard-faye-portrait.jpg" alt="Dr. Bernard Faye – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function carlFriedrichGaussPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-carl-friedrich-gauss-portrait.jpg" alt="Carl Friedrich Gauss – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function claudioNaranjoPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function diegoVelazquezPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function eliJaxonBearPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-eli-jaxon-bear-portrait.jpg" alt="Eli Jaxon-Bear – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function franzVonAssisiPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-franz-von-assisi-portrait.jpg" alt="Francis of Assisi" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-henry-shukman", label:"Portrait: Henry Shukman (SO7w6) – Zen teacher"},
...
export function gloriaVonThurnUndTaxisPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-gloria-von-thurn-und-taxis-portrait.jpg" alt="Gloria von Thurn and Taxis – Portrait" class="krim-portrait-img" loading="lazy"
        ...
        <p class="krim-portrait-subtitle">Princess, entrepreneur & patron of the arts, b. 1960 – Animal equivalent: Hippopotamus</p>
      </div>
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The self-preservation Two (SE2) is in the Enneagram tradition the subtype that directs the energy of the Two most directly toward its own existence and that of its inner circle. Naranjo called this subtype Me First: not egocentrism, but survival intelligence. The SE2 asks first: What do I need to endure? What does what belongs to me need to survive? It is the most concrete, grounded, least romanticizing of the three Two variants.</p>
          <p class="vb-intro">When Gloria von Thurn und Taxis became a widow at thirty in 1990, she took on a task that would have overwhelmed most experienced managers: restructuring one of the oldest aristocratic fortunes in Europe. She sold real estate, artwork, land and kept St. Emmeram Castle in Regensburg, the core of the family identity. No sentimentality, no shyness about tough decisions, no hedging. That is the SE2 in its clearest expression: It knows what is essential and protects it with a determination that often unsettles outsiders.</p>
          <p class="vb-intro">What is remarkable is that Gloria von Thurn und Taxis never spoke the language of management consulting. She spoke the language of responsibility. For the children, for the heritage, for the people who depend on this heritage. That is the SE2 perspective: Survival is not a selfish project it is the foundation on which everything else stands.</p>
        </blockquote>
        ...
        <h2 class="vb-section">4. The Passion: Pride as a Protective Shell</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The passion of the Two is called pride, and in its deepest form it is not arrogance, but a protective strategy: the belief that through one's own giving, achieving, and carrying, one is indispensable. The Two who is proud of what she does for others never has to ask whether she would also be loved without this achievement. The pride of the SE2w1 carries a special quality: It connects with a consciousness of status, dignity, and duty.</p>
          <p class="vb-intro">Gloria von Thurn und Taxis carries her inheritance not as a burden, but as a mandate. The Regensburg Castle Festival, which she turned into a cultural institution of rank; the art collection, which she carefully maintained; the public presence, which she never shied away from all of this is an expression of a pride that serves no vain self-dramatization, but rather the conviction: This heritage is worth preserving, and I am the one who preserves it.</p>
          <p class="vb-intro">The shadow of this pride, as with any Two, lies in the question that remains silent beneath it: What am I when I have nothing left to give? The SE2w1 answers this with even more action, even more posture, even more clarity. The hippopotamus builds its territory larger so that it never stands empty.</p>
        </blockquote>

        <h2 class="vb-section">5. The Transformation: From Excess to Matriarch</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Gloria von Thurn und Taxis's 1980s are well documented: the mohawk, the costume parties, the headlines. It would be easy to see a contradiction between that and the woman she is today. From an Enneagram perspective, there is none. The SE2 lives in extremes: It is fully present in the moment, fully in enjoyment when that is possible and fully in protection, fully in responsibility when that is required. The shift from Princess TNT to the matriarch of the House of Thurn und Taxis is not a rupture. It is the same character in a different life situation.</p>
          <p class="vb-intro">What changed is the water in which the hippopotamus swims. In the 1980s, the water was society, parties, the youth of the moment. After 1990, the water became the castle, the heritage, the family, the faith. The hippopotamus did not change. It remeasured its territory.</p>
        </blockquote>

        <h2 class="vb-section">6. The Gift: Steadfastness as a Cultural Force</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">What Gloria von Thurn und Taxis gave to the House of Thurn und Taxis and the city of Regensburg can be quantified and not quantified at the same time. Quantifiable is the restructuring of a crumbling heritage, the building of a functioning corporate structure, the establishment of a cultural festival of international renown. Unquantifiable is what lies behind it: the ability not to break under extreme pressure, but to grow.</p>
          <p class="vb-intro">That is the gift of the SE2w1: steadfastness that does not come at the expense of others. A hippopotamus holding its territory and within it creating space for culture, for family, for that which reaches beyond a single person. Gloria von Thurn und Taxis has proven that nobility is not a fate one inherits but a task one accepts or abandons daily anew. She accepted. The hippopotamus stands.</p>
        </blockquote>
...
export function helmutKohlPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function isaacNewtonPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function jenniferMatherPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
...
export function juditPolgarPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-judit-polgar-portrait.jpg" alt="Judit Polgár" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function klaraVonAssisiPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-klara-von-assisi-portrait.jpg" alt="Clare of Assisi" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function lenaUrzendowskyPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-lena-urzendowsky-portrait.jpg" alt="Lena Urzendowsky – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-sebastian-urzendowsky", label:"Portrait: Sebastian Urzendowsky (SE4w3) – her older brother"},
      ])}
    </div>
  `);
}

export function madelineStuartPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-madeline-stuart-portrait.jpg" alt="Madeline Stuart – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function marquisDeSadePortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-marquis-de-sade-portrait.jpg" alt="Marquis de Sade" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">What he was concretely accused of: in 1768 he lured the beggar woman Rose Keller to his house in Arcueil under a pretext, bound her, and whipped her &ndash; she escaped and pressed charges, the first major scandal that briefly landed him in prison. In 1772 came the so-called Marseille affair: Sade allegedly gave prostitutes candy laced with the irritant, potentially poisonous substance cantharidin (&bdquo;Spanish fly&ldquo;), and several women fell seriously ill; combined with a sodomy charge against his servant, he was sentenced to death in absentia and fled to Italy. Finally in 1777 his own mother-in-law had him imprisoned via a <em>lettre de cachet</em> &ndash; a royal warrant issued without any trial &ndash; at Vincennes and later the Bastille, where he spent more than a decade without ever being formally convicted.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">This rivalry cost him nearly his entire adult life: in total he spent around 32 years in prisons and the Charenton asylum &ndash; over the scandals described above, over his mother-in-law&#39;s complaint, later over his writings. The SX4 does not avoid conflict. It seeks it out, because only in resistance against the imposed order does the unadulterated self remain palpable.</p>
        </blockquote>
...
export function monicaSimpsonPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-monica-simpson-portrait.jpg" alt="Monica Simpson – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function nusratFatehAliKhanPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-nusrat-fateh-ali-khan-portrait.jpg" alt="Nusrat Fateh Ali Khan – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      ${relatedLinks([
        {route:"beruehmte-persoenlichkeiten", label:"All Famous Personalities"},
        {route:"subtype/se2", label:"SP2 – The Hippopotamus: Subtype Profile"},
        {route:"krankheitsportraets-nusrat-fateh-ali-khan", label:"Illness Portrait: Nusrat Fateh Ali Khan (SP2w3)"},
...
export function pythagorasPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-pythagoras-portrait.jpg" alt="Pythagoras" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function sadhguruPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-sadhguru-portrait.jpg" alt="Sadhguru – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">1. The Raccoon</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>Raccoon</strong> is the animal of the self-preservation Three &ndash; and at first sight it appears inconspicuous. No lion that roars. No peacock that shines. The raccoon wears a natural mask &ndash; not from intent to deceive, but because adaptability and quiet dexterity are its nature. It finds what it needs. It uses what is there. It overlooks nothing.</p>
...
export function stingPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-sting-portrait.jpg" alt="Sting" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>self-preservation One (SP1)</strong> does not carry its standards outward. It does not correct the world &ndash; it corrects itself, over and over, with a severity that others rarely see. Naranjo called this subtype <em>Worry</em> &ndash; concern. The SP1 asks itself: Is this really good enough? Have I done the right thing? Do I live up to my own standard?</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The healing path of the One leads from anger to serenity. The growing One learns: what is good does not need to be perfect in order to be good. The right thing reveals itself not only through control, but also through trust &ndash; trust in the flow that the Nine energy knows.</p>
          <p class="vb-intro">Sting has walked this path &ndash; not by abandoning his standards, but by discovering that beauty is greater than correctness. That an imperfect song that touches someone is worth more than a perfect one that reaches no one. The eagle does not always need to be on top. Sometimes it simply flies.</p>
        </blockquote>
...
export function tomKaulitzPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-tom-kaulitz-portrait.jpg" alt="Tom Kaulitz – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro" style="margin-top:1rem;">On December 5, 2026, Tom and Bill Kaulitz carried this pattern onto a new stage: together, they hosted, live from Halle (Saale), a one-off special edition of the German cult TV show <em>Wetten, dass..?</em> for public broadcaster ZDF &ndash; another visible achievement the twins approached the way they always do, as a pair. Both brothers made clear early on that this was a one-time event, not a permanent handover of the hosting role: they intend to keep focusing on their band and their own projects rather than committing long-term to a new format &ndash; itself an expression of the SP2w3's typical balance between visible appearances and holding onto one's own, familiar foundation.</p>
        </blockquote>
...
export function warrenBuffettPortraitPage() {
  return shell(`
    <div class="page-container">
      ${pageHeader("Famous Personalities")}
      <div id="js-back-target" data-route="beruehmte-persoenlichkeiten" style="display:none;"></div>
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-warren-buffett-portrait.jpg" alt="Warren Buffett" class="krim-portrait-img" loading="lazy" />
        </div>
        ...
        <p class="krim-portrait-subtitle">Investor, entrepreneur, b. 1930 – Animal equivalent: Owl</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. The Owl from Omaha</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The owl is the animal symbol of the Self-Preservation Type 5—a creature of silence, observation, and concentrated perception. It waits. It watches. It acts only when it has truly understood what it sees. And when it acts, it does so with a precision that others mistake for luck, but which requires decades of patient observation.</p>
          <p class="vb-intro">Warren Edward Buffett, born on August 30, 1930, in Omaha, Nebraska, is perhaps the most famous owl in economic history. The man the world calls the Oracle of Omaha has lived in the same modest house in Omaha since 1958. He drives himself. He eats breakfast at McDonald's. He reads, by his own account, around five hundred pages a day. And from this simplicity, he built one of the greatest fortunes in human history—not in spite of it, but because of it.</p>
        </blockquote>

        <h2 class="vb-section">2. The Self-Preservation Five: The Castle in Omaha</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">According to Naranjo, the Self-Preservation Five (SP5) is the subtype he named "Castle": one's own territory becomes a fortress. In Buffett's case, this castle is literal: his house on 5835 Farnam Street in Omaha, which he bought for $31,500 and never left. No penthouse in Manhattan. No estate in the Caribbean. The castle lies in Nebraska, and there it remains.</p>
          <p class="vb-intro">The passion of Type Five is avarice—not as mere stinginess, but as a deeply rooted structure: the fear that one's resources will not suffice, combined with a radical restraint in expending energy, time, and money. Buffett's frugality is legendary. He eats breakfast for $3.09 or $3.30, depending on the day's market mood—and he has shared that during downturns, he switches to the cheaper option. That is avarice at the highest level: even his own breakfast is calculated.</p>
          <p class="vb-intro">His investment strategy follows the same SP5 logic: spend nothing on what you do not fully understand. Buy only what you are prepared to hold forever. Do not waste capital—preserve it, let it grow, hoard it. Compound interest is the mathematical model of avarice: spend nothing, and what you hold doubles again and again. Buffett made this principle his philosophy of life.</p>
        </blockquote>

        <h2 class="vb-section">3. The Six Wing: Skepticism as an Investment Principle</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The Six wing (w6) imparts a characteristic flavor to the Self-Preservation Five: deep mistrust toward hype, speculation, and crowd euphoria—combined with strong loyalty toward what has proven true and solid. The Six wing always asks: Where is the risk? What can go wrong? What is the worst that could happen?</p>
          <p class="vb-intro">This perspective explains why Buffett consistently avoided the dot-com boom of the 1990s. As the world poured money into tech stocks, he stuck to what he understood: insurance, railways, consumer goods, banks. He was mocked for it—until the bubble burst. His famous dictum: Be fearful when others are greedy, and greedy when others are fearful. That is the Six wing in its most productive form: skepticism as protection against the herd.</p>
          <p class="vb-intro">The loyalty of the Six wing is evident in his decades-long partnership with Charlie Munger, which spanned over sixty years. Munger, who died in 2023 at the age of 99, was not just a business partner—he was the only person Buffett trusted completely. That is SP5w6: few genuine attachments, but those that exist endure for a lifetime.</p>
        </blockquote>

        <h2 class="vb-section">4. The Work: Five Hundred Pages and a Corporation</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Berkshire Hathaway, today one of the most valuable companies in the world, began as a struggling textile firm that Buffett took over in 1965. What he built from it is not a traditional conglomerate, but a reflection of his personality: a collection of solid, understandable businesses—Geico, BNSF Railway, See's Candies, stakes in Coca-Cola—designed for long-term value creation rather than quick returns. That is the SP5 castle as an economic structure: many chambers, all solidly built, no redundant windows.</p>
          <p class="vb-intro">The key to his success, Buffett himself says, is reading. Five hundred pages a day, for decades. Books, annual reports, newspapers, balance sheets. The SP5 does not just hoard money—it hoards knowledge. And from this hoarded knowledge grows, slowly and unspectacularly, an advantage that others mistake for genius. Buffett once put it this way: Knowledge builds up like compound interest. The owl reads until it truly understands.</p>
          <p class="vb-intro">His annual letter to Berkshire shareholders has been mandatory reading for investors worldwide for decades—not because of the numbers, but because of its clarity. Buffett writes as the owl sees: directly, without ornament, with a precision that needs no obfuscation.</p>
        </blockquote>

        <h2 class="vb-section">5. Light and Shadow: The Castle Where You Are Alone</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The light of the SP5w6 lies in its ability to penetrate complexity and expose the essence. Buffett did not merely make money—he founded a school of thought: Value Investing as an intellectual discipline, an attitude toward uncertainty, a philosophy of waiting. That is the gift of the owl: a gaze that sees past the noise of the present moment.</p>
          <p class="vb-intro">The fateful pattern of Type Five is avarice—and in Buffett, it appears not only in his relationship with money, but also with emotions and relationships. His first wife, Susan, lived apart from him in San Francisco for years while he remained in Omaha. His biographer Robert Hagstrom and others have described how difficult it was for Buffett to be truly present—emotionally available, rather than merely intellectually engaged. The castle protects. But it also isolates.</p>
          <p class="vb-intro">The Six wing can cause suspicion to tip into a general distrust of anything new. Buffett arrived late to Apple—only after long hesitation and after being convinced by Tim Cook. And he openly admitted to missing out on Amazon and Google as investment opportunities. Not because he did not understand them—but because the Six wing whispered: I don't trust this.</p>
        </blockquote>

        <h2 class="vb-section">6. The Owl That Gives</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The healing path of Type Five leads from the question "Do I have enough?" to the realization "Knowledge does not diminish when shared—it grows." In Buffett, this step looks like generosity—yet he remains an SP5 to the core.</p>
          <p class="vb-intro">In 2006, Buffett announced his intention to donate roughly 99 percent of his fortune—primarily to the Gates Foundation and his family foundations. Together with Bill Gates, he founded The Giving Pledge, a public commitment by the ultra-wealthy to donate their riches. Looking closer at how this is executed: Buffett transfers no cash, but Berkshire shares—stock he would not have sold anyway, as selling would trigger capital gains taxes. The foundations receiving these shares are managed by people close to him. The wealth changes names, not control. The avarice of the Self-Preservation Five never stops calculating, even when wearing the face of philanthropy.</p>
...
export function cleopatraPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-cleopatra-portrait.jpg" alt="Cleopatra" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function brigitteMacronPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/brigitte-macron-portrait.jpg" alt="Brigitte Macron – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">This shows an especially characteristic pattern of the relationship Three: personal success is not primarily sought for its own sake, but invested in the partner's success — their rise becomes almost more important than one's own. Brigitte became, in a sense, the engine on Macron's path to the presidency: she brought her decades of pedagogical experience, her social network, and her maturity as an older, seasoned woman directly into his career, rather than pursuing a public career of her own. This pattern — success as a shared project, in which the other's success becomes one's own fulfillment — also shows up in the SX3 outside romantic partnerships, for instance when parents make a child's career, or coaches a protégé's success, their own life's real project. One's own success is not unimportant in this, but it stays secondary to the triumph experienced vicariously.</p>
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">1. The Sloth Who Gave Up Medicine for the Stage</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>sloth</strong> rarely changes branches &ndash; but once it has settled, it stays there, sheltered from the bustle around it. Jürgen Drews, born 1945 in Nauen, began studying medicine after school, like his father before him, but gave it up after a few semesters in favor of music. In 1991 he met Ramona Middendorf, and in 1994 the two married &ndash; more than three decades later they still perform together on stage and at events.</p>
          <p class="vb-intro">This constancy runs through his entire life: rather than losing himself in shifting relationships or constant new artistic departures, he stayed with one woman, one genre, and &ndash; since the 1990s &ndash; one place that became his second home: Mallorca.</p>
        </blockquote>

        <h2 class="vb-section">2. The Sexual Nine: Merging With the Mallorca Crowd</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>Sexual Nine (SX9)</strong>, per Naranjo, does not seek the distance of the stage but complete absorption into the shared moment with the audience. In Drews this shows in the title "King of Mallorca," given to him by Thomas Gottschalk in 1999 on the show 'Wetten, dass..?' and confirmed in 2000 by the hit song of the same name: not a distant star, but someone who literally merged with the celebrating crowd on the island, summer after summer, decade after decade.</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">In the early 1970s Drews sang with the Les Humphries Singers before landing his biggest solo success to date in 1976 with 'Ein Bett im Kornfeld,' becoming a fixture on the ZDF Hitparade. An attempt to break into the US market in 1980/81 stayed modest &ndash; number 79 on the Billboard Hot 100 with "Don't Want Nobody."</p>
...
export function sebastianUrzendowskyPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-sebastian-urzendowsky-portrait.jpg" alt="Sebastian Urzendowsky – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
        ...
        <p class="krim-portrait-subtitle">Actor, born 1985 in Berlin &ndash; Animal equivalent: Dove</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. The Dove That Moved Through Five School Systems Without Loud Complaint</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>dove</strong> carries the upheaval of its childhood quietly, without dramatizing it outwardly. Sebastian Urzendowsky, born in 1985 in East Berlin, was six years old when his parents divorced. At fifteen he moved with his mother and her new partner to Lichterfelde, then spent a school year at a school in France and half a year at an English boarding school – each time the new student having to relearn the unwritten rules and group dynamics of an unfamiliar environment.</p>
          <p class="vb-intro">After finishing school he lived for a time in Spain and Switzerland before deciding, in 2006, to study acting at the Berlin University of the Arts – a restless, often-changing youth that he describes in interviews not as drama but matter-of-factly, as simply part of how he grew up.</p>
        </blockquote>

        <h2 class="vb-section">2. Self-Preservation Four: Quiet Roles Instead of Loud Appearances</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">According to Naranjo, the <strong>Self-Preservation Four (SE4)</strong> is the countertype of the Four: instead of putting one's own emotional depth on display, it is channeled into persistent, understated work. Urzendowsky became known for exactly these quiet, gripping roles – in "Der Turm," "The Counterfeiters," "Mitten in Deutschland: NSU," and "Babylon Berlin," he plays characters whose inner turmoil rarely shows through big gestures, but almost always through muted intensity.</p>
          <p class="vb-intro">He describes himself as a "family person" with a close bond to his relatives, despite his unsettled childhood. About his own parents' divorce he speaks matter-of-factly rather than accusingly: divorce has become far more accepted today, he says, and couples no longer stay together just for appearances.</p>
        </blockquote>

        <h2 class="vb-section">3. The Three Wing: Two Grimme Awards for the Same Quiet Precision</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>Three Wing</strong> gives the Self-Preservation Four a goal-directed drive that still translates its own restraint into measurable success. Urzendowsky received the Grimme Award twice for his performances – in 2013 for "Der Turm," in 2017 for "Die Täter – Heute ist nicht alle Tage" – two honors for exactly the quiet, unshowy roles he consistently chose over more spectacular offers.</p>
          <p class="vb-intro">He describes his own approach to historical figures as methodical rather than intuitive: research is essential, he says, though a film never depicts a real person one-to-one, but deliberately focuses on one aspect of a life – a decision made jointly by writer, director, and actor. This analytical preparation is a classic Three Wing addition to the Four: success is not left to chance, but structurally built.</p>
        </blockquote>

        <h2 class="vb-section">4. The Work: From Childhood Discovery to a Fixture of German Television</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Discovered as a child, Urzendowsky's cinematic breakthrough came with roles in "Lichter," "Pingpong," and the Oscar-winning drama "The Counterfeiters." Over the years he built a consistent presence in Germany's most demanding productions – a body of work that grows through the repetition of serious, unshowy roles rather than a single, loud breakthrough.</p>
        </blockquote>

        <h2 class="vb-section">5. Light and Shadow of the Self-Preservation Four with a Three Wing</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The light of the SE4w3 shows in Urzendowsky's ability not to suppress an unsettled, repeatedly interrupted childhood, but to turn it into a remarkably steady career, rewarded with two Grimme Awards – continuity as an answer to early upheaval.</p>
          <p class="vb-intro">The shadow of the Four shows in the tendency to minimize family ruptures rather than name them openly. His own line, "it takes a lot of courage to address problems openly," reads almost like a piece of self-disclosure about that exact challenge – an insight he articulates without necessarily living it out consistently himself.</p>
        </blockquote>

        <h2 class="vb-section">6. The Dove That Turned Every Move Into a Role</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Sebastian Urzendowsky's path shows the Self-Preservation Four with a Three Wing in a particularly steady form: a youth shaped by moves and separations, processed not through complaint but through two decades of quiet, repeatedly awarded acting work. The dove finds its course even when the landscape beneath it keeps changing.</p>
          ${bookTip("wer-du-wirklich-bist-band-1", "The nine types in depth &ndash; protective patterns, passions, and the path to essence.", "Who You Really Are &ndash; Volume 1")}
        ...
        ${relatedLinks([
          ...
          {route:"beruehmte-lena-urzendowsky", label:"Portrait: Lena Urzendowsky (SE2w1) – his sister"},
          {route:"beruehmte-nicolas-cage", label:"Portrait: Nicolas Cage (SE4w3) – also an actor, same subtype"},
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">This attitude reached into details no user would ever see – such as insisting that even the inside of circuit boards be arranged cleanly and aesthetically, though no one would ever open them. For the SO1, that isn't excessive perfectionism, but the consistent application of a moral standard to every detail of one's own work. A neat side note that goes beyond wordplay: modern circuit boards genuinely contain, in trace amounts, valuable metals such as palladium, platinum, and tantalum. And the One's homeopathic constitutional remedy happens to be Platinum metallicum, drawn from the precious metal platinum, which no acid can corrode – the same striving for untouchable purity that Jobs demanded even from the hidden inside of his boards, which literally carry a trace of the matching metal (a coincidence the German word "Platine," circuit board, makes even more fitting).</p>
        </blockquote>

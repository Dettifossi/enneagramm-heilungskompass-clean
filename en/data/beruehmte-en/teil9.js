    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Carl Gustav Jung was born in 1875 in Kesswil on Lake Constance, the son of a Swiss Reformed pastor. Even as a child he showed a pronounced inwardness and a strong interest in dreams, myths, and religious questions. From 1895 to 1900 he studied medicine at the University of Basel, with a particular interest in psychiatry – a field still held in low regard within medicine at the time, one most of his fellow students avoided. Immediately after graduating, in 1900, he took a position as an assistant physician at the Burghölzli clinic in Zurich under Eugen Bleuler, and in the following years, together with Franz Riklin, developed the word association test, which gave him his first empirical evidence for unconscious psychic content.</p>
...
export function albertEinsteinPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-albert-einstein-portrait.jpg" alt="Dr. Albert Einstein – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        <p class="vb-intro" style="text-align:center;font-style:italic;">
          A dedicated <a href="javascript:void(0)" data-route="krankheitsportraets-albert-einstein">Illness Portrait</a>
          covers Einstein's years-known abdominal aortic aneurysm and his deliberate decision against a further operation in 1955.
        </p>
      ...
      ${relatedLinks([
        {route:"beruehmte-persoenlichkeiten", label:"All famous personalities"},
        {route:"subtype/so5", label:"SO5 – The Octopus: Subtype Profile"},
        {route:"krankheitsportraets-albert-einstein", label:"Illness Portrait: Albert Einstein (SO5w4)"},
...
export function annikaVonMutiusPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-annika-von-mutius-portrait.jpg" alt="Dr. Annika von Mutius – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function carolinePetersPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-caroline-peters-portrait.jpg" alt="Caroline Peters – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function cynthiaMossPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-cynthia-moss-portrait.jpg" alt="Dr. Cynthia Moss – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function dirkRossmannPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-dirk-rossmann-portrait.jpg" alt="Dirk Rossmann – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The octopus is the animal of the social Type 5—a creature without a fixed center, operating with several arms at once, adapting to its surroundings while never quite being pinned down. Dirk Rossmann was born on September 7, 1946, in Hanover, the son of a second-generation drugstore owner who died when Dirk was twelve. That same year, the pattern already showed itself in concrete form: the twelve-year-old took orders from the neighbors every Thursday for drugstore goods from his mother's store, which she now ran alone, and delivered them by bicycle every Friday—ten percent cheaper than they would have cost in the store. A small system, self-built, that brought in several hundred marks a month, long before it became a company. At twenty-five, in 1972, he opened Germany's first self-service drugstore in Hanover on 120 square meters—located next to a funeral home, a detail he later commented on with dry humor.</p>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">The shadow of the Five is <strong>avarice</strong> – two sides of the same movement: holding on to what one already has, and quietly wanting more, because security gets defined through possession. For the SO5w6, this rarely shows as everyday stinginess – there, they tend to appear controlled and reserved – but rather as a quiet pull toward the prospect of additional security. It is precisely this hoarding pull that can draw an otherwise cautious Five into risks that contradict their own nature: the private stock market speculation that nearly drove Rossmann into ruin in 1996 wasn't a break from his avarice, but its flip side – the attempt to quickly accumulate still more security beyond the familiar frame of his own system (the drugstore business), in a field (financial markets) he didn't understand with the same depth.</p>
        </blockquote>
...
export function epikurPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-epikur-portrait.jpg" alt="Epicurus" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function guentherJauchPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-guenther-jauch-portrait.jpg" alt="G\xfcnther Jauch – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function jamesCordenPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-james-corden-portrait.jpg" alt="James Corden – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function joeNavarroPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-joe-navarro-portrait.jpg" alt="Joe Navarro – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function junkoTabeiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-junko-tabei-portrait.jpg" alt="Junko Tabei – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">That Tabei repeatedly founded her own groups and clubs might, at first glance, suggest a social rather than a self-preservation Seven – but that is not the case with her. Naranjo described the self-preservation Seven as the subtype that strikingly often builds tight, almost family-like clan structures (clan-building) around itself, in extreme cases even with mafia-like patterns of loyalty – not out of a social need for recognition as with the SO7, but because exactly this reliable, family-like group carries her own material and emotional security. The "Ladies Climbing Club" was not a public stage, but a protective, provisioning network in the SE7 sense – turned inward, not outward.</p>
        </blockquote>
...
export function konradAdenauerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-konrad-adenauer-portrait.jpg" alt="Konrad Adenauer – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        ...
        <p class="krim-portrait-subtitle">Psychologist, author, coach, b. 1988 – Animal equivalent: Chihuahua</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. The Chihuahua That Learned to Look</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The Chihuahua is the animal of the sexual Four: small in stature, vast in inner life, and equipped with an intensity that knows no middle ground. The Chihuahua loves deeply, feels sharper than most around it, and will not be intimidated—yet it is also sensitive, vulnerable, and dependent on connection like hardly any other animal. What it has built, it protects. What it has felt, it does not forget. And what it has once understood, it passes on.</p>
          <p class="vb-intro">The German Linda-Marlen Leinweber is a psychologist, author, coach, and founder of the online platform Poise, as well as one of the most prominent German voices in the field of mental health and prevention. Her path there led not through theory, but through personal experience: through years in which she stood speechlessly facing what her body and psyche were telling her. This biography is no footnote. It is the foundation.</p>
          <p class="vb-intro">What distinguishes Linda Leinweber from many other psychologists and coaches is this connection: she does not speak about pain from the outside. She speaks from an inner place that knows this pain and has learned to read it. That is SX4w5: depth that feels no shame. Insight that does not hide.</p>
        </blockquote>

        <h2 class="vb-section">2. The Sexual Four: Rivalry Against Trivialization</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The sexual Four (SX4) is, in the Enneagram tradition, the subtype that does not carry the pain of the Four inward, but turns it outward—as intensity, as craving, as fire. Naranjo called this subtype Rivalry: the burning conviction that others were given something withheld from oneself—and the drive to compete against it, to surpass, to prove oneself. In the SX4, this drive does not remain abstract. It directs itself at something concrete—at a person, a system, an injustice.</p>
          <p class="vb-intro">In Linda Leinweber, this energy sought out a clear opponent: the trivialization of psychological distress. The notion that anxiety and panic can be overcome if you just pull yourself together. The idea that burnout is a matter of discipline rather than the system. That prevention is a luxury rather than common sense. Against this attitude—which she experienced not least in herself during years with panic attacks and exhaustion—she directs her work like a counterweight.</p>
          <p class="vb-intro">Her own crisis was the turning point. Linda Leinweber was already working as a model and had studied psychology in Cologne and Berlin when she experienced firsthand what it means when the nervous system collapses: panic attacks, pressure, the feeling of sitting in a hamster wheel she had built herself. She didn't bury this experience. She made it the foundation of her entire professional trajectory. That is SX4: pain is not managed. It becomes the compass.</p>
        </blockquote>

        <h2 class="vb-section">3. The Five Wing: The Analyst Behind the Voice</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The Five wing (w5) brings something decisive to the sexual Four: the analytical lens, the hunger for understanding, the ability not only to feel one's own experience, but to penetrate it. The SX4 alone could get stuck in the intensity of its own feelings; the Five wing pulls it into observation, into theory, into craft. It says: feeling is not enough—you also have to understand.</p>
          <p class="vb-intro">Linda Leinweber's educational path bears this signature: psychology degree, systemic organizational consulting, certified coaching, hypnotherapy. That is not a collection of certificates—that is a Five wing moving from one tool to the next because no single one is sufficient. Hypnotherapy stands out in particular: it engages where classical talk therapy hits its limits—in the deep subconscious, in body memory, in patterns that cannot be dissolved by insight alone. Anyone taking this path thinks in depths.</p>
          <p class="vb-intro">The Five wing also manifests in Leinweber's publishing work. Her book Frei und trotzdem verbunden ("Free yet connected")—a title that itself contemplates a paradox—is dedicated to relationship dynamics, attachment patterns, and conflict resolution. This is no classic self-help book: no "10 steps to a better relationship," but an attempt to understand why people get stuck in the exact same patterns and what it takes to find a way out. That is SX4w5 in its best element: depth that serves others.</p>
        </blockquote>

        <h2 class="vb-section">4. Poise and the Vision of Prevention</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">With Poise, Linda Leinweber created a platform that anchors her approach institutionally: an interdisciplinary team of psychologists, psychotherapists, and coaches making psychological counseling and support accessible online. The name is chosen with intent—poise means balance, posture, inner stability. Not drama. Not spectacular healing. But: the measure that sustains. Digging a bit deeper reveals: the English word poise and the English word poison share the same root—the Old French poison originally meant drink, potion, poison. The name thus carries both within itself: balance and antidote. And when one knows that the unconscious SX4 can carry a certain toxic quality in its gaze—an intensity that burns, a rivalry that gnaws, a passion that flips—the platform name gains a second interpretation: Poise as a consciously chosen counter-image to one's own shadow. Balance as the answer to that which can derail.</p>
          <p class="vb-intro">The preventive approach is central here: Leinweber aims to reach people before the crisis hits. Before burnout arrives, before panic disorder establishes itself, before the relationship breaks apart. That is a deeply systemic thought, explaining why she is also active in corporate consulting: B2B workshops, mental health concepts for executives, structural prevention instead of individual firefighting. The Chihuahua that doesn't wait until the house is ablaze.</p>
          <p class="vb-intro">Through her Instagram channel (@psychologin_lindaleinweber) and her podcast Das Wunder Frau, she reaches a broad audience beyond the clinical setting. This commitment to destigmatization—the message that mental health is not a luxury topic, but a fundamental question of life—is her most consistent political stance. Not in parliament, but where attitudes are formed: in people's everyday lives.</p>
        </blockquote>

        <h2 class="vb-section">5. Light and Shadow: The Fire That Understands</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The core pattern of the Four is envy—the deep, often unconscious feeling that others were gifted a completeness missing in oneself. In the SX4, this envy wears a more personal face: not glancing at others' possessions, but the sting when someone else is allowed to effortlessly be what one finds so difficult to be. Light, free, unburdened. The SX4 knows the feeling of being heavier than others—and has found ways to work with it.</p>
          <p class="vb-intro">The light of the SX4w5 lies in its ability to render its own darkness productive—not as a performance, but as genuine service. Linda Leinweber doesn't help because she ought to. She helps because she knows what it feels like when nobody helped. This difference is palpable. People who help from personal experience pass something along differently than those who have merely learned how cognitively.</p>
          <p class="vb-intro">The shadow: the Five wing tends toward withdrawal, over-processing thoughts, holding back until everything is truly thought through. The SX4, on the other hand, presses for connection, for resonance, for immediate contact. This inner tension between analysis and expression, between depth and contact, is the most productive thing the SX4w5 combination generates. And at times, the most exhausting.</p>
        </blockquote>

        <h2 class="vb-section">6. The Chihuahua Showing Others the Way</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The healing path of the Four leads from the question "Why am I not like the others?" to the realization "What I am is unique, and it is mine." For the SX4w5, this means not tempering one's own intensity, but directing it—not against oneself, not against the world, but toward what is possible.</p>
          <p class="vb-intro">Linda Leinweber walked this path in her biography. From experiencing panic attacks herself to a grounded education, from education to the platform, from the platform to a public voice for mental health. That is no self-optimization project. That is a Four that learned not to hide her inner world, but to carry it—and transformed that carrying into a craft that serves others.</p>
          <p class="vb-intro">The Chihuahua from Altmünster on Lake Traunsee is not afraid of big feelings. It learned to read them. That is the sexual Four with a Five wing. That is Linda Leinweber.</p>
        </blockquote>
...
export function mariacarlaBosconoPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-mariacarla-boscono-portrait.jpg" alt="Mariacarla Boscono – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function melanieKreisPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-melanie-kreis-portrait.jpg" alt="Melanie Kreis – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">The German executive Melanie Kreis is CFO of DHL Group—one of the largest logistics corporations in the world. She is responsible for the finances of a DAX company with billions in revenue and employees in over 220 countries. And yet: when journalists describe her, the word ego is rarely dropped. She is described as reliable, precise, analytical, and as someone who works for the corporation, not for her own appearance. That is the meerkat: it keeps watch. Not for itself. For the group.</p>
        </blockquote>
...
export function scarlettJohanssonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-scarlett-johansson-portrait.jpg" alt="Scarlett Johansson – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function taylorSwiftPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-taylor-swift-portrait.jpg" alt="Taylor Swift – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function udoJuergensPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-udo-juergens-portrait.jpg" alt="Udo Jürgens – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">6. A Dissenting View: Claudio Naranjo and the Self-Preservation Nine</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Claudio Naranjo, one of the most influential Enneagram teachers and the teacher of this app's author, classified Churchill differently in his book project on Type 9 (“E9 Book – Psychospiritual Laziness”), as a <strong>Self-Preservation Nine with an Eight-wing (SE9w8)</strong>. His argument: Churchill's massive physical presence, his lifelong “appetite” (cigars, alcohol, lavish food) and his seemingly restless activity &ndash; painting, hours of bricklaying at Chartwell, writing monumental memoirs &ndash; were in truth a Nine's distraction manoeuvres, avoiding confrontation with his own inner emptiness and the “Black Dog.” The hardness commonly read as an Eight trait was, in Naranjo's view, more a stoic, conservative force defending a fragile inner status quo &ndash; not a fight born of relish for confrontation, but a fight for a “safe harbour.”</p>
          <p class="vb-intro">This view was deliberately weighed here rather than accepted or dismissed without examination &ndash; but ultimately it does not convince. Naranjo's own distinguishing criterion provides the strongest counterargument: a Nine fights to preserve an existing, safe state; an Eight fights to assert a position, even against everyone's resistance. Churchill's defining act &ndash; his years-long, isolated resistance to Chamberlain's policy of appeasement in the 1930s &ndash; was precisely not a defence of the status quo, but a deliberate break with it: against his own party, against the more comfortable, safer path of a negotiated settlement with Hitler. By Naranjo's own definition, that is Eight behaviour, not Nine behaviour. The cited activities, too, look on closer inspection less like Nine-like dispersal than like Eight-like channelling of surplus force into a new arena of mastery once the political one was closed off &ndash; he built large parts of the Chartwell walls with his own hands, with the same imperial meticulousness as his politics. And in the film and audio records of his speeches, his gestures and expressions &ndash; direct, confrontational, impatient &ndash; read far more as Eight than as Nine.</p>
          <p class="vb-intro">In general, distinguishing SE8w9 from SE9w8 is one of the most demanding calls in the entire Enneagram typology &ndash; both subtypes can appear calm, patient and stubborn at once, and behavioural evidence alone is often not enough to separate them reliably. With living people, what helps most is a skill that cannot be learned in a weekend but only over months of dedicated practice: precise analysis of <strong>gaze quality</strong>. Is the gaze directed outward, confrontational, probing, ready to resist &ndash; the typical “orangutan gaze” of the Eight? Or is it turned inward, heavy, sluggish and self-forgetting &ndash; the resting “elephant gaze” of the Nine? This discernment is part of the advanced typing training taught, among others, by David L. Rathmer, and is considered one of the subtlest yet most reliable diagnostic methods, because the gaze often reveals a person's intrinsic motivation and passion more directly than outward behaviour does. Applied to Churchill himself, based on available film and photographic material of his speeches, this gaze analysis confirms the outward-directed, confrontational Eight gaze &ndash; a further, independent argument for SE8w9.</p>
        </blockquote>

        <h2 class="vb-section">7. The Orangutan That Would Not Let Go of the Branch</h2>
        <blockquote class="vb-blockquote">
...
export function huangYongPingPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-huang-yong-ping-portrait.jpg" alt="Huang Yong Ping – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function edvardMunchPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/edvard-munch-portrait.jpg" alt="Edvard Munch – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">The armadillo that did not hide its shell of fear and illness, but made it the most visible feature of its entire body of work, and that in the end left its whole life's work to the community it had remained both distant from and attached to throughout its life — that is the lasting image of the social Four with a Five-wing.</p>
        </blockquote>
...
export function irisBerbenPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-iris-berben-portrait.jpg" alt="Iris Berben – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
...
export function zoeKravitzPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="https://pub-2851309644cc48aea2a2ae780b41b196.r2.dev/assets/portraits/beruehmte-zoe-kravitz-portrait.jpg" alt="Zoë Kravitz – Portrait" class="krim-portrait-img" loading="lazy" />
        </div>
        <p class="krim-portrait-name">Zoë Kravitz</p>
        <p class="krim-portrait-typ">SO3w2 &middot; Social Type 3 with Two-wing</p>
        <p class="krim-portrait-subtitle">Actress and musician, born 1988 &ndash; Animal correspondence: Cheetah</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. The Cheetah Who Sought Recognition on Every Terrain</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>cheetah</strong> doesn't hunt indiscriminately – it chooses precisely the terrain where its speed shows to best advantage. Zoë Kravitz, born 1988 in Venice, California, the only child of Lisa Bonet and Lenny Kravitz, built not just an acting career over the years but conquered several respected terrains one after another: music with the bands Elevator Fight and Lolawolf, then in 2024, directing with 'Blink Twice' – a debut critics called "bold and memorable," one that thrust her "into the turf of directors to watch."</p>
          <p class="vb-intro">This versatility is no accident, but a pattern: success is meant to become visible not just in one field, but across several recognized ones at once.</p>
        </blockquote>

        <h2 class="vb-section">2. The Social Three: Recognition Through Comparison, Not the Solo Act</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>Social Three (SO3)</strong>, per Naranjo, seeks prestige and success within a group or shared standard of comparison – vanity as a constant measuring of oneself against a shared ideal, not the immediate impact of a single moment. In Kravitz, the shadow side of this pattern shows as early as age thirteen: she developed an eating disorder from continually comparing herself to models and women in magazines – a socially mediated beauty ideal she measured herself against, not a spontaneous, immediate impulse.</p>
          <p class="vb-intro">She later made this experience public: "You could see my rib cage." Rather than staying silent, she has repeatedly spoken openly about body image and eating disorders in the entertainment industry – transforming her own wound of social comparison into a cause meant to help other women.</p>
        </blockquote>

        <h2 class="vb-section">3. The Two-wing: Care as the Drive Behind the Ambition</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The <strong>Two-wing</strong> gives the social Three an attentive, supportive note, showing in Kravitz through her advocacy for body positivity, mental health, and diversity in Hollywood. She doesn't limit herself to being successful; she visibly works to help others – especially young women with similar experiences – feel less alone.</p>
          <p class="vb-intro">This warmth carries into her private life too: after her parents' divorce in 1993, she stayed closely bonded with both of them, growing up between Miami and New York, between mother and father – and today the entire, multiply blended family around Lisa Bonet, Jason Momoa, and Lenny Kravitz maintains a notably warm relationship with one another, one Zoë herself actively sustains.</p>
        </blockquote>

        <h2 class="vb-section">4. The Work: From Supporting Role to Her Own Direction</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">After early roles in 'X-Men: First Class' and the 'Divergent' series, Kravitz established herself as a versatile, serious actress with 'Mad Max: Fury Road,' 'Big Little Lies,' and 'High Fidelity' (which earned her a Black Reel Award), before taking on one of her biggest roles yet as Catwoman in 'The Batman' in 2022.</p>
          <p class="vb-intro">With 'Blink Twice,' she finally expanded her terrain to directing in 2024 – a step showing how consistently she refused to confine her status to a single field, instead seeking recognition simultaneously across several highly regarded disciplines.</p>
        </blockquote>

        <h2 class="vb-section">5. Light and Shadow of the Social Three with Two-wing</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">The light of the SO3w2 shows in Kravitz in the ability to turn her own, very personal struggle with societal beauty ideals into a public, warmhearted message that genuinely helps others, rather than hiding her own vulnerability.</p>
          <p class="vb-intro">The shadow of the Three shows in the early, almost compulsive spiral of self-comparison that led to her eating disorder – a pattern that emerges when one's own worth becomes too tightly bound to an externally set, shared ideal rather than an inner measure.</p>
        </blockquote>

        <h2 class="vb-section">6. The Actress Who Proved Herself Again and Again</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Zoë Kravitz's path shows the social Three with Two-wing in a particularly versatile form: recognition was never sought in just one field, but across acting, music, and directing – accompanied by genuine care for others, born out of her own, publicly shared vulnerability. The cheetah changes terrain, but it never stops running.</p>
          ${bookTip("wer-du-wirklich-bist-band-1", "The nine types in their depth – defense patterns, passions, and the path to essence.", "Wer du wirklich bist – Band 1")}
          ${bookTip("die-verborgene-dynamik-der-27-subtypen", "27 subtypes: passions, defense strategies, and healing paths from therapeutic practice.", "Die verborgene Dynamik der 27 Subtypes")}
          ${bookTip("die-27-persoenlichkeiten-des-enneagramms", "27 character profiles in comparison – how the subtypes of the same type differ from one another.", "Die 27 Persönlichkeiten des Enneagramms")}
        </blockquote>
        ...
        ${relatedLinks([
          ...
          {route:"beruehmte-lenny-kravitz", label:"Portrait: Lenny Kravitz (SX3w2) – her father"},

...
function lucyCookePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-lucy-cooke-portrait.jpg" alt="Lucy Cooke – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>sexuelle Neun (SX9)</strong> sucht die Verschmelzung in ihrer intensivsten Form &ndash; mit einem einzigen Wesen, einem Ideal, oder, wie bei Cooke, mit einem einzigen, oft missverstandenen Tier. Sie gründete die Sloth Appreciation Society, schrieb gleich mehrere Bücher ausschließlich über Faultiere (<em>A Little Book of Sloth</em>, deutsch: »Ein kleines Buch über Faultiere«; <em>The Power of Sloth</em>, deutsch: »Die Kraft des Faultiers«; <em>Life in the Sloth Lane</em>, deutsch: »Leben auf der Faultierspur«) und produzierte virale Faultier-Videos samt eigenem Kalender. Kein Nebenprojekt unter vielen &ndash; das Faultier ist der rote Faden ihres gesamten Lebenswerks.</p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Das ist kein impulsiver Bruch, sondern ein kalkulierter, mutiger Kampf um die eine Bindung, die zählte &ndash; getragen von einer Kraft, die unter der zerbrechlichen Fassade der chronisch kranken Dichterin lag. Später, in Italien, setzte sich dieselbe Härte fort: In <em>Casa Guidi Windows</em> (1851, deutsch: »Die Fenster von Casa Guidi«) und dem noch schärferen <em>Poems Before Congress</em> (1860, deutsch: »Gedichte vor dem Kongress«) bezog sie unverblümt politisch Stellung für die italienische Unabhängigkeit &ndash; und in <em>The Cry of the Children</em> (1843, deutsch: »Der Schrei der Kinder«) prangerte sie die Kinderarbeit in britischen Fabriken und Bergwerken mit einer Direktheit an, die Teile der Öffentlichkeit empörte. Kein Rückzug ins Private, sondern ein Kämpfen mit der Feder, wo der Körper längst keine anderen Waffen mehr hatte.</p>
        </blockquote>
...
function janeGoodallPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-jane-goodall-portrait.jpg" alt="Dr. Jane Goodall – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function craigFosterPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-craig-foster-portrait.jpg" alt="Craig Foster – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function anaSalcedaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-ana-salceda-portrait.jpg" alt="Ana Salceda – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Diese Sprache &ndash; Stille, Verschmelzung, das Eintauchen ins Innere statt distanzierte Beobachtung &ndash; ist fast wortgleich mit dem, was auch Craig Foster (SX9w1) \xfcber seinen Oktopus oder Jane Goodall (SX9w1) \xfcber ihren ersten vertrauten Schimpansen David Greybeard sagten. Nicht die Art, sondern das eine, individuelle Wesen steht im Zentrum &ndash; das ist die sexuelle, nicht die soziale oder selbsterhaltende Instinktvariante.</p>
        </blockquote>
...
function jamesLevinePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-james-levine-portrait.jpg" alt="James Levine – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Einserfl\xfcgel</strong> verleiht der selbsterhaltenden Neun eine Qualität, die einen SE9er mit schwach ausgeprägtem Einserflügel ergänzt: Pr\xe4zision, Strenge und einen inneren Ma\u00dfstab, der keine Abk\xfcrzungen akzeptiert. Die SE9w8 sucht die Macht. Die <strong>SE9w1</strong> sucht die Richtigkeit &ndash; im Detail, im Klang, in der Reinheit des Ausdrucks.</p>
...
function ludwigErhardPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-ludwig-erhard-portrait.jpg" alt="Ludwig Erhard – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">5. Licht und Schatten</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SE9w1 ist ihre <strong>F\u00e4higkeit, aus prinzipientreuer Geduld dauerhafte Strukturen zu schaffen</strong>. Erhards Soziale Marktwirtschaft pr\u00e4gt die deutsche Wirtschaftsordnung bis auf den heutigen Tag &ndash; ein Erbe, das weit \u00fcber seine eigene Amtszeit hinausreicht, gerade weil es nicht auf spektakul\u00e4re Einzelentscheidungen, sondern auf ein stabiles, in sich stimmiges System gebaut war.</p>
...
function herbertGroenomeyerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-herbert-groenemeyer-portrait.jpg" alt="Herbert Gr\u00f6nemeyer – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function jamesCordenPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-james-corden-portrait.jpg" alt="James Corden – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function donataHopfenPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-donata-hopfen-portrait.jpg" alt="Donata Hopfen – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der Schatten der SO6w7 liegt in der Geschwindigkeit. Wo Melanie Kreis (SO6w5) mit dem F\xfcnferfl\xfcgel bremst, gr\xfcndlich pr\xfcft und erst dann handelt, kann die SO6w7 zu fr\xfch loslaufen &ndash; bevor die Gruppe wirklich bereit ist mitzugehen. Der Siebenerfl\xfcgel erzeugt Tempo und Begeisterung, aber Begeisterung allein baut noch keine Br\xfccke zwischen einer Vision und den \xc4ngsten der Menschen, die dieser Vision folgen sollen. Die DFL-Episode zeigt dieses Muster pur: Der Aufbruch war real, die Notwendigkeit war real &ndash; aber die Gruppe war noch nicht dort, wo die Vision schon war.</p>
          <p class="vb-intro">F\xfcr die SO6 ist das die tiefste Wunde: Als Mitglied der Gemeinschaft ausgesto\u00dfen zu werden von genau jener Gemeinschaft, f\xfcr die man angetreten ist. Hopfen hat diese Erfahrung \xf6ffentlich gemacht. Und ist danach nicht verschwunden. Das ist der Unterschied zwischen dem SO6-Schatten und der SO6-Reife: Die reife Sechs wei\xdf, dass Zugeh\xf6rigkeit nicht an einer einzigen Gruppe h\xe4ngt.</p>
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">4. Hume und der Schock des dogmatischen Schlummers</h2>
        <blockquote class="vb-blockquote">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Das erkl\u00e4rt auch, warum die Verwechslung mit der Eins in die Irre f\u00fchrt: Die Angeh\u00f6rigen der Kopftriade (Typ 5, Typ 6, Typ 7) tragen ein Vertrauensdefizit in sich, das sie vor allem durch Denk- und Verstandesenergie zu kompensieren suchen \u2013 durch Analyse, Systembildung, das gedankliche Absichern gegen Unsicherheit. Bei Kant liegt der Schwerpunkt seines gesamten Einsatzes klar auf dieser Verstandesenergie. Die Angeh\u00f6rigen der Bauchtriade (Typ 8, Typ 9, Typ 1) tragen dagegen ein Schutzdefizit, das beim Typ 1 insbesondere \u00fcber Aggressionsenergie kompensiert wird \u2013 \u00fcber den moralisch-emp\u00f6rten Impuls, sich und andere gegen tats\u00e4chliche oder bef\u00fcrchtete Angriffe von au\u00dfen zu wappnen. Kants Werk zeigt genau diese zweite Energie nicht: kein Zorn \u00fcber Fehlverhalten, keine gegen die Welt gerichtete Korrekturbewegung, sondern die stille, systematische Absicherung des eigenen Denkens gegen die Unsicherheit, die Hume aufgerissen hatte.</p>
        </blockquote>

        <h2 class="vb-section">6. Verm\u00e4chtnis: Der K\u00f6nigsberger, an dem sich die Moderne rieb</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Kant starb 1804 in K\u00f6nigsberg, ohne, wie bereits zuvor erw\u00e4hnt, die Stadt je auf Dauer verlassen zu haben. Sein Werk aber reiste weit \u00fcber seine eigenen Lebensgrenzen hinaus: Friedrich Nietzsche (SX5w4), fast ein Jahrhundert sp\u00e4ter geboren, griff Kants Pflichtethik scharf an \u2013 er nannte ihn einmal sp\u00f6ttisch den "chinesischen" Denker von K\u00f6nigsberg und warf dem kategorischen Imperativ vor, das Leben einem abstrakten Gesetz zu opfern, statt es zu bejahen. Diese Auseinandersetzung, obwohl nie pers\u00f6nlich, wurde zu einer der pr\u00e4gendsten philosophischen Konfrontationen der Moderne \u2013 das Erdm\u00e4nnchen der Pflicht gegen den einsamen K\u00e4mpfer der Lebensbejahung.</p>
...
function andyReidPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-andy-reid-portrait.jpg" alt="Andy Reid – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>F\u00fcnferfl\u00fcgel (w5)</strong> bringt der sozialen Sechs analytische Tiefe und die \u00dcberzeugung, dass Vorbereitung der beste Schutz vor der Angst ist. Wo eine SO6 mit schwächerem Fünferflügel Sicherheit durch Zugehörigkeit sucht, fügt ein stark ausgeprägter Fünferflügel eine zweite Schicht hinzu: das Verstehen als Fundament des Vertrauens. Man kann nur verl\u00e4sslich f\u00fcr die Gruppe da sein, wenn man das System bis ins letzte Detail durchdrungen hat.</p>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Wenige Wochen sp\u00e4ter \u00fcbernahm Reid die Kansas City Chiefs &ndash; ein Franchise, das seit Jahrzehnten ohne Super-Bowl-Titel geblieben war. Er baute erneut auf, Schritt f\u00fcr Schritt, Jahr f\u00fcr Jahr, bis das System stand: 2020, 2023 und 2024 gewann er mit den Chiefs den Super Bowl. Kein spektakul\u00e4rer Neuanfang, sondern dieselbe beharrliche Struktur-Arbeit wie zuvor &ndash; nur in einer neuen Umgebung, mit derselben unersch\u00fctterlichen Best\u00e4ndigkeit.</p>
...
function melanieKreisPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-melanie-kreis-portrait.jpg" alt="Melanie Kreis – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">1. Das Kaninchen</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das <strong>Kaninchen</strong> ist wachsam, loyal und sucht Sicherheit in dem, was es kennt. Es ist kein Tier der gro\xdfen Geste. Es lebt im Vertrauten, baut sein Revier sorgf\xe4ltig aus &ndash; und wenn die Situation es verlangt, zeigt es eine Entschlossenheit, die man von au\xdfen nicht erwartet h\xe4tte. Das Kaninchen \xfcberlebt nicht durch Kraft, sondern durch Klugheit, Verl\xe4sslichkeit und das Vertrauen seiner Gruppe.</p>
          <p class="vb-intro">Der US-amerikanische Astronaut Neil Armstrong war der erste Mensch, der den Mond betreten hat. Am 20. Juli 1969, um 02:56 Uhr UTC, setzte er seinen linken Fu\xdf auf die Mondoberfl\xe4che und sprach einen Satz, den die Welt nach wie vor kennt. Danach tat er alles, um wieder in der Stille zu verschwinden. Er gab kaum Interviews. Er floh vor der \xd6ffentlichkeit. Er kehrte nach Ohio zur\xfcck, auf seinen Bauernhof, und lebte dort so unauff\xe4llig, als h\xe4tte er nur einen kurzen Ausflug gemacht &ndash; zum Mond und zur\xfcck. Das ist das Kaninchen: Der au\xdferordentlichste Mensch, der je seinen Fu\xdfabdruck im Staub hinterlie\xdf &ndash; und der danach nichts sehnlicher wollte als Normalit\xe4t.</p>
        </blockquote>
...
function herbertKicklPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-herbert-kickl-portrait.jpg" alt="Herbert Kickl – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Malaika Mihambo lebt und trainiert bis in die Gegenwart mit demselben Team, das sie seit Jahren begleitet. Das ist die selbsterhaltende Sechs mit F\u00fcnferfl\u00fcgel: Wachheit, die zur Methode wurde &ndash; und ein Vertrauen, das sich niemand ohne Vorbereitung erarbeitet.</p>
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">5. Licht und Schatten</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SX6w5 zeigt sich in der schieren Ausdauer, mit der Platon aus einer traumatischen Erfahrung ein vollständiges philosophisches System schuf, das bis auf den heutigen Tag die Grundfragen von Erkenntnistheorie, Ethik und Politik prägt. Der britische Philosoph Alfred North Whitehead bemerkte im 20. Jahrhundert, die gesamte europäische Philosophietradition bestehe im Grunde nur aus "einer Reihe von Fußnoten zu Platon" – eine Übertreibung, die dennoch den Kern trifft.</p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Geboren 1797 im Wiener Vorort Himmelpfortgrund als Sohn eines Schuldirektors, eines von über zwanzig Kindern, von denen die meisten früh starben, wuchs der österreichische Komponist Schubert in bescheidenen, aber musikalisch geprägten Verhältnissen auf. Seine außergewöhnliche Begabung fiel schon als Chorknabe der Wiener Hofkapelle auf – doch anders als das selbstbewusste Auftreten eines Beethoven (SX6w5) suchte der junge Schubert nie die Konfrontation mit der musikalischen Öffentlichkeit, sondern das stille, beharrliche Komponieren im Hintergrund.</p>
        </blockquote>
...
function sundarPichaiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-sundar-pichai-portrait.jpg" alt="Sundar Pichai – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function markZuckerbergPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-mark-zuckerberg-portrait.jpg" alt="Mark Zuckerberg – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Jodie Foster hat diesen Weg auf ihre Weise beschritten: Sie hat sich nie der \u00d6ffentlichkeit ausgeliefert, aber sie hat sich den wenigen Menschen, die ihr Vertrauen verdienten, \u00fcber Jahrzehnte hinweg wirklich gezeigt. Das ist kein Widerspruch, sondern die unverfälschteste Form der Auspr\u00e4gung einer SX5w6: Der Igel, der sich niemandem zeigt, der ihn nicht verdient &ndash; und der sich dem, der ihn verdient, ganz zeigt.</p>
...
function taylorSwiftPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-taylor-swift-portrait.jpg" alt="Taylor Swift – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function fredericChopinPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-frederic-chopin-portrait.jpg" alt="Fr&eacute;d&eacute;ric Chopin – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Fr&eacute;d&eacute;ric Chopin lebte neununddrei\u00dfig Jahre &ndash; und in dieser Zeit komponierte er ein Werk, das noch heute so klingt wie kein anderes: als \xf6ffne sich jemand vollst\xe4ndig, aber nur am Klavier. In Salons, nicht in Konzerts\xe4len. F\xfcr wenige, nicht f\xfcr viele. Er gab in seinem gesamten Leben kaum drei\u00dfig \xf6ffentliche Konzerte. Den Rest der Zeit arbeitete er, liebte er &ndash; und schrieb Musik, die mehr von ihm preisgab, als er jemals h\xe4tte in Worte fassen k\xf6nnen.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Chopins gr\u00f6\u00dfte Liebe war <strong>George Sand</strong>, die Schriftstellerin, die b\xfcrgerlich Aurore Dudevant hie\u00df. Sie begegneten sich 1836 in Paris. Zwei Jahre sp\xe4ter, im Winter 1838/39, reisten sie gemeinsam nach Mallorca &ndash; Chopin krank, das Klima rau, die Unterkunft karg. Er komponierte dort die <em>Pr\xe4ludien op. 28</em>, eines seiner dichtesten Werke. Die Isolation des Winters, die N\xe4he zu George Sand, die Todesn\xe4he der Tuberkulose &ndash; all das ist in diesen Miniaturen.</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Viererfl\xfcgel (w4)</strong> bringt der sexuellen F\xfcnf etwas Entscheidendes hinzu: den Schmerz des Verlusts als k\xfcnstlerischen Antrieb. Eine SX5 mit schwach ausgeprägtem Viererflügel würde sich vielleicht verschließen. Ein stark ausgeprägter Viererflügel macht aus dieser Verschlossenheit Kunst &ndash; er verwandelt das Unausgesprochene in Form, den Schmerz in Klang.</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro"><em>Pianissimo</em> &ndash; in der Musik die Anweisung, so leise wie m\u00f6glich zu spielen &ndash; ist weit mehr als eine Lautst\xe4rkeangabe. Es ist eine Haltung. Es ist die Entscheidung, nicht zu dr\xe4ngen, nicht zu \xfcberw\xe4ltigen, sondern den H\xf6rer in die Stille hineinzuziehen. Im Pianissimo entsteht Spannung nicht durch Lautst\xe4rke, sondern durch Zur\xfcckhaltung. Das Ungesagte, das Subtile, das Z\u00f6gern zwischen zwei T\xf6nen &ndash; all das wird h\xf6rbar, weil der L\xe4rm fehlt. Und wer wirklich zuh\xf6rt, merkt: Diese leisen Stellen sind die intensivsten. Das radikalste Entschleunigen ist gleichzeitig das Aufmerksamste.</p>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Es gibt kaum ein treffenderes Bild f\xfcr den SX5w4er: Der K\xf6rper bleibt im Exil. Das Herz kehrt heim. Was er niemals als Mensch zur\xfcckgeben konnte &ndash; die R\xfcckkehr nach Polen, die Ber\xfchrung des Bodens, auf dem er Kind war &ndash; das schenkte er sich im Tod.</p>
      ...
      ${bookTip("die-verborgene-dynamik-der-27-subtypen", "27 Subtypen: Leidenschaften, Schutzstrategien und Heilungswege aus der therapeutischen Praxis.", "Die verborgene Dynamik der 27 Subtypen")}
      ${bookTip("die-27-persoenlichkeiten-des-enneagramms", "27 Charakterprofile im Vergleich \u2013 wie sich die Subtypen desselben Typs voneinander unterscheiden.", "Die 27 Pers\u00f6nlichkeiten des Enneagramms")}
      <p class="vb-intro">Die Tuberkulose, die ihn vermutlich schon als jungen Mann begleitete und sich nach der Trennung von George Sand 1847 dramatisch beschleunigte, wird ausführlich im eigenen <a href="javascript:void(0)" data-route="krankheitsportraets-frederic-chopin">Krankheitsporträt zu Chopin</a> gedeutet.</p>
      ${relatedLinks([
        {route:"beruehmte-persoenlichkeiten", label:"Alle ber\xfchmten Pers\xf6nlichkeiten"},
        {route:"krankheitsportraets-frederic-chopin", label:"Krankheitsporträt: Frédéric Chopin (SX5w4)"},
        {route:"subtype/sx5", label:"SX5 \u2013 Der Igel: Subtyp-Profil"},
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Viererfl\u00fcgel (w4)</strong> bringt der sexuellen F\u00fcnf etwas Entscheidendes hinzu: den Schmerz des Verlusts als k\u00fcnstlerischen und sprachlichen Antrieb. Eine SX5 mit schwach ausgeprägtem Viererflügel würde sich vielleicht nur verschließen. Ein stark ausgeprägter Viererflügel macht aus dieser Verschlossenheit Ausdruck &ndash; verwandelt das Unausgesprochene in eine Sprache von unerh\u00f6rter Intensit\u00e4t.</p>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Das ist die SX5w4 in ihrer klarsten Ausprägung: Der R\u00fcckzug ist kein Mangel, sondern die Voraussetzung. Nur im fast vollst\u00e4ndigen Alleinsein, ohne akademische Anstellung, ohne feste Bindung, \u00f6ffnete sich der eine Kanal, durch den alles str\u00f6mte, was in ihm war.</p>
        </blockquote>

        <h2 class="vb-section">5. Licht und Schatten: Klarheit und Zusammenbruch</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SX5w4 ist die F\u00e4higkeit zur <strong>radikalen Selbstoffenbarung im eigenen Medium</strong> &ndash; Nietzsche hat in seinen B\u00fcchern mehr von sich preisgegeben als die meisten Menschen einem einzigen Vertrauten. Seine Sprache besitzt eine Intensit\u00e4t, die auch heute noch kaum ein Philosoph erreicht hat, gerade weil sie aus einem Menschen kam, der im Alltag fast v\u00f6llig allein war.</p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Swintons k\xfcnstlerisches Leben ist von genau diesem Muster gepr\xe4gt: Sie arbeitet seit Jahrzehnten in engen, wiederkehrenden Kreisen &ndash; mit dem Regisseur Derek Jarman, der sie in den 1980er Jahren entdeckte und mit dem sie bis zu seinem Tod 1994 acht Filme drehte; sp\xe4ter mit Wes Anderson, mit Luca Guadagnino, mit den Coen-Br\xfcdern. Sie wechselt nicht st\xe4ndig das Umfeld &ndash; sie vertieft wenige Verbindungen \xfcber Jahrzehnte. Das ist die SX5: nicht die Breite des Kontakts, sondern die Tiefe der wenigen, denen man sich wirklich anvertraut.</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Viererfl\xfcgel (w4)</strong> bringt der sexuellen F\xfcnf ein Bed\xfcrfnis nach dem Einzigartigen, dem Unverwechselbaren, dem, was jenseits der Konvention liegt. Eine SX5 mit schwach ausgeprägtem Viererflügel würde vielleicht ihre wenigen Verbindungen pflegen und sich sonst zurückziehen. Ein stark ausgeprägter Viererflügel fügt hinzu: <em>Ich will nicht nur beobachten &ndash; ich will die Form finden, die genau das ausdr\xfcckt, was sonst niemand sieht.</em></p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Naranjo war musisch veranlagt auf eine Weise, die viele \u00fcberraschte. Er komponierte, er liebte Musik als Weg zur Seele &ndash; nicht als Hintergrundkulisse, sondern als Erkenntnisquelle. Diesen Zug hat der Viererfl\u00fcgel: das Gef\u00fchl, dass bestimmte Wahrheiten sich nicht rein sprachlich ausdr\u00fccken lassen, sondern nur in der Form, im Klang, im Bild. Sein Werk hat diese Tiefe &ndash; es ist nicht nur Systematik, sondern gelebte Menschenkunde.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class=vb-intro>Entscheidend f\u00fcr die weltweite Verbreitung war seine Verbindung zur <strong>University of California, Berkeley</strong>. Dort lehrte er und zog einen Kreis von Sch\u00fclern an, die das Enneagramm-Wissen in die Welt trugen und zu bedeutenden Lehrern in eigener Hinsicht wurden: <strong>Helen Palmer</strong>, die das Enneagramm im englischsprachigen Raum popularisierte und die Oral Tradition begr\u00fcndete; <strong>Sandra Maitri</strong>, die die spirituelle Dimension des Systems tiefer erforschte; <strong>Beatrice Chestnut</strong>, die sp\u00e4ter das umfassendste englischsprachige Buch \u00fcber die 27 Subtypen schrieb; und <strong>Eli Jaxon-Bear</strong>, der Naranjos Arbeit mit meditativen Ans\u00e4tzen verband. Sie alle gehen auf denselben Ursprung zur\u00fcck: auf den Oktopus aus Chile, der in Berkeley seine Arme ausstreckte.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">So entstand auch ein Austausch mit dem Autor dieses Kompasses: Im Zuge des Buchs <em>Wer Du wirklich bist</em> (2015) &ndash; dem ersten deutschsprachigen Buch, das die 27 Subtypen umfassend darstellte &ndash; kam es zu einem Kontakt \u00fcber E-Mail und sp\u00e4ter Skype. Naranjo las, kommentierte, gab R\u00fcckmeldungen zu den Schaubildern ber\u00fchmter Komponisten im Buch &ndash; er, der selbst musisch war, hatte daf\u00fcr ein besonderes Gesp\u00fcr. Und als das Gespr\u00e4ch auf Hom\u00f6opathie kam &ndash; auf die Frage, welche Mittel zu welchen Subtypen passen &ndash; reagierte er sofort mit einer Gegenfrage: Er sprach von den einundf\u00fcnfzig Opiumderivaten, die sein eigener Lehrer klassifiziert hatte. Zwei Wissende, die aneinander tasteten, jeder vom anderen Feld fasziniert. Das ist das Bild einer SO5w4 in echter Begegnung: nicht Belehrung, sondern echtes Staunen dar\u00fcber, was der andere wei\u00df.</p>
        </blockquote>
...
function gertrudeElionPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-gertrude-elion-portrait.jpg" alt="Gertrude Belle Elion – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function peterLustigPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-peter-lustig-portrait.jpg" alt="Peter Lustig – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der deutsche Moderator Peter Lustig war diese Eule: Ein Mann, der sich einen Wohnwagen auf eine Wiese stellte, die Welt mit wachem Blick betrachtete &ndash; und daraus eine der erfolgreichsten Kindersendungen des deutschen Fernsehens machte. <em>L\u00f6wenzahn</em> war kein Unterhaltungsprogramm. Es war ein Denkprogramm. Die Frage hinter jeder Folge: <em>Wie funktioniert das eigentlich?</em> Das ist die Eule.</p>
        </blockquote>
...
function veraBirkenbihlPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-vera-birkenbihl-portrait.jpg" alt="Vera F. Birkenbihl – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der Sechserfl\xfcgel kann die Skepsis in Misstrauen kippen lassen &ndash; eine Welt voller falscher Systeme, gegen die man sich behaupten muss. Bei Birkenbihl blieb die Skepsis produktiv: Sie verwandelte sich in Fragen, die Fragen in Methoden und die Methoden in Werke, die nach wie vor gelesen und genutzt werden.</p>
        </blockquote>
...
function junkoTabeiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-junko-tabei-portrait.jpg" alt="Junko Tabei – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function jeanneCalmentPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-jeanne-calment-portrait.jpg" alt="Jeanne Calment – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
        ...
        <blockquote class="vb-blockquote">
          ...
          <div style="display:flex;gap:0.8rem;flex-wrap:wrap;margin:1.5rem 0;justify-content:center;align-items:flex-start;">
            <div style="width:45%;min-width:150px;aspect-ratio:3/4;overflow:hidden;border-radius:6px;">
              <img src="./assets/portraits/beruehmte-jeanne-calment-1895.jpg" alt="Jeanne Calment um 1895, mit etwa 20 Jahren" loading="lazy" style="width:100%;height:100%;object-fit:cover;object-position:center 25%;display:block;" />
            </div>
            <div style="width:45%;min-width:150px;aspect-ratio:3/4;overflow:hidden;border-radius:6px;">
              <img src="./assets/portraits/beruehmte-jeanne-calment-1900er.jpg" alt="Jeanne Calment um 1900–1910, mit etwa 40 Jahren" loading="lazy" style="width:100%;height:100%;object-fit:cover;object-position:center 15%;display:block;" />
            </div>
          </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Sechserfl\u00fcgel (w6)</strong> gibt der selbsterhaltenden Sieben ein stabiles, loyales Fundament. Wo eine SE7 mit schwächerem Sechserflügel zur Zerstreuung neigt, verankert ein stark ausgeprägter w6-Flügel sie in Verlässlichkeit &ndash; im festen Ritual, im wiederkehrenden Termin, in der Rolle, auf die man sich verlassen kann.</p>
          <p class="vb-intro">Kings Karriere war genau das: Verl\u00e4sslichkeit \u00fcber Jahrzehnte. <em>Larry King Live</em> lief von 1985 bis 2010 auf CNN, f\u00fcnf Abende die Woche, 25 Jahre lang &ndash; eine der am l\u00e4ngsten laufenden Sendungen mit demselben Moderator in der US-Fernsehgeschichte. Diese Best\u00e4ndigkeit hatte System \u2013 Ausdruck des Sechserfl\u00fcgels: die Sendung als sicherer Ort, jeden Abend zur gleichen Zeit, egal was in der Welt geschah. Zuschauer wie G\u00e4ste wussten: King ist da, verl\u00e4sslich wie ein Ritual.</p>
        </blockquote>
...
function mariahCareyPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-mariah-carey-portrait.jpg" alt="Mariah Carey – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">1. Der Gorilla</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Gorilla</strong> ist das st\u00e4rkste Tier des Regenwaldes &ndash; und das w\u00e4rmste. Er lebt in engem Familienverband, pflegt seine Beziehungen, sch\u00fctzt die Seinen mit einer Kraft, die er selten zeigen muss. Er muss nicht den Kampf suchen; allein seine Pr\u00e4senz gen\u00fcgt. Und er liebt das Essen &ndash; nicht als Schw\u00e4che, sondern als Ausdruck von Leben, Freude, \u00dcberfluss. Der Gorilla ist gro\u00dfz\u00fcgig mit dem, was er hat. Und er vergisst niemals, wer ihr geschadet hat.</p>
          <p class="vb-intro">Die US-amerikanische S\u00e4ngerin Mariah Carey ist die meistverkaufte S\u00e4ngerin aller Zeiten &ndash; oder zumindest eine der Anw\u00e4rterinnen auf diesen Titel, je nach Z\u00e4hlweise. Sie hat achtzehn Nummer-eins-Singles in den amerikanischen Billboard Hot 100 &ndash; mehr als jeder andere Solok\u00fcnstler in der Geschichte dieser Hitliste. Ihre Stimme umfasst f\u00fcnf Oktaven, inklusive des Pfeifregisters, das sie als Erste popul\u00e4r machte. Und sie hat ein einziges Weihnachtslied geschrieben &ndash; <em>All I Want for Christmas Is You</em> (1994) &ndash;, das ihr noch heute j\u00e4hrlich mehrere Millionen Dollar einbringt. Mariah Carey ist der Gorilla: warm, m\u00e4chtig, \u00fcppig &ndash; und vollkommen bereit, denjenigen in die Augen zu sehen, die ihr im Weg stehen.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Achterfl\u00fcgel</strong> gibt dem selbsterhaltenden Siebener eine Qualität, die eine SE7 mit schwach ausgeprägtem Achterflügel nicht immer zeigt: den Willen zur Macht, die Bereitschaft zur Konfrontation und ein ausgepr\u00e4gtes Sensorium f\u00fcr Kontrolle &ndash; und f\u00fcr deren Verlust. Wo die SE7 Freude sucht und Unangenehmes meidet, f\u00fcgt der Achterfl\u00fcgel hinzu: <em>Und wenn jemand meine Freude bedroht, werde ich es ihn wissen lassen.</em></p>
...
function carolinePetersPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-caroline-peters-portrait.jpg" alt="Caroline Peters – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function dieterNuhrPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-dieter-nuhr-portrait.jpg" alt="Dieter Nuhr – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der deutsche Kabarettist Dieter Nuhr wurde 1960 in Wesel am Rhein geboren und wuchs im Ruhrgebiet auf. Er studierte P\u00e4dagogik, Kunstgeschichte und Geographie an der Universit\u00e4t Duisburg &ndash; ein Studium, das seinen sp\u00e4teren Blick auf Gesellschaft, Bildung und Kultur pr\u00e4gen sollte. Er ist kein Kabarettist aus dem Bauch; er ist ein Kabarettist aus der Beobachtung. Der Biber, der jeden Stein genau pr\u00fcft, bevor er ihn einsetzt.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Achterfl\u00fcgel</strong> gibt dem sozialen Siebener etwas, das eine SO7 mit schwach ausgeprägtem Achterflügel nicht immer zeigt: Konfrontationsbereitschaft, Durchsetzungswillen und die F\u00e4higkeit, Grenzen klar zu benennen &ndash; und zu verteidigen. Wo eine SO7 mit schwach ausgeprägtem Achterflügel nachgibt und vermittelt, sagt ein stark ausgeprägter Achterflügel: <em>Bis hier und nicht weiter.</em></p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der US-amerikanische Schauspieler Wallace Shawn ist klein, kahlk\u00f6pfig, hat eine nasale Stimme, die man nicht vergisst, und spielt seit Jahrzehnten Schurken, arme Tr\u00f6pfe und Selbst\u00fcbersch\u00e4tzer in Filmen, in denen irgendwer am Ende <em>Inconceivable!</em> (\u201eUnvorstellbar!\u201c) ruft. Dabei ist er einer der klugsten K\u00f6pfe der amerikanischen Intellektuellenszene \u2013 Sohn des Chefredakteurs des <em>New Yorker</em>, ausgebildet in Harvard und Oxford, Verfasser von B\u00fchnenst\u00fccken, die das Off-Theater der 1970er und 1980er Jahre pr\u00e4gten. Wallace Shawn ist der Gorilla: er sieht gem\u00fctlich aus \u2013 und tr\u00e4gt das Schwergewicht der Ideen.</p>
        </blockquote>

        <h2 class="vb-section">2. Die Familie: Vergn\u00fcgen als Weltanschauung</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Claudio Naranjo nannte den selbsterhaltenden Typ 7 die <strong>Familie</strong> \u2013 weil dieser Subtyp Sicherheit und Freude nicht in der gro\u00dfen Welt sucht, sondern im engsten Kreis. Er baut Nester aus Vertrautheit, W\u00e4rme und sinnlichem Vergn\u00fcgen. Essen, Gespr\u00e4ch, Musik, Lachen, gute Menschen am Tisch: das sind keine Luxusg\u00fcter der SE7, sondern existenzielle Bed\u00fcrfnisse. Die Freude ist kein Zusatz zum Leben \u2013 sie ist das Leben selbst.</p>
          <p class="vb-intro">Shawn lebt seit Jahrzehnten mit der Schriftstellerin Deborah Eisenberg zusammen, ohne je \u00f6ffentlich geheiratet zu haben. Er spricht mit einer Warmherzigkeit \u00fcber Freundschaften und intellektuelle Gespr\u00e4che, die er kaum von Liebe unterscheidet. Sein ber\u00fchmtestes Werk \u2013 <em>Mein Abendessen mit Andr\u00e9</em> (<em>My Dinner with Andre</em>, 1981) \u2013 ist buchst\u00e4blich ein Film \u00fcber ein Abendessen: zwei Freunde reden, zwei Stunden lang, \u00fcber Bewusstsein, Theater, Leben und Tod. Kein Held, keine Action, keine Romanzen. Nur Gespr\u00e4ch als Lebenselixier. Der SE7 pur: das Tischgespr\u00e4ch als h\u00f6chste Kunstform.</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Sechserfl\u00fcgel (w6)</strong> gibt dem selbsterhaltenden Siebener etwas, das eine SE7 mit schwach ausgeprägtem Sechserflügel allein nicht immer entwickelt: ein stabiles ethisches Rückgrat. Wo die SE7 zur Zerstreuung neigt, zur Vermeidung des Unbehagens durch Vergn\u00fcgen, gibt der w6-Fl\u00fcgel den Mut, beim Unbehaglichen zu bleiben \u2013 und es in Worte zu fassen, auch wenn es wehtut.</p>
          ...
          <p class="vb-intro">Der Sechserfl\u00fcgel macht den Gorilla loyal und ernsthaft. Er sorgt daf\u00fcr, dass das Vergn\u00fcgen nie ganz naiv bleibt. Shawn lacht viel \u2013 und er wei\u00df immer, warum er lacht.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht des SE7w6 ist seine <strong>F\u00e4higkeit zur Freude ohne Selbst\u00e4uschung</strong>. Shawn kann lachen und gleichzeitig wissen, dass Lachen nicht alles ist. Er sucht das Vergn\u00fcgen, aber fl\u00fcchtet sich nicht in dieses. Er ist warm, anwesend, neugierig \u2013 und er tr\u00e4gt eine ernsthafte Meinung, ohne sie anderen mit Druck aufzuzwingen.</p>
...
function guentherJauchPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-guenther-jauch-portrait.jpg" alt="G\xfcnther Jauch – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function ladyDianaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-lady-diana-portrait.jpg" alt="Lady Diana – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>Taube</strong> ist seit Jahrtausenden das Symbol des Friedens &ndash; und es ist ein Tier, das auf Anhieb zart wirkt, fast verletzlich. Und doch ist die Taube z\u00e4h: Sie findet ihren Weg auch \u00fcber weite Strecken, auch durch Sturm. Sie tr\u00e4gt Botschaften. Sie kehrt zur\u00fcck. Die Taube h\u00e4lt inne, wo andere weiterfliegen &ndash; und in diesem Innehalten entsteht etwas Stilles, das mehr bewegt als viele laute Gesten.</p>
          <p class="vb-intro">Die britische Diana Frances Spencer, Princess of Wales, war eines der bekanntesten Gesichter des 20. Jahrhunderts &ndash; und gleichzeitig eine der einsamsten Pers\u00f6nlichkeiten ihrer Zeit. In einer Welt aus Protokoll, Palast und \u00d6ffentlichkeit trug sie etwas in sich, das sich nicht einordnen lie\u00df: eine Empfindlichkeit, die manchmal l\u00e4hmte, und eine F\u00e4higkeit zur Verbindung, die Millionen ber\u00fchrte. Die Taube, die Botschaften tr\u00e4gt &ndash; auch dann, wenn der Weg beschwerlich ist.</p>
        </blockquote>

        <h2 class="vb-section">2. Die selbsterhaltende Vier: Leiden als stille Welt</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>selbsterhaltende Vier (SE4)</strong> ist in der Enneagramm-Tradition der Kontratyp der Vier: Sie zeigt ihr Innenleben nicht nach au\u00dfen, sie zieht es nicht in gro\u00dfe Gesten oder dramatische Selbstdarstellung. Naranjo nannte diesen Subtyp <em>Z\u00e4higkeit</em> (im Original: <em>tenacity</em>) &ndash; nicht im Sinn von H\u00e4rte gegen\u00fcber anderen, sondern als einen Antrieb, sich selbst gegen\u00fcber kompromisslos zu sein. Die SE4 k\u00e4mpft mit dem Schmerz &ndash; aber sie k\u00e4mpft ihn still aus. Sie zeigt St\u00e4rke nach au\u00dfen, w\u00e4hrend sie innen ringt.</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Dreierfl\u00fcgel (w3)</strong> bringt der selbsterhaltenden Vier etwas Entscheidendes: die F\u00e4higkeit, das Innere nach au\u00dfen zu wenden und in Wirkung zu verwandeln. Eine SE4 mit schwach ausgeprägtem Dreierflügel könnte sich in der inneren Welt verlieren – tief empfindend, aber unsichtbar. Ein stark ausgeprägter Dreierflügel gibt ihr stattdessen eine Bühne &ndash; nicht aus Eitelkeit, sondern aus dem Bed\u00fcrfnis, das Erlebte zu gestalten und weiterzugeben.</p>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Das Schicksalsmuster der Vier ist der <strong>Neid</strong> &ndash; nicht als Missgunst, sondern als das tiefe Gef\u00fchl, dass anderen etwas mitgegeben wurde, das einem selbst fehlt. Bei der SE4 \u00e4u\u00dfert sich das als das chronische Gef\u00fchl der Unvollst\u00e4ndigkeit: nie ganz richtig, nie ganz genug, immer etwas au\u00dfen vor. Diana hat dieses Gef\u00fchl während ihres ganzen Lebens beschrieben &ndash; das Gef\u00fchl, in einer Welt zu leben, die f\u00fcr andere gemacht war, nicht f\u00fcr sie.</p>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">3. Der Dreierfl\u00fcgel: Die Botschaft nach au\u00dfen tragen</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Dreierfl\u00fcgel (w3)</strong> gibt der selbsterhaltenden Vier etwas Entscheidendes: die F\u00e4higkeit, das Innere in Wirkung zu verwandeln. Eine SE4 mit schwach ausgeprägtem Dreierflügel könnte in ihrer inneren Welt verharren – tief empfindend, aber unsichtbar. Ein stark ausgeprägter Dreierflügel gibt ihr das Handwerk, diese Tiefe in eine Form zu gie\u00dfen, die Millionen erreicht.</p>
      ...
      ${relatedLinks([
        ...
        {route:"krankheitsportraets-adele", label:"Krankheitsportr\u00e4t: Adele (SE4w3) \u2013 postnatale Depression"},
      ])}
    </div>
  `);
}
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Bei McCartney zeigt sich das im scharfen Kontrast zu seinem einstigen Songwriting-Partner John Lennon &ndash; im Kompass als soziale Vier mit F\u00fcnferfl\u00fcgel (SO4w5) typisiert &ndash; der seine Wunden \u00f6ffentlich, roh und ungesch\u00f6nt in Songs wie &bdquo;Mother&ldquo; verarbeitete. Das liegt nicht allein an der Pers\u00f6nlichkeit, sondern folgt der Subtypenlehre selbst: Die soziale Vier gilt als Verst\u00e4rkungstyp und wird umgangssprachlich auch die <em>&bdquo;Sad Four&ldquo;</em> genannt &ndash; die Vier, die ihr Leiden sichtbar nach au\u00dfen tr\u00e4gt, um gesehen zu werden. Die selbsterhaltende Vier dagegen, der Kontratyp, ist die <em>&bdquo;Glad Four&ldquo;</em> &ndash; sie zeigt eher ein heiteres Gesicht, w\u00e4hrend der Schmerz nach innen wandert. (Die dritte im Bunde, die sexuelle Vier, gilt als <em>&bdquo;Mad Four&ldquo;</em> &ndash; die zornige, leidenschaftliche Vier.)</p>
          <p class="vb-intro">McCartney ging den der SE4 eigenen Weg: Auch seine schmerzhaftesten Erfahrungen &ndash; der fr\u00fche Tod seiner Mutter mit vierzehn, die Trennung der Beatles, private Verluste &ndash; erscheinen in seiner Musik meist verkleidet, in Metaphern geh\u00fcllt, melodisch abgefedert. Wo Lennon schrie, komponierte McCartney &ndash; zwei Vieren, zwei v\u00f6llig unterschiedliche Ausdrucksformen desselben Schicksalsmusters.</p>
          <p class="vb-intro">Der selbsterhaltende Instinkt richtet die Vier auf das eigene Funktionieren aus &ndash; auf Stabilit\u00e4t, Kontinuit\u00e4t, das stille Weitermachen. McCartney ist bekannt f\u00fcr eine fast obsessive Arbeitsdisziplin: Er komponiert auch heute noch regelm\u00e4\u00dfig, tourt im hohen Alter noch durch Stadien, h\u00e4lt an einem strikten Tagesrhythmus fest. Die SE4, die den inneren Sturm durch \u00e4u\u00dfere Struktur z\u00e4hmt.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Auch seine notorische Zur\u00fcckgezogenheit im Studio &ndash; endlose N\u00e4chte allein mit dem Klavier, das Feilen an einer einzigen Akkordfolge, bis sie stimmt &ndash; tr\u00e4gt diese Handschrift. Der F\u00fcnferfl\u00fcgel zieht sich zur\u00fcck, um das Werk in aller Ruhe zu durchdringen, und tritt erst dann wieder hervor, wenn er es der Welt vorspielen kann.</p>
        </blockquote>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Viererfl\u00fcgel (w4)</strong> bringt in die SX3-Energie etwas, das bei schwach ausgepr\u00e4gtem Viererfl\u00fcgel oft verdr\u00e4ngt bleibt: das Bed\u00fcrfnis nach Tiefe, nach Echtheit, nach einem Ausdruck, der \u00fcber die Oberfl\u00e4che hinausgeht. Die SX3w4 will nicht nur bezaubern &ndash; sie will <em>bedeutsam</em> sein.</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Meg Ryan war in den 1990er Jahren das Gesicht einer Filmgattung, die heute nostalgisch verkl\u00e4rt wird: die romantische Kom\u00f6die in ihrer warmherzigsten Form. Drei Filme mit der Regisseurin Nora Ephron schufen ein Universum, das bis auf den heutigen Tag als Ma\u00dfstab gilt.</p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Ihre Wirkung ersch\u00f6pfte sich nie im rein Visuellen. Regisseure und Kollegen beschrieben eine Pr\u00e4senz, die sich vor der Kamera vervielfachte &ndash; als w\u00fcrde die Linse selbst zum Gegen\u00fcber, dem sie sich zuwandte. Genau das zeigt sich hier ungefiltert als der SX3-Wirkung: nicht Distanz, sondern N\u00e4he, die durch die Leinwand hindurch tr\u00e4gt.</p>
        </blockquote>
...
function dieterBohlenPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-dieter-bohlen-portrait.jpg" alt="Dieter Bohlen – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Viererfl\u00fcgel (w4)</strong> bringt der sexuellen Drei etwas, das man beim ersten Hinsehen nicht vermutet: Tiefe. Eine SX3 mit schwach ausgeprägtem Viererflügel könnte in der Verführung aufgehen – immer glänzend, immer überzeugend, immer auf der Jagd nach dem nächsten Moment der Verbindung. Ein stark ausgeprägter Viererflügel stellt dagegen eine andere Frage dahinter: <em>Aber wer bin ich wirklich? Was bleibt, wenn der Glanz verblasst?</em></p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Genau hier zeigt sich die sexuelle Drei mit Viererflügel von ihrer wissenschaftlichsten Seite: Leistung und Präsentation dürfen keine hohle Fassade sein. Sie müssen durch innere Substanz, durch echten Wert, untermauert sein &ndash; ›mehr sein als Schein‹. Was die SX3w4 als Lebensgefühl in sich trägt (die Sehnsucht, nicht nur zu glänzen, sondern auch wirklich bedeutsam zu sein), hat Zuk als Naturgesetz nachgewiesen: Der Pfau täuscht nicht. Sein Rad ist ein ehrliches Signal.</p>
        </blockquote>
...
function kaiPflaumePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-kai-pflaume-portrait.jpg" alt="Kai Pflaume – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Claudio Naranjo nannte diesen Subtyp <em>Masculinity/Femininity</em>: die Verk\u00f6rperung von Anziehungskraft in ihrer reinsten, pers\u00f6nlichsten Form. Beim gesunden SX3 ist das keine Fassade &ndash; es ist eine echte Gabe. Die F\u00e4higkeit, in jedem Gegen\u00fcber etwas Besonderes zu sehen und ihm das sp\u00fcrbar zu machen.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Zweierfl\u00fcgel: W\u00e4rme als zweite Natur</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Zweierfl\u00fcgel (w2)</strong> f\u00fcgt der Dreierenergie etwas Entscheidendes hinzu: echte F\u00fcrsorge. W\u00e4hrend eine Drei mit schw\u00e4cher ausgepr\u00e4gtem Zweierfl\u00fcgel eher mit Charisma und Leistung punktet, kommt beim SX3w2 noch eine zweite Kraft hinzu &ndash; das aufrichtige Interesse an anderen, die Freude daran, jemandem etwas Gutes zu tun. Die Zwei gibt, nicht um Gegenleistung zu erwarten, sondern weil Geben ihr Wesen ist.</p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Die französische Schauspielerin Brigitte Bardot wurde mit &bdquo;Und ewig lockt das Weib&ldquo; (1956) \u00fcber Nacht zur internationalen Ikone &ndash; und zu einer Ersch\u00fctterung der b\u00fcrgerlichen Sittlichkeit ihrer Zeit. Kein Skandal um ihre Person allein, sondern die schiere Wirkung ihrer Pr\u00e4senz auf der Leinwand ver\u00e4nderte, wie Weiblichkeit im europ\u00e4ischen Kino gezeigt werden durfte. Der Pfau, der ein ganzes Publikum ver\u00e4ndert, allein durch das, was er ist.</p>
        </blockquote>

        <h2 class="vb-section">2. Die sexuelle Drei: Magnetismus als Lebensthema</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>sexuelle Drei (SX3)</strong> macht pers\u00f6nliche Anziehungskraft zur Lebensaufgabe &ndash; nicht Erfolg vor der Masse wie die soziale Drei, sondern die unmittelbare, k\u00f6rperliche, direkte Resonanz mit dem Gegen\u00fcber. Claudio Naranjo nannte diesen Subtyp <em>Masculinity/Femininity</em>: die Verk\u00f6rperung von Attraktivit\u00e4t in ihrer reinsten, intimsten Form. Die SX3 fragt nicht <em>Bewundert man mich?</em>, sondern <em>Begehrt man mich?</em></p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Zweierfl\u00fcgel (w2)</strong> gibt der sexuellen Drei eine Dimension, die \u00fcber reinen Magnetismus hinausgeht: das echte Bed\u00fcrfnis, sich um andere zu k\u00fcmmern, F\u00fcrsorge zu geben, nicht nur Bewunderung zu empfangen. Eine SX3 mit schwach ausgeprägtem Zweierflügel könnte in ihrer eigenen Wirkung aufgehen. Ein stark ausgeprägter Zweierflügel öffnet den Blick nach außen &ndash; auf die, die keine Stimme haben.</p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Naranjo nannte diesen Subtyp <em>Inadaptability</em> &ndash; Unnachgiebigkeit gegen\u00fcber dem, was ist, wenn es nicht sein sollte. Die SO1 akzeptiert keine Kompromisse mit Unrecht. Sie hat hohe Ma\u00dfst\u00e4be &ndash; nicht nur f\u00fcr sich, sondern f\u00fcr die Welt. Das macht sie zur geborenen Reformerin, zur Stimme derer, die keine Stimme haben.</p>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Zweierfl\u00fcgel (w2)</strong> f\u00fcgt der sozialen Eins etwas Entscheidendes hinzu: direktes, pers\u00f6nliches Mitgef\u00fchl. Bei schwach ausgepr\u00e4gtem Zweierfl\u00fcgel kann die Eins kalt wirken in ihrer Geradlinigkeit &ndash; unerbittlich, fordernd, schwer zug\u00e4nglich. Der Zweierfl\u00fcgel \u00f6ffnet diese Energie: Er macht aus der Systemkritikerin einen Menschen, der auch die Hand ausstreckt.</p>
...
function konradLorenzPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-konrad-lorenz-portrait.jpg" alt="Konrad Lorenz – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Naranjo nannte diesen Subtyp <em>Inadaptability</em> &ndash; Unnachgiebigkeit gegen\u00fcber dem, was abweicht. Die SO1 hat Schwierigkeiten damit, Kompromisse mit dem zu machen, was sie f\u00fcr strukturell falsch h\u00e4lt. Das macht sie zur konsequentesten Reformerin unter den Einser-Subtypen &ndash; und zur unbequemsten Gespr\u00e4chspartnerin.</p>
          <p class="vb-intro">Friedrich Merz verk\u00f6rpert diese Energie ungefiltert. Als Jurist, als Wirtschaftspolitiker, als CDU-Vorsitzender und jetzt als Bundeskanzler: Ihm geht es immer um das Prinzip. Um Haushaltsdisziplin als moralische Frage. Um die Grenze als rechtliche Pflicht. Um den Staat als Ordnungsrahmen, der gehalten werden muss. Das ist keine Ideologie. Das ist der Blick der sozialen Eins auf die Welt.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Neunerfl\u00fcgel: Ruhe im Inneren, Klarheit nach au\u00dfen</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Neunerfl\u00fcgel (w9)</strong> ver\u00e4ndert die soziale Eins auf subtile, aber entscheidende Weise. Eine SO1 mit schwach ausgeprägtem Neunerflügel kann hitzig, anklagend, moralisierend wirken – der Zorn liegt nah an der Oberfläche. Ein stark ausgeprägter Neunerflügel kühlt diese Energie ab. Er bringt eine gewisse Gelassenheit, eine F\u00e4higkeit zur Ruhe, die die Botschaft der Eins stabiler und weniger angreifbar macht.</p>
          <p class="vb-intro">Der Neunerfl\u00fcgel f\u00fcgt auch eine Qualit\u00e4t hinzu, die man bei Merz h\u00e4ufig beobachtet: die F\u00e4higkeit, lange zu warten. Die Neun ist geduldig &ndash; fast zu geduldig manchmal. Merz hat jahrelang auf seine politische Stunde gewartet, nach der \u00c4ra Merkel im Hintergrund gearbeitet, sich nicht verbiegen lassen. Das ist nicht die Energie eines Einser-K\u00e4mpfers mit schwach ausgepr\u00e4gtem Neunerfl\u00fcgel. Das ist die geduldige Beharrlichkeit der SO1w9er.</p>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Zweierfl\u00fcgel (w2)</strong> ver\u00e4ndert die sexuelle Eins auf entscheidende Weise. Eine SX1 mit schwach ausgeprägtem Zweierflügel kann verzehrend wirken – hitzig, fordernd, schwer zugänglich in ihrer Intensität. Ein stark ausgeprägter Zweierflügel bringt eine natürliche Wärme ins Spiel: das echte Interesse am anderen, die Freude am Geben, die F\u00e4higkeit, andere in die eigene Welt einzuladen statt sie auf Abstand zu halten.</p>
...
function jjLiuPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-jj-liu-portrait.jpg" alt="J. J. Liu – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function frankaPotentePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-franka-potente-portrait.jpg" alt="Franka Potente – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>

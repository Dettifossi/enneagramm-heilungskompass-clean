    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der ungarische Komponist Franz Liszt, geboren 1811 im ungarischen Raiding als Sohn eines Verwalters im Dienst der Fürsten Esterházy, zeigte Liszt schon als Kind ein außergewöhnliches Talent, das ihn bald zum Unterricht bei Carl Czerny und später nach Paris führte. Seine physische Spielweise war so kraftvoll, dass bei seinem Klavierspiel regelmäßig Klaviersaiten zerrissen – ein Klavierbauer musste eigens verstärkte Instrumente für seine Konzerte bereitstellen. Der Schimpanse spielt nicht für sich – er reißt begeistert den ganzen Saal mit sich.</p>
        </blockquote>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der deutsche Komponist Robert Schumann, geboren 1810 in Zwickau als Sohn eines Buchhändlers und Schriftstellers, wuchs in einem Haus voller Literatur auf. Schon früh zeigte sich die Rastlosigkeit des Schimpansen: mal Jurastudium, mal Klaviervirtuose, mal Dichter – bevor er sich endgültig der Musik verschrieb. Eine selbstverschuldete Handverletzung, vermutlich durch ein mechanisches Übungsgerät, beendete seine Pianistenkarriere abrupt und lenkte seine ganze Energie auf das Komponieren und Schreiben um.</p>
        </blockquote>
...
function shakiraPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-shakira-portrait.jpg" alt="Shakira – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Die kolumbianische S\u00e4ngerin Shakira, geboren 1977 in Barranquilla an der kolumbianischen Karibikk\u00fcste, ist dieser Schimpanse unverfälscht. Schon als Kind schrieb sie Songs, tanzte auf Tischen in Restaurants ihrer Heimatstadt und wurde von einem Talentmanager entdeckt, der sie \u201eunaufhaltsam" nannte. Ihre H\u00fcften, wie sie selbst in einem ihrer bekanntesten Songs sang, l\u00fcgen nicht &ndash; und genau diese ungefilterte, k\u00f6rperliche Ehrlichkeit ist der Kern ihrer gesamten Kunst.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Achterfl\u00fcgel (w8)</strong> gibt der sexuellen Sieben etwas, das Siebenern mit schwach ausgepr\u00e4gtem Achterfl\u00fcgel oft fehlt: den Willen, die eigene Intensit\u00e4t nicht dem Zufall zu \u00fcberlassen, sondern selbst zu gestalten und zu verteidigen. Wo eine SX7 mit schw\u00e4cherem Achterfl\u00fcgel sich treiben lassen k\u00f6nnte, ergreift die SX7w8 die Kontrolle &ndash; \u00fcber die eigene Karriere, das eigene Bild, die eigene Kunst.</p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der s\u00fcdafrikanisch-amerikanische Unternehmer Elon Musk hat in weniger als drei\u00dfig Jahren PayPal mitgegr\u00fcndet, SpaceX aus dem Nichts aufgebaut, Tesla vor dem Bankrott gerettet, Starlink ins All geschossen, X (ehemals Twitter) \u00fcbernommen und nebenbei einen Flammenwerferhersteller namens The Boring Company auf die Welt losgelassen. Der Biber macht keine halben Sachen. Er baut und baut &ndash; und sucht sich das n\u00e4chste Hindernis, das es zu stauen gilt.</p>
        </blockquote>
...
function mariellaSuperinaPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-mariella-superina-portrait.jpg" alt="Dr. Mariella Superina – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function carlFriedrichGaussPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-carl-friedrich-gauss-portrait.jpg" alt="Carl Friedrich Gauß – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function parisHiltonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-paris-hilton-portrait.jpg" alt="Paris Hilton – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
        <p class="krim-portrait-name">Paris Hilton</p>
        <p class="krim-portrait-typ">SX4w3 &middot; Sexueller Typ 4 mit Dreierflügel</p>
        <p class="krim-portrait-subtitle">Erbin, Unternehmerin, Reality-TV-Pionierin, geb. 1981 &ndash; Tierentsprechung: Chihuahua</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. Der Chihuahua, der immer einen Chihuahua an der Seite hatte</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Chihuahua</strong> ist das Tier der sexuellen Vier &ndash; klein, aber mit einer Präsenz, die den gesamten Raum füllt, dramatisch in jeder Regung, und immer auf der Suche nach der einen intensiven Verbindung, die alles andere überstrahlt. Kaum ein Bild verkörpert dieses Prinzip so buchstäblich wie das von Paris Hilton mit ihrem berühmtesten Begleiter: dem Chihuahua Tinkerbell, der über ein Jahrzehnt lang kaum von ihrer Seite wich, mit diamantbesetzten Outfits durch die Öffentlichkeit getragen wurde und zur Symbolfigur eines ganzen Modetrends wurde &ndash; des "Handtaschenhundes".</p>
          <p class="vb-intro">Hilton, Urenkelin des Hotelgründers Conrad Hilton, wurde Ende der 1990er-Jahre zunächst als Teil der New Yorker Society-Szene bekannt, bevor sie ab 2003 mit der Reality-Serie "The Simple Life" weltberühmt wurde. Ihr Stil &ndash; Trainingsanzüge, Strasssteine, eben jener kleine Hund in der Handtasche &ndash; prägte über Jahre den Massengeschmack, lange bevor Influencer-Marketing ein Begriff war.</p>
        </blockquote>

        <h2 class="vb-section">2. Die sexuelle Vier: Intensität als Bühne und als Schutz zugleich</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>sexuelle Vier (SX4)</strong> nennt Naranjo "Konkurrenz": Sie sucht ihre Bedeutung nicht in stiller Rückzogenheit, sondern in einer dramatischen, unübersehbaren Präsenz, die im Wettbewerb um Aufmerksamkeit und Intensität gewinnen will. Hilton perfektionierte über Jahre eine öffentliche Kunstfigur &ndash; eine hauchige, mädchenhafte Stimme, eine geradezu inszenierte Naivität &ndash; die so wirkungsvoll war, dass sie zum Vorbild für eine ganze Generation späterer Reality- und Social-Media-Persönlichkeiten wurde.</p>
          <p class="vb-intro">Doch genau diese Kunstfigur war, wie Hilton selbst später offenlegte, ein Schutzschild: In Interviews beschrieb sie sich als "von Natur aus sehr schüchtern" und erklärte, ihre eigentliche Stimme sei tiefer und ruhiger, als die Öffentlichkeit sie je gehört hatte. Die sexuelle Vier zeigt sich hier von ihrer paradoxesten Seite: eine Bühnenfigur von solcher Intensität aufzubauen, dass sie das verletzliche Selbst dahinter über Jahrzehnte vollständig verdecken konnte.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Dreierflügel: Die perfekt inszenierte Marke</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Dreierflügel (w3)</strong> verleiht der Vier ein untrügliches Gespür für Wirkung, Bild und Vermarktung &ndash; die eigene Intensität wird nicht nur gefühlt, sondern strategisch in eine erfolgreiche, wiedererkennbare Marke übersetzt. Hilton baute aus ihrer öffentlichen Figur ein Geschäftsimperium: Parfums, Modelinien, DJ-Karriere, unternehmerische Beteiligungen &ndash; ein Werk, das weit über die ursprüngliche Society-Bekanntheit hinausging und ihr von späteren Reality-Stars, darunter Kim Kardashian, ausdrücklich als Wegbereiterin zugeschrieben wird.</p>
          <p class="vb-intro">Auch Tinkerbell war Teil dieser bewussten Inszenierung: Der Chihuahua trat regelmäßig in "The Simple Life" auf, wurde zur eigenen kleinen Berühmtheit und verstärkte genau jenes Bild grenzenloser, glamouröser Verspieltheit, das Hilton als Marke verkörperte. Der Dreierflügel weiß genau, welches Detail ein Bild vollständig macht.</p>
        </blockquote>

        <h2 class="vb-section">4. Licht und Schatten</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SX4w3 ist die Fähigkeit, <strong>innere Intensität in eine kulturprägende öffentliche Figur</strong> zu verwandeln &ndash; Hilton veränderte nachweislich, wie eine ganze Generation Prominenz, Mode und mediale Selbstinszenierung verstand, lange bevor soziale Medien diesen Mechanismus für alle zugänglich machten.</p>
          <p class="vb-intro">Der Schatten zeigte sich erst Jahrzehnte später, in der Dokumentation "This Is Paris" (2020), in der Hilton die Fassade bewusst ablegte und über belastende Kindheitserfahrungen in sogenannten "Troubled-Teen"-Einrichtungen sprach. Sie beschrieb, wie befreiend es war, endlich als verletzlicher Mensch statt als perfekte Kunstfigur wahrgenommen zu werden. Die Kehrseite der sexuellen Vier mit Dreierflügel: Eine Bühnenpersona so überzeugend zu bauen, dass die Welt jahrzehntelang das eigentliche Selbst dahinter kaum zu Gesicht bekam.</p>
        </blockquote>

        <h2 class="vb-section">5. Der Chihuahua, der zeigt, dass unter der Rüstung ein Herz schlägt</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Tinkerbell starb 2015 im Alter von vierzehn Jahren, tief betrauert von Hilton, die offen von ihrer engen, jahrelangen Bindung zu dem kleinen Hund sprach. Was bleibt, ist ein doppeltes Bild: die glamouröse, unübersehbare Kunstfigur mit dem Chihuahua in der Handtasche &ndash; und die Frau, die Jahrzehnte später den Mut fand, genau diese Rüstung öffentlich abzulegen.</p>
          <p class="vb-intro">Kaum ein Bild könnte treffender für die sexuelle Vier mit Dreierflügel stehen: ein kleines Tier von grenzenloser, unübersehbarer Präsenz an der Seite einer Frau, deren eigene, ebenso intensive öffentliche Inszenierung erst spät den Blick auf ein zartes, verletzliches Inneres freigab.</p>
        </blockquote>
...
function hughWarwickPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-hugh-warwick-portrait.jpg" alt="Hugh Warwick – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function anneMcBridePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-anne-mcbride-portrait.jpg" alt="Dr. Anne McBride – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function johnWaynePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-john-wayne-portrait.jpg" alt="John Wayne – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <p class="vb-intro">Die 1964 öffentlich ausgetragene Lungenkrebs-Erkrankung sowie die tödliche Magenkrebs-Diagnose 1979 werden ausführlich im eigenen <a href="javascript:void(0)" data-route="krankheitsportraets-john-wayne">Krankheitsporträt zu Wayne</a> gedeutet.</p>
      ...
      ${relatedLinks([
        {route:"beruehmte-persoenlichkeiten", label:"Alle berühmten Persönlichkeiten"},
        {route:"krankheitsportraets-john-wayne", label:"Krankheitsporträt: John Wayne (SX8w7)"},
...
function martaManserPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-marta-manser-portrait.jpg" alt="Prof. Dr. Marta Manser – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function timCluttonBrockPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-tim-clutton-brock-portrait.jpg" alt="Prof. Tim Clutton-Brock – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function davidMechPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-david-mech-portrait.jpg" alt="Dr. L. David Mech – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der US-amerikanische Wolfsforscher Dr. L. David Mech, 1937 in Auburn, New York, geboren, machte aus einer einzigen, jahrzehntelang verfolgten Forschungsfrage ein Lebenswerk: rund 380 wissenschaftliche Publikationen, elf Bücher, darunter das bis heute maßgebliche Standardwerk "The Wolf: The Ecology and Behavior of an Endangered Species" (1970, deutsch etwa: "Der Wolf: Ökologie und Verhalten einer bedrohten Art"). 1985 gründete er zusätzlich das International Wolf Center, um sein Wissen einer breiten Öffentlichkeit zugänglich zu machen.</p>
        </blockquote>

        <h2 class="vb-section">2. Die sexuelle Sechs: Direkte Konfrontation statt Ausweichen</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>sexuelle Sechs (SX6)</strong> begegnet der eigenen Angst kontraphobisch &ndash; nicht durch Vermeidung, sondern durch die direkte, oft jahrzehntelange Auseinandersetzung mit genau dem, was andere fürchten würden. Mech verbrachte unzählige Wochen im arktischen Winter auf Ellesmere Island, um wilde Wolfsrudel aus nächster Nähe zu beobachten &ndash; eine Forschungsmethode, die außergewöhnliche physische Härte und die Bereitschaft erfordert, sich extremer Kälte und Isolation über lange Zeiträume auszusetzen.</p>
          <p class="vb-intro">Bezeichnend ist auch seine intellektuelle Konfrontationsbereitschaft mit sich selbst: Mech prägte in den 1970er-Jahren maßgeblich das populäre Konzept des "Alpha-Wolfs" in einer strikten Dominanzhierarchie &ndash; und korrigierte diese eigene, weltberühmt gewordene These später selbst öffentlich, als neuere Feldbeobachtungen zeigten, dass ein Wolfsrudel in freier Wildbahn meist schlicht eine Familie ist &ndash; ein Elternpaar mit seinem Nachwuchs aus mehreren Jahren &ndash;, in der sich die Rangfolge über natürliche Reifung und familiäre Bindung ergibt, nicht über ständige, gewaltsame Rangordnungskämpfe rivalisierender Fremder. Die eigene, einst verteidigte Sicherheit infrage zu stellen, sobald neue Fakten es verlangen, ist ein typisches Merkmal der Sechs, insbesondere der sexuellen Sechs mit Fünferflügel.</p>
        </blockquote>
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-douglas-smith", label:"Porträt: Dr. Douglas W. Smith (SX6w5)"},
...
function douglasSmithPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-douglas-smith-portrait.jpg" alt="Dr. Douglas W. Smith – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>sexuelle Sechs (SX6)</strong> begegnet Angst kontraphobisch &ndash; nicht durch Ausweichen, sondern durch die direkte Übernahme von Verantwortung genau dort, wo andere zurückschrecken würden. Die Wiederansiedlung der Wölfe in Yellowstone 1995 war ein hochriskantes, politisch umkämpftes Projekt: Smith musste nicht nur wissenschaftlich, sondern auch gegen erheblichen öffentlichen Widerstand von Ranchern und Jägern bestehen, um die Wölfe dauerhaft im Park zu etablieren.</p>
          <p class="vb-intro">Sein Lebenswerk dokumentiert eindrücklich, wie die Rückkehr eines einzigen Rudels das gesamte ökologische Gleichgewicht eines riesigen Nationalparks verändern kann &ndash; bis hin zum Flussverlauf, der sich durch das veränderte Verhalten der Elche und die dadurch zurückkehrende Ufervegetation neu formte. Genau diese Hingabe an das Überleben und den Schutz einer ganzen Gemeinschaft, nicht nur einzelner Tiere, ist der Kern der sexuellen Sechs.</p>
        </blockquote>
        ...
        <h2 class="vb-section">4. Licht und Schatten</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SX6w5 ist die Fähigkeit, <strong>unter erheblichem Druck und Widerstand die Verantwortung für ein ganzes ökologisches System zu übernehmen</strong> &ndash; die Wolfswiederansiedlung in Yellowstone gilt heute als eines der erfolgreichsten Naturschutzprojekte der Geschichte und veränderte grundlegend, wie Wissenschaft und Öffentlichkeit das Konzept der "trophischen Kaskade" verstehen: wie ein einziges Raubtier ein gesamtes Ökosystem stabilisieren kann.</p>
          <p class="vb-intro">Der Schatten der sexuellen Sechs mit Fünferflügel zeigt sich in der enormen persönlichen Belastung eines derart konfliktreichen Lebenswerks: Über Jahrzehnte im Zentrum eines politisch aufgeladenen Streits zu stehen, erfordert eine Widerstandsfähigkeit, die kaum Raum für andere Lebensbereiche jenseits dieser einen, alles fordernden Aufgabe lässt.</p>
        </blockquote>

        <h2 class="vb-section">5. Zwei Wölfe, ein Code</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Was Smith der Welt gibt, ist der lebende Beweis dafür, dass ein einzelnes Rudel eine ganze Landschaft heilen kann &ndash; ein Werk, das er, wie Mech, mit jahrzehntelanger, kontraphobischer Hingabe an ein und dasselbe Tier vollbrachte. Beide Männer, beide SX6w5, beide dem Wolf verschrieben &ndash; nicht zufällig, sondern als zwei Ausprägungen desselben archetypischen Prinzips.</p>
          <p class="vb-intro">Am Ende bleibt ein Bild, das kaum treffender für die sexuelle Sechs mit Fünferflügel sein könnte: ein Mann, dessen archetypisches Tier der Wolf ist, der die Wölfe buchstäblich zurück in ihre Heimat brachte &ndash; und dabei ein Rudel von Forschenden anführte, so wie ein Alphatier sein eigenes Rudel führt.</p>
        </blockquote>
      ...
      ${relatedLinks([
        ...
        {route:"subtype/sx6", label:"SX6 – Der Wolf: Subtyp-Profil"},
        {route:"lebensmusterkompass/sx6", label:"Lebensmusterkompass: SX6 – Wolf"},
        {route:"beruehmte-david-mech", label:"Porträt: Dr. L. David Mech (SX6w5)"},
        {route:"beruehmte-moses", label:"Porträt: Moses (SX6w5)"},
      ])}
...
function frankRosellPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-frank-rosell-portrait.jpg" alt="Prof. Dr. Frank Rosell – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function dietlandMuellerSchwarzePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-dietland-mueller-schwarze-portrait.jpg" alt="Prof. Dr. Dietland Müller-Schwarze – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function fransDeWaalPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-frans-de-waal-portrait.jpg" alt="Prof. Dr. Frans de Waal – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      ${relatedLinks([
        ...
        {route:"krankheitsportraets-frans-de-waal", label:"Krankheitsporträt: Frans de Waal (SX7w6) – Magenkrebs, bis zuletzt aktiv"},
      ])}
...
function jillPruetzPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-jill-pruetz-portrait.jpg" alt="Dr. Jill Pruetz – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der franz\u00f6sische Schriftsteller Jules Verne wurde 1828 in Nantes geboren, als Sohn eines Anwalts. Als Junge versuchte er angeblich, sich heimlich als Schiffsjunge auf einem Segelschiff nach Indien einzuschmuggeln &ndash; sein Vater holte ihn im letzten Moment zurück. Dieser früh gebrochene Fluchtversuch aufs offene Meer verwandelte sich später in ein lebenslanges literarisches Bauprojekt: Wo der reale Aufbruch verwehrt blieb, wurde die Vorstellungskraft zum Schiff, das keine Grenze kannte.</p>
        </blockquote>
...
function jacquelineMarsPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-jacqueline-mars-portrait.jpg" alt="Jacqueline Mars – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Jacqueline Mars ist eine der reichsten Frauen der Welt &ndash; und eine der unbekanntesten. Das ist keine F\u00fcgung und keine Sch\u00fcchternheit. Das ist die SE8w7 in vollendeter Form: das Territorium gesichert, die Ressourcen gesichert, das Leben in vollen Z\xfcgen genossen &ndash; und das alles ohne eine einzige Pressekonferenz. Der Orang-Utan braucht keine Zuschauer. Er thront in seinem Baum, weit \u00fcber dem L\xe4rm der Welt, und wei\xdf genau, was er hat.</p>
          ${bookTip("wer-du-wirklich-bist-band-1", "Die neun Typen in ihrer Tiefe \u2013 Schutzmuster, Leidenschaften und der Weg zur Essenz.", "Wer du wirklich bist \u2013 Band 1")}
          ${bookTip("die-verborgene-dynamik-der-27-subtypen", "27 Subtypen: Leidenschaften, Schutzstrategien und Heilungswege aus der therapeutischen Praxis.", "Die verborgene Dynamik der 27 Subtypen")}
          ${bookTip("die-27-persoenlichkeiten-des-enneagramms", "27 Charakterprofile im Vergleich \u2013 wie sich die Subtypen desselben Typs voneinander unterscheiden.", "Die 27 Pers\u00f6nlichkeiten des Enneagramms")}
        </blockquote>
...
function dhapanbalYunupinguPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-dhapanbal-yunupingu-portrait.jpg" alt="Dhapanbal Yunupingu – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Neunerflügel</strong> verleiht der selbsterhaltenden Acht etwas, das einer Acht mit schwach ausgeprägtem Neunerflügel oft schwerfällt: Geduld, Verschmelzung mit der Gemeinschaft und die Fähigkeit, im Hintergrund zu wirken, statt im Vordergrund zu kämpfen. Die SE8w9 sichert ihr Territorium nicht durch Konfrontation, sondern durch beharrliche, stille Präsenz.</p>
...
function indraNooyiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-indra-nooyi-portrait.jpg" alt="Indra Nooyi – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function umbertEcoPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-umberto-eco-portrait.jpg" alt="Dr. Umberto Eco – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Siebenerfl\u00fcgel</strong> verleiht der selbsterhaltenden Acht etwas, das eine Acht mit schwach ausgepr\u00e4gtem Siebenerfl\u00fcgel manchmal vermissen l\u00e4sst: Leichtigkeit. Ohne diesen Fl\u00fcgel kann die Acht schwer werden, fordernd, kompromisslos. Der Siebenerfl\u00fcgel \u00f6ffnet ein Fenster &ndash; er bringt Spielfreude, Ironie, die Bereitschaft, das eigene Wissen nicht als Keule zu benutzen, sondern als Einladung.</p>
...
function goldaMeirPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-golda-meir-portrait.jpg" alt="Golda Meir – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Neunerfl\xfcgel</strong> verleiht der selbsterhaltenden Acht etwas, das einer Acht mit kaum entwickeltem Neunerfl\xfcgel oft schwer f\xe4llt: Geduld und die F\xe4higkeit, viele Perspektiven gleichzeitig zu halten. Die SE8w7 ist impulsiv, risikofreudig, direkt &ndash; sie will sofort. Die SE8w9 kann warten. Sie baut. Sie sieht das gro\xdfe Bild, auch wenn die Lage unklar ist.</p>
          <p class="vb-intro">Meir war zehn Jahre lang Au\xdfenministerin Israels (1956&ndash;1966) &ndash; eine Amtszeit, die f\xfcr die Hartn\xe4ckigkeit einer SE8 spricht, aber auch f\xfcr die diplomatische Geduld des Neunerfl\xfcgels. Sie baute Beziehungen zu afrikanischen Staaten auf, als Israel auf der internationalen B\xfchne zunehmend isoliert zu werden drohte; sie verhandelte, wo andere konfrontierten; sie lie\xdf Dinge reifen, wo eine Acht mit schwach ausgepr\xe4gtem Neunerfl\xfcgel sie eher erzwungen h\xe4tte. David Ben-Gurion, der sie kannte wie kaum jemand sonst, nannte sie schlicht: den besten Mann im Kabinett.</p>
        </blockquote>
...
function biruteGaldikasPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-birute-galdikas-portrait.jpg" alt="Dr. Birut\xe9 Galdikas – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function carstenStahlPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-carsten-stahl-portrait.jpg" alt="Carsten Stahl – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Siebenerfl\xfcgel</strong> verleiht der sozialen Acht eine Qualität, die einen SO8er mit schwach ausgeprägtem Siebenerflügel ergänzt: Beweglichkeit, Begeisterungsf\xe4higkeit, ein Talent daf\xfcr, Menschen mitzurei\u00dfen. Die SO8w9 sch\xfctzt aus der Stille. Die <strong>SO8w7</strong> sch\xfctzt mit Feuer.</p>
...
function cynthiaLummisPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-cynthia-lummis-portrait.jpg" alt="Cynthia Lummis – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Siebenerfl\u00fcgel</strong> verleiht der sozialen Acht eine Qualität, die einen SO8er mit schwach ausgeprägtem Siebenerflügel ergänzt: Aufgeschlossenheit f\u00fcr Neues, Risikofreude, eine Bereitschaft, sich gegen den Strom zu stellen, wenn sie von etwas \u00fcberzeugt ist. Die SO8w9 sch\u00fctzt aus der Stille. Die <strong>SO8w7</strong> sch\u00fctzt mit Pioniergeist, oft lange bevor der Mainstream folgt.</p>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Diese körperliche und geistige Unerschütterlichkeit blieb während seines ganzen Lebens sein Markenzeichen: barfuß im Winter unterwegs, gleichgültig gegenüber Komfort, unbestechlich in seinen Überzeugungen. Der Löwe zieht sich nicht zurück, wenn es unbequem wird – er hält stand, für sich und für die, die ihm anvertraut sind.</p>
        </blockquote>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Die Gestalttherapie, die er mitbegründete, prägt bis auf den heutigen Tag Beratung, Coaching und Psychotherapie weit über ihre ursprüngliche Schule hinaus &ndash; ihr Kernprinzip, dass Bewusstheit (Awareness) im gegenwärtigen Moment mehr heilt als jede nachträgliche Erklärung, trägt deutlich die Handschrift des Löwen mit Siebenerflügel: kein geduldiges Abwarten, sondern die volle, ungefilterte Konfrontation mit dem, was gerade lebendig ist.</p>
        </blockquote>
...
function jamaicaKincaidPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-jamaica-kincaid-portrait.jpg" alt="Jamaica Kincaid – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function laurenceFrankPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-laurence-frank-portrait.jpg" alt="Dr. Laurence Frank – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function adeleNeuhauserPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-adele-neuhauser-portrait.jpg" alt="Adele Neuhauser – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function pabloPicassoPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-pablo-picasso-portrait.jpg" alt="Pablo Picasso – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
        <p class="krim-portrait-name">Pablo Picasso</p>
        <p class="krim-portrait-typ">SX8w7 · Sexueller Typ 8 mit Siebenerflügel</p>
        <p class="krim-portrait-subtitle">Spanischer Maler und Bildhauer, 1881–1973 – Tierentsprechung: Krokodil</p>
      </div>
      <div class="page-content">

        <h2 class="vb-section">1. Das Krokodil</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das <strong>Krokodil</strong> ist das Tier des sexuellen Typs 8 – und kaum eine Künstlerbiografie zeigt es so unverstellt wie die Pablo Picassos. Das Krokodil wartet nicht ab, ob ihm ein Territorium zusteht. Es nimmt es. Es teilt die Welt nicht in Regeln und Ausnahmen, sondern in das, was es ergreift, und das, was es unbeachtet lässt. 91 Jahre lang lebte Picasso genau so: unermüdlich, unersättlich, unbeirrbar von jeder Erwartung, die nicht seine eigene war.</p>
          <p class="vb-intro">Über 20.000 Werke – Gemälde, Skulpturen, Keramiken, Grafiken, Bühnenbilder – hinterließ er, mehr als jeder andere Künstler der Moderne. Kein Rückzug, kein Innehalten, keine Schaffenspause aus Selbstzweifel. Das Krokodil frisst, solange es Hunger hat. Und Picassos Hunger – nach Ausdruck, nach Anerkennung, nach Frauen, nach dem nächsten Bild – erlosch nie.</p>
        </blockquote>

        <h2 class="vb-section">2. Málaga: Die Taube und der Vater</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Pablo Ruiz Picasso wurde 1881 in Málaga geboren, Sohn des Zeichenlehrers und Malers José Ruiz Blasco (SE4w5), der sich auf ein einziges, immer wiederkehrendes Motiv spezialisiert hatte: Tauben. Der Vater unterrichtete an der örtlichen Kunstschule, war in Málaga ein respektierter, aber kein herausragender Künstler – ordentlich, akademisch, ohne den Ehrgeiz, die Malerei neu zu erfinden. Genau in diesem Haushalt, geprägt von väterlicher Disziplin und väterlichem Handwerk, wuchs ein Kind heran, das beides binnen weniger Jahre hinter sich lassen sollte.</p>
          <p class="vb-intro">Der Überlieferung nach malte der junge Pablo im Alter von dreizehn Jahren eine Taube mit einer Präzision und Lebendigkeit, die sein Vater bei sich selbst nie erreicht hatte. José Ruiz Blasco soll daraufhin Pinsel und Palette genommen und seinem Sohn übergeben haben – mit dem Versprechen, selbst nie wieder zu malen. Wie viel an dieser Szene später zur Legende ausgeschmückt wurde, lässt sich nicht mehr sicher rekonstruieren; sicher belegt ist, dass José Ruiz Blasco seine eigene künstlerische Tätigkeit in eben diesen Jahren zurücknahm, während er den außergewöhnlichen Fortschritt seines Sohnes öffentlich anerkannte. Für die sexuelle Acht ist das kein bloßes Talent-Erwachen. Es ist ein Machtwechsel: Der Sohn übernimmt nicht nur das Handwerk, sondern das Territorium des Vaters – und der Vater tritt zurück.</p>
        </blockquote>

        <h2 class="vb-section">3. Barcelona, Madrid: Die Schule, die zu klein war</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">1895 zog die Familie nach Barcelona, wo José Ruiz Blasco eine Stelle an der Kunstschule La Llotja fand. Für die Aufnahmeprüfung – normalerweise auf mehrere Wochen angelegt – soll Pablo, gerade vierzehn Jahre alt, nur einen einzigen Tag gebraucht haben. Die Prüfungskommission war so beeindruckt, dass sie ihn direkt in die fortgeschrittene Klasse aufnahm, weit vor Gleichaltrigen. 1897 wechselte er an die Königliche Akademie San Fernando in Madrid – die renommierteste Kunstschule Spaniens.</p>
          <p class="vb-intro">Er blieb nicht lange. Der formale Unterricht, das Kopieren klassischer Vorbilder, die akademischen Regeln – all das langweilte ihn binnen Monaten. Er schwänzte den Unterricht, verbrachte seine Zeit stattdessen im Prado vor den Werken Velázquez’ (SX9w1) und Goyas, und kehrte schließlich nach Barcelona zurück, ohne den Abschluss zu machen. Die sexuelle Acht mit Siebenerflügel lässt sich nicht in ein System einordnen, das langsamer ist als sie selbst. Was sie lernen will, lernt sie sich selbst an – schneller, direkter, ungeduldiger als jede Institution es vorsieht.</p>
        </blockquote>

        <h2 class="vb-section">4. Die sexuelle Acht: Besitz</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Die <strong>sexuelle Acht (SX8)</strong> ist nach Naranjo der Subtyp, den er <em>Besitz</em> nannte – auf Englisch <em>Possession</em>. Sie will keine distanzierte Verbindung, sondern die vollständige Verschmelzung: mit einem Menschen, mit einem Werk, mit einer Idee. Was sie berührt, will sie ganz. Was sie liebt, verzehrt sie fast. Und wenn die Intensität erlischt, lässt sie los – oft abrupt, oft ohne Rücksicht auf den, der zurückbleibt.</p>
          <p class="vb-intro">Picassos eigener Satz bringt diese Haltung auf den Punkt: <em>„Je ne cherche pas, je trouve"</em> – Ich suche nicht, ich finde. Kein Zweifel, kein Zögern, kein Bedürfnis nach Bestätigung von außen. Wenn Picasso ein Motiv, eine Form, einen Menschen für sich beanspruchte, geschah das mit einer Selbstverständlichkeit, die keinen Widerspruch kannte. Sein berühmtes Diktum, jeder Schöpfungsakt sei zuerst ein Zerstörungsakt, beschreibt exakt das Prinzip der SX8: Um etwas Neues vollständig zu besitzen, muss das Alte zuerst fallen.</p>
        </blockquote>

        <h2 class="vb-section">5. Der Siebenerflügel: Der rastlose Stilwandel</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Siebenerflügel</strong> verleiht der sexuellen Acht eine Qualität, die die pure Intensität des Achterkerns ergänzt: Appetit, Neugier, die Lust am nächsten Experiment. Die SX8w7 verharrt nicht in einer einmal gefundenen Form – sie sucht die nächste, sobald die vorherige ausgereizt ist. Kaum ein Künstlerleben zeigt das so deutlich wie Picassos endlose Kette von Stilperioden: die Blaue Periode (1901–1904), geprägt von Armut, Einsamkeit und dem Suizid seines Freundes Carlos Casagemas; die Rosa Periode (1904–1906) mit Zirkusfiguren und wärmeren Tönen; 1907 der Bruch mit <em>Les Demoiselles d’Avignon</em>, der die Malerei des 20. Jahrhunderts neu definierte; die Entwicklung des Kubismus gemeinsam mit Georges Braque; später Neoklassizismus, surrealistische Einflüsse, Keramik, Bühnenbilder.</p>
          <p class="vb-intro">Ein sexueller Typ 8 mit Neunerflügel hätte sich vermutlich in einer gefundenen Form eingerichtet und sie vertieft. Picasso tat das Gegenteil: Kaum hatte eine Stilrichtung ihre volle Reife erreicht, verließ er sie – nicht aus Unzufriedenheit, sondern aus Appetit auf das Nächste. Der Siebenerflügel macht aus der Besitzergreifung der Acht keine Erstarrung, sondern eine Kette immer neuer Eroberungen.</p>
        </blockquote>

        <h2 class="vb-section">6. Die Frauen: Musen und Verschleiß</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Picassos Beziehungen folgten demselben Muster wie sein Werk: totale Intensität, dann abrupter Wechsel. Fernande Olivier, Eva Gouel, Olga Chochlowa – seine erste Ehefrau, von der er sich nie offiziell scheiden ließ –, Marie-Thérèse Walter, die er als Siebzehnjährige kennenlernte, während er noch mit Olga verheiratet war, die Fotografin Dora Maar, Françoise Gilot, die als einzige seiner Partnerinnen ihn aus eigenem Entschluss verließ, und schließlich Jacqueline Roque, die letzten zwei Jahrzehnte seines Lebens an seiner Seite. Jede dieser Frauen wurde für eine Zeit zum vollständigen Zentrum seiner Kunst – gemalt, verwandelt, verewigt – und jede erlebte irgendwann, wie diese Intensität sich einer nächsten zuwandte.</p>
          <p class="vb-intro">Françoise Gilot beschrieb später in ihren Memoiren, wie Picasso Menschen wie Farben behandelte: vollständig verwendet, bis nichts mehr von ihnen übrig war. Der Schatten der SX8 zeigt sich hier ungeschönt: Marie-Thérèse Walter nahm sich 1977, vier Jahre nach Picassos Tod, das Leben. Jacqueline Roque erschoss sich 1986. Sein Enkel Pablito vergiftete sich, nachdem man ihm 1973 den Zutritt zu Picassos Beerdigung verweigert hatte. Besitz, der nie wirklich endet – auch nicht mit dem Tod dessen, der besaß.</p>
        </blockquote>

        <h2 class="vb-section">7. Guernica und das Jahrhundert</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">1937 bombardierte die deutsche Legion Condor im Auftrag Francos die baskische Stadt Guernica – der erste systematische Luftangriff der Geschichte auf eine Zivilbevölkerung. Picasso, der zu dieser Zeit ein Wandbild für die Weltausstellung in Paris in Auftrag hatte, verwandelte diesen Schrecken binnen Wochen in eines der bedeutendsten politischen Kunstwerke des 20. Jahrhunderts: <em>Guernica</em>, monumental, in Schwarz-Weiß-Grau gehalten, ein einziger Schrei aus Pferden, Menschen und zerbrochenen Formen.</p>
          <p class="vb-intro">Während der deutschen Besatzung von Paris blieb Picasso in der Stadt, obwohl seine als „entartet" gebrandmarkte Kunst ihn zur Zielscheibe machte. Der Legende nach zeigte ihm ein Gestapo-Offizier eine Postkarte von Guernica und fragte: „Haben Sie das gemacht?" Picasso soll geantwortet haben: „Nein – das haben Sie gemacht." Ob dieser Wortwechsel wörtlich so stattfand, ist historisch nicht gesichert, doch er trifft die Haltung: Die sexuelle Acht weicht der Konfrontation nicht aus, selbst wenn sie gefährlich ist.</p>
        </blockquote>

        <h2 class="vb-section">8. Licht und Schatten: Genie und Verwüstung</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SX8w7 ist ihre kompromisslose Schöpferkraft: die Fähigkeit, eine ganze Kunstrichtung – oder gleich mehrere – im Alleingang neu zu erfinden, ohne je um Erlaubnis zu fragen. Picasso hat die Malerei des 20. Jahrhunderts nicht beeinflusst. Er hat sie mehrfach neu begründet, jedes Mal, wenn er eine gefundene Form hinter sich ließ, um die nächste zu erobern.</p>
          <p class="vb-intro">Der Schatten ist derselbe Zug, nur ohne die Kunst als Ventil: eine Besitzergreifung, die keinen Unterschied macht zwischen einer Leinwand und einem Menschen. Wer Picasso nahestand, wurde Teil seines Werkes – und musste akzeptieren, dass diese Zugehörigkeit endete, sobald seine Intensität sich verschob. Die reife SX8w7 lernt, dass echte Größe nicht Verschleiß braucht, um sich zu beweisen. Picasso hat diese Lektion, soweit die Quellen zeigen, nie vollständig gelernt. Macht und Liebe schließen sich bekanntlich aus.</p>
        </blockquote>

        <h2 class="vb-section">9. Tod und Vermächtnis</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Pablo Picasso starb 1973 in Mougins, Frankreich, im Alter von 91 Jahren – arbeitend fast bis zuletzt. Kein Rückzug ins Private, kein Verstummen im Alter: Noch in seinen letzten Lebensjahrzehnten war seine Produktivität ungebrochen, seine Neugier auf neue Techniken – Keramik, Linolschnitt, Skulptur aus Fundstücken – unerschöpft. Das Krokodil bleibt bis zuletzt an der Oberfläche: sichtbar, aktiv, nie im Ruhestand.</p>
          <p class="vb-intro">Was bleibt, ist ein Werk, das die Kunstgeschichte mehrfach neu geschrieben hat – und eine Biografie, die zeigt, wozu dieselbe Kraft fähig ist: zur größten kreativen Explosion der Moderne und zur rücksichtslosen Erschöpfung derer, die ihr zu nahe kamen. Beides war Picasso. Die sexuelle Acht mit Siebenerflügel kennt keine halben Sachen – weder im Schaffen noch im Besitzen.</p>
          ${bookTip("wer-du-wirklich-bist-band-1", "Die neun Typen in ihrer Tiefe – Schutzmuster, Leidenschaften und der Weg zur Essenz.", "Wer du wirklich bist – Band 1")}
          ${bookTip("die-verborgene-dynamik-der-27-subtypen", "27 Subtypen: Leidenschaften, Schutzstrategien und Heilungswege aus der therapeutischen Praxis.", "Die verborgene Dynamik der 27 Subtypen")}
          ${bookTip("die-27-persoenlichkeiten-des-enneagramms", "27 Charakterprofile im Vergleich – wie sich die Subtypen desselben Typs voneinander unterscheiden.", "Die 27 Persönlichkeiten des Enneagramms")}
        </blockquote>
...
function diogenesPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-diogenes-portrait.jpg" alt="Diogenes von Sinope – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function grahameWebbPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-grahame-webb-portrait.jpg" alt="Prof. Grahame Webb – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <p class="vb-intro">Die vier Krebserkrankungen an insgesamt drei verschiedenen, sehr unterschiedlichen Organen über zwei Jahrzehnte, die sie nie zum freiwilligen Rücktritt bewogen, werden ausführlich im eigenen <a href="javascript:void(0)" data-route="krankheitsportraets-ruth-bader-ginsburg">Krankheitsporträt zu Ginsburg</a> gedeutet.</p>
        ${relatedLinks([
          {route:"beruehmte-genesis-p-orridge", label:"Portr\xe4t: Genesis P-Orridge (SX8w9)"},
          {route:"beruehmte-donald-trump", label:"Portr\xe4t: Donald J. Trump (SX8w7)"},
...
function eliJaxonBearPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-eli-jaxon-bear-portrait.jpg" alt="Eli Jaxon-Bear – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der US-amerikanische Eli Jaxon-Bear, geboren 1947 als Elliot J. Zeldow in Brooklyn, New York, war in jungen Jahren ein gl\u00fchender politischer Aktivist der amerikanischen B\u00fcrgerrechtsbewegung &ndash; 1965 nahm er an den B\u00fcrgerrechtsm\u00e4rschen in Montgomery, Alabama, teil, wurde sp\u00e4ter Gemeindeorganisator in Chicago und Detroit. 1990 reiste er gemeinsam mit seiner ein Jahr zuvor angetrauten Frau <a href="#beruehmte-gangaji">Gangaji (SX4w3)</a> nach Indien und traf dort H. W. L. Poonja, genannt Papaji, einen Sch\u00fcler des gro\u00dfen Weisen Ramana Maharshi &ndash; den letzten Lehrer auf einer lebenslangen Suche, die ihn zuvor bereits in ein Zen-Kloster in Japan und einen Sufi-Zirkel in Marrakesch gef\u00fchrt hatte. Was folgte, war keine sanfte Bekehrung. Es war die vollst\u00e4ndige Kapitulation eines Krokodils, das erkannte, dass sein eigenes Bei\u00dfen die letzte Fixierung war, die es loslassen musste.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Er gr\u00fcndete die Leela Foundation und h\u00e4lt seit Jahrzehnten Retreats und Satsangs weltweit, in denen er Menschen direkt mit der Frage konfrontiert, wer sie jenseits ihrer Pers\u00f6nlichkeitsfixierung wirklich sind. Er lebt in Ashland, Oregon, gemeinsam mit seiner Frau <a href="#beruehmte-gangaji">Gangaji (SX4w3)</a>, ebenfalls einer bekannten spirituellen Lehrerin &ndash; 1989 heirateten die beiden in einer H\u00f6hle am Haleakala-Krater auf Maui, ein Jahr bevor sie gemeinsam nach Indien reisten und dort auf Papaji trafen. Jaxon-Bears Lehre ist kein sanftes Coaching, sondern die direkte, oft unbequeme Einladung, die eigene Fixierung als Fixierung zu erkennen &ndash; und loszulassen.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Vom revolution\u00e4ren Aktivisten zum Lehrer der Befreiung: Das ist die SX8w9 in ihrer reifsten Form &ndash; ein Krokodil, das nicht aufgeh\u00f6rt hat, kompromisslos zu sein, sondern das seine Kompromisslosigkeit auf die letzte, entscheidende Grenze richtet: die eigene Vorstellung davon, wer man ist. Jaxon-Bear zeigt anderen bis auf den heutigen Tag denselben Weg, den er selbst gegangen ist &ndash; nicht sanft, sondern direkt, mit der Wucht einer Acht, die die Wahrheit nicht verhandeln l\u00e4sst.</p>
        </blockquote>
      ...
      ${relatedLinks([
        {route:"beruehmte-persoenlichkeiten", label:"Alle ber\u00fchmten Pers\u00f6nlichkeiten"},
        {route:"beruehmte-gangaji", label:"Portr\u00e4t: Gangaji (SX4w3) \u2013 seine Frau"},
        {route:"subtype/sx8", label:"SX8 \u2013 Das Krokodil: Subtyp-Profil"},
...
function angelaMerkelPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-angela-merkel-portrait.jpg" alt="Angela Merkel – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Diese Seite zeigte sich fr\xfch. Als die CDU-Spendenaff\u00e4re 1999/2000 ihren politischen Ziehvater Helmut Kohl zu erdr\u00fccken drohte, schrieb Merkel &ndash; damals CDU-Generalsekret\xe4rin &ndash; einen Artikel in der Frankfurter Allgemeinen Zeitung, in dem sie die Partei aufforderte, sich von Kohl zu l\xf6sen und eigenst\xe4ndig fortzufahren. Es war ein \xf6ffentliches Messer in den R\xfccken ihres Mentors. Kohl nannte sie immer sein &ldquo;M\xe4dchen&rdquo; &ndash; und meinte damit, sie geformt zu haben. Die SE9w8 hatte ihn gerade \xfcberholt, ohne die Miene zu ver\xe4ndern.</p>
          <p class="vb-intro">Helmut Kohl war ein <strong>selbsterhaltender Typ 8 mit Neunerfl\xfcgel (SE8w9)</strong> &ndash; das Urgestein, der gro\xdfe Patriarch, der die CDU jahrzehntelang als pers\xf6nliches Territorium behandelte. Der SE8 braucht Loyalit\xe4t; er sieht Menschen durch die Linse von Zugeh\xf6rigkeit und Besitz. Merkel war f\xfcr ihn kein Gespr\u00e4chspartner &ndash; sie war sein Projekt, seine Entdeckung, sein &ldquo;M\xe4dchen&rdquo;. Was Helmut Kohl als SE8 dabei \xfcbersah: Die Neun unterwirft sich nicht. Sie passt sich an &ndash; und wartet.</p>
          <p class="vb-intro">Die Dynamik zwischen SE8w9 und SE9w8 ist lehrreich. Der Achter dominiert offen, besetzt Raum, verlangt Pr\xe4senz. Die Neun l\xe4sst ihn &ndash; registriert, lernt, baut still ihre eigene Position auf. Kohl glaubte, Merkel geformt zu haben. In Wahrheit hatte sie in seiner N\xe4he gelernt, wie Macht funktioniert &ndash; und wie sie funktioniert, wenn man kein Patriarch sein will. Die Acht muss zeigen, dass sie stark ist. Die Neun muss das nicht &ndash; und genau das ist ihr Vorteil.</p>
        </blockquote>
...
function carmenGoglinPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-carmen-goglin-portrait.jpg" alt="Carmen Goglin – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function ameliaEarhartPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-amelia-earhart-portrait.jpg" alt="Amelia Earhart – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function sandraHuellerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-sandra-hueller-portrait.jpg" alt="Sandra H\xfcller – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Geboren 1978 in Suhl, Th\xfcringen, ausgebildet an der Ernst-Busch-Schauspielschule Berlin, blieb die deutsche Schauspielerin Sandra H\xfcller trotz Oscar-Nominierungen und internationalem Ruhm ihrem Stammhaus treu. Diese Best\xe4ndigkeit ist kein Zufall, sondern die Grundhaltung des Tieres: Der B\xfcffel wechselt die Herde nicht, nur weil andere Weiden gr\xfcner erscheinen.</p>
        </blockquote>
...
function sophieMarceauPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-sophie-marceau-portrait.jpg" alt="Sophie Marceau – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function nataschaKampuschPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-natascha-kampusch-portrait.jpg" alt="Natascha Kampusch – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function annaAndersonPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-anna-anderson-portrait.jpg" alt="Anna Anderson – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function carlTanzlerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-carl-tanzler-portrait.jpg" alt="Carl Tanzler – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
...
function helmutKohlPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-helmut-kohl-portrait.jpg" alt="Helmut Kohl – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <h2 class="vb-section">6. Der L\u00f6we, der einen Kontinent zusammenhielt</h2>
        <blockquote class="vb-blockquote">
...
function gerhardSchroederPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-gerhard-schroeder-portrait.jpg" alt="Gerhard Schr\u00f6der – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Auch sein Privatleben folgte diesem Muster der intensiven, wechselnden Bindungen: Schr\u00f6der war viermal verheiratet, jede Ehe von gro\u00dfer \u00f6ffentlicher Aufmerksamkeit begleitet. F\u00fcr die sexuelle Acht folgt das einer klaren Logik &ndash; sie sucht die eine Beziehung, in der volle Intensit\u00e4t m\u00f6glich ist, und wenn diese erlischt, wird sie mit derselben Entschlossenheit beendet, mit der sie begonnen wurde.</p>
        </blockquote>

        <h2 class="vb-section">3. Der Siebenerfl\u00fcgel: Charisma und Risikofreude</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Siebenerfl\u00fcgel (w7)</strong> verleiht der Acht eine Leichtigkeit, einen Charme und eine Lust am Risiko, die bei schwach ausgeprägtem Siebenerflügel fehlen würden &ndash; die Konfrontation wird dann nicht nur ausgetragen, sondern regelrecht genossen. Schr\u00f6ders Auftreten &ndash; die Cohiba-Zigarre, der Brioni-Anzug, das breite Grinsen bei Wahlsiegen &ndash; war genau diese Mischung aus Kampfeslust und Lebensfreude, die ihn zum &bdquo;Medienkanzler&ldquo; machte, dem ersten deutschen Regierungschef, der Politik konsequent als mediales Ereignis inszenierte.</p>
...
function konradAdenauerPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-konrad-adenauer-portrait.jpg" alt="Konrad Adenauer – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Kaum ein Denker hat das abendl\u00e4ndische Wissen so grundlegend geordnet wie Aristoteles \u2013 seine Logik blieb \u00fcber zwei Jahrtausende das Fundament wissenschaftlicher Schlussfolgerungen, seine Ethik pr\u00e4gt bis auf den heutigen Tag Debatten \u00fcber das gute Leben, seine Biologie legte den Grundstein f\u00fcr die systematische Naturbeobachtung.</p>
...
function johnnyDeppPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-johnny-depp-portrait.jpg" alt="Johnny Depp – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Leonard Bernstein starb 1990 in New York an Herzversagen, wenige Wochen nach seinem letzten Konzert, von dem die Ärzte ihm aufgrund seiner fortgeschrittenen Lungenkrankheit dringend abgeraten hatten – er dirigierte bis fast zum letzten Atemzug. Sein Werk umfasst bis auf den heutigen Tag eines der vielseitigsten Vermächtnisse der amerikanischen Musikgeschichte: einer der bedeutendsten Dirigenten des 20. Jahrhunderts, Schöpfer eines der langlebigsten Broadway-Musicals aller Zeiten und ein Pädagoge, der klassische Musik einem Massenpublikum öffnete, wie es vor ihm niemand geschafft hatte.</p>
...
function morganFreemanPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-morgan-freeman-portrait.jpg" alt="Morgan Freeman – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Der <strong>Sechserfl\u00fcgel (w6)</strong> verleiht der Sieben eine erdende Verl\u00e4sslichkeit, die bei schwach ausgepr\u00e4gtem Sechserfl\u00fcgel fehlen w\u00fcrde &ndash; die Lust am Neuen wird nicht chaotisch ausgelebt, sondern in loyale, langj\u00e4hrige Zusammenarbeit eingebettet. Freemans Zusammenarbeit mit Regisseur Clint Eastwood (u. a. &bdquo;Million Dollar Baby&ldquo;), mit Regisseur Rob Reiner oder in wiederkehrenden Rollen zeigt eine Treue zu Arbeitsbeziehungen, die f\u00fcr eine Sieben mit schwach ausgepr\u00e4gtem Sechserfl\u00fcgel untypisch w\u00e4re.</p>
...
function nicolasCagePortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-nicolas-cage-portrait.jpg" alt="Nicolas Cage – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Statt \u00f6ffentlich zu klagen, reagierte Cage mit stiller, fast schon bemerkenswerter Arbeitsdisziplin: Er nahm in kurzer Zeit dutzende Filmrollen an, viele davon in kleineren, direkt f\u00fcr den Streamingmarkt produzierten Produktionen, um seine Schulden abzutragen. Diese jahrelange, unspektakul\u00e4re Aufbauarbeit im Hintergrund, fernab gro\u00dfer roter Teppiche, ist die reinste Auspr\u00e4gung der selbsterhaltenden Vier: Nicht klagen, sondern beharrlich weiterarbeiten, bis die eigene Existenz wieder gesichert ist.</p>
        </blockquote>
...
function leoTolstoiPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-leo-tolstoi-portrait.jpg" alt="Leo Tolstoi – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der russische Schriftsteller Lew Nikolajewitsch Tolstoi wurde 1828 auf dem Familiengut Jasnaja Poljana geboren, verlor beide Eltern fr\u00fch und wuchs bei Verwandten auf. Schon als junger Mann f\u00fchrte er akribisch Tagebuch &ndash; ein lebenslanges Ritual der schonungslosen Selbstbeobachtung, in dem er seine eigenen moralischen Schw\u00e4chen, seine Spielsucht, seine sexuellen Verfehlungen und seine st\u00e4ndige Selbstkritik minuti\u00f6s festhielt. Diese fr\u00fche Gewohnheit der inneren Buchf\u00fchrung wurde zur Grundlage seines gesamten literarischen Werks.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Die Taube, die zeitlebens zwischen Reichtum und Askese, zwischen Ruhm und Selbstverleugnung schwankte und erst im Tod, fern von ihrem eigenen Gut, zur Ruhe kam &ndash; das ist das bleibende Bild der selbsterhaltenden Vier mit F\u00fcnferfl\u00fcgel: ein stilles, durchdachtes Ringen um die eigene Wahrheit.</p>
        </blockquote>
    ...
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Auf die Frage, ob er auch mal zornig werden könne, hat Mey in Interviews wiederholt betont, dass ihm das im Grunde fremd sei – gerade im Kreis der eigenen Familie werde er nie zornig, und offene Wut finde er grundsätzlich unangebracht. Das ist kein Verschmelzen mit der Situation, wie es eher der Neun entspräche, sondern eine bewusste, fast moralisch gefärbte Zurückhaltung: Der eigene Zorn würde genau das gefährden, was der selbsterhaltenden Sechs am wichtigsten ist – die Sicherheit im engsten, vertrautesten Kreis.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Auch im Kleinen zeigt sich diese Kombination aus klarer innerer Position und vorsichtiger äußerer Verpackung: Mey hat nie einen Hehl daraus gemacht, dass ihm der Schlager fremd ist und er seiner eigenen Musik bewusst einen Gegenpol dazu setzen wollte – doch er trägt diese Haltung freundlich vor, ohne jemanden vor den Kopf zu stoßen. Eine reine Neun würde sich kaum so dezidiert positionieren; die SE6w5 hat sehr wohl ein klares Urteil, verpackt es aber so, dass niemand im eigenen Umfeld verprellt wird. Auch das Tempo, mit dem Mey in Interviews antwortet – schnell, reaktionsbereit, ohne die für die reine Fünf typische nachdenkliche Verzögerung –, passt zu diesem Bild: ein Kopfmensch, aber ein wacher, sofort scannender, kein introspektiv-zurückgezogener.</p>
          <p class="vb-intro">Genau diese ständige, wache Reaktionsbereitschaft ist das entscheidende Unterscheidungsmerkmal zur Neun, die von außen mitunter ähnlich freundlich-zurückhaltend wirken kann: Der Sechs ist ihre eigene Grundanspannung oft selbst kaum bewusst – sie kennt es nicht anders, als ständig aufmerksam zu sein –, während die Neun sich tatsächlich entspannt und ihre Anspannung erst bei starker Überlastung überhaupt bemerkt. Bei Mey liegt genau dieser feine, aber deutliche Unterschied vor: eine durchgehend präsente, nie ganz abschaltende Wachheit, kein selbstvergessenes Sich-treiben-Lassen.</p>
        </blockquote>
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der Schatten zeigt sich in der Vorsicht, die der Fünferflügel mit sich bringt: Wer die Welt vor allem beobachtet und kontrolliert, statt sich ihr ungeschützt auszusetzen, riskiert, dass echte Nähe stets einen sorgfältig kontrollierten Rahmen behält – warm, aber selten wirklich ungeschützt. Auch in seinem öffentlichen Auftreten, so professionell und routiniert es nach über fünf Jahrzehnten Bühnenerfahrung wirkt, lässt sich bei genauem Hinsehen jener flüchtige, kaum greifbare Anflug von Wachsamkeit im Blick erahnen, der der Sechs eigen ist – gut überspielt, nie dominant, aber im Kern nie ganz verschwunden.</p>
        </blockquote>
...
function marcelProustPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-marcel-proust-portrait.jpg" alt="Marcel Proust – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          ...
          <p class="vb-intro">Der französische Schriftsteller Marcel Proust wurde 1871 in Auteuil bei Paris geboren, litt von fr\u00fcher Kindheit an unter schwerem Asthma und einer au\u00dfergew\u00f6hnlichen k\u00f6rperlichen Empfindlichkeit, die sein gesamtes Leben pr\u00e4gte. In seiner Jugend und als junger Mann war er ein eifriger Salonbesucher der Pariser Oberschicht &ndash; er beobachtete Adel und B\u00fcrgertum mit regelrecht wissenschaftlicher Genauigkeit, bevor er sich, zunehmend krank, in sein legend\u00e4res, mit Kork ausgekleidetes Schlafzimmer zur\u00fcckzog, um die letzten 13 Jahre seines Lebens fast ausschlie\u00dflich dort mit dem Schreiben seines Lebenswerks zu verbringen.</p>
        </blockquote>
        ...
        <h2 class="vb-section">5. Licht und Schatten</h2>
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Das Licht der SO4w5 ist die F\u00e4higkeit, <strong>fl\u00fcchtige, subjektive Erinnerung in eine universelle, minuti\u00f6s durchdachte Kunstform</strong> zu verwandeln &ndash; Prousts Werk gilt nach wie vor als einer der bedeutendsten Romane der Weltliteratur, weil es zeigt, wie das scheinbar Kleinste (der Geschmack eines Geb\u00e4cks) das Gr\u00f6\u00dfte (eine ganze verlorene Welt) enthalten kann.</p>
  ...
  return shell(`
    <div class="page-container">
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Hippokrates starb um 370 v. Chr. in Larisa, weit entfernt von seiner Heimatinsel Kos. Sein Name wird bis in die Gegenwart mit jedem Medizinstudium verbunden, sein Eid – in modernisierter Form – von Absolventen weltweit gesprochen oder als ethischer Bezugspunkt zitiert.</p>
  ...
  return shell(`
    <div class="page-container">
      ...
      ${relatedLinks([
        ...
        {route:"beruehmte-marcel-proust", label:"Porträt: Marcel Proust (SO4w5)"},
        {route:"beruehmte-gustav-mahler", label:"Porträt: Gustav Mahler (SO4w5)"},
        {route:"beruehmte-pythagoras", label:"Porträt: Pythagoras (SO5w6) – den er in seinen Fragmenten scharf kritisierte"},
      ])}
    </div>
  `);
}
...
function leonardoDaVinciPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-leonardo-da-vinci-portrait.jpg" alt="Leonardo da Vinci – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
      ...
      <div class="page-content">
        ...
        <blockquote class="vb-blockquote">
          <p class="vb-intro">Leonardo da Vinci starb 1519 in Amboise, Frankreich, im Dienst des franz\u00f6sischen K\u00f6nigs Franz I. Sein Nachlass an Notizb\u00fcchern, Skizzen und unvollendeten Ideen inspiriert auch heute noch Wissenschaftler, K\u00fcnstler und Ingenieure gleicherma\u00dfen &ndash; ein Beweis daf\u00fcr, dass sein Denken seiner Zeit um Jahrhunderte voraus war.</p>
...
function udoJuergensPortraitPage() {
  return shell(`
    <div class="page-container">
      ...
      <div class="krim-portrait-wrap">
        <div class="krim-portrait-frame">
          <img src="./assets/portraits/beruehmte-udo-juergens-portrait.jpg" alt="Udo J\u00fcrgens – Porträt" class="krim-portrait-img" loading="lazy" />
        </div>
